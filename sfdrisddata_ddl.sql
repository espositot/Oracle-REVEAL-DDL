-----------------------------------------------------------
-- Export file for user SFDRISDDATA@DATAWH               --
-- Created by espositot on 5/26/2016, 16:33:52 16:33:52  --
-----------------------------------------------------------

set define off
spool sfdrisddata_ddl.log

prompt
prompt Creating table DISTRICT_DIM
prompt ===========================
prompt
create table SFDRISDDATA.DISTRICT_DIM
(
...
alter table SFDRISDDATA.DISTRICT_DIM
...
prompt =================================
prompt
create table SFDRISDDATA.ABSENCE_REASON_DIM
(
...
comment on table SFDRISDDATA.ABSENCE_REASON_DIM
  is 'The reason that a student missed instruction such as excused or unexcused.';
comment on column SFDRISDDATA.ABSENCE_REASON_DIM.absence_reason_key
...
comment on column SFDRISDDATA.ABSENCE_REASON_DIM.exclude_absence_reason
  is 'Indicates that the Absence Reason should be excluded from Risk Calculation Engine processing.
Values: Yes/No';
alter table SFDRISDDATA.ABSENCE_REASON_DIM
...
alter table SFDRISDDATA.ABSENCE_REASON_DIM
  ...
  references SFDRISDDATA.DISTRICT_DIM (DISTRICT_SID);

prompt
prompt Creating table ACADEMIC_RECORD_SOURCE_DIM
prompt =========================================
prompt
create table SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM
(
...
comment on table SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM
  is 'Indicates the where the record of academic achievement came from, classroom, transfer, exam, etc...';
comment on column SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM.academic_source_code
  is 'A code that indicates what kind of Academic Source .
Example: T - transfer
               C - Classroom
               E - Exam
               O - online';
comment on column SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM.academic_source_description
  is 'Describes the Academic Source Code.
Examples: Transfer,
                 Classroom,
                 Exam,
                 Online';
create unique index SFDRISDDATA.PK_CREDIT_TYPE_DIM on SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM (ACADEMIC_SOURCE_CODE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM
...
prompt ============================================
prompt
create table SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM
(
...
comment on table SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM
  is 'Describes why the assigned action length varies from the actual days served.';
comment on column SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason_sid
  is 'Uniquely identifies the Action Length Diff Reason Dim';
comment on column SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason
  is 'Description of why the assigned days varies from the actual days.
Example: Term Modified by District';
comment on column SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason_key
  is 'Business key for the Action Length Diff Reason Dim.
Example: TX*849395*Other';
alter table SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM
...
prompt =============================
prompt
create table SFDRISDDATA.AD_CAMPUS_XREF
(
...
prompt ============================
prompt
create table SFDRISDDATA.AD_FIRST_NAME
(
...
prompt ===========================
prompt
create table SFDRISDDATA.AD_LAST_NAME
(
  name_sid  NUMBER not null,
...
prompt =============================
prompt
create table SFDRISDDATA.AD_SCHOOL_NAME
(
  name_sid    NUMBER not null,
...
prompt =============================
prompt
create table SFDRISDDATA.AD_STREET_NAME
(
  name_sid    NUMBER not null,
...
prompt ==============================
prompt
create table SFDRISDDATA.AD_STUDENT_XREF
(
...
prompt ========================
prompt
create table SFDRISDDATA.APEX$_ACL
(
  id         NUMBER not null,
...
create index SFDRISDDATA.APEX$_ACL_IDX1 on SFDRISDDATA.APEX$_ACL (WS_APP_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.APEX$_ACL
...
prompt ============================
prompt
create table SFDRISDDATA.APEX$_WS_ROWS
(
  id            NUMBER not null,
  ws_app_id     NUMBER not null,
...
create index SFDRISDDATA.APEX$_WS_ROWS_IDX on SFDRISDDATA.APEX$_WS_ROWS (WS_APP_ID, DATA_GRID_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.APEX$_WS_ROWS
...
prompt =============================
prompt
create table SFDRISDDATA.APEX$_WS_FILES
(
  id                  NUMBER not null,
  ws_app_id           NUMBER not null,
  data_grid_id        NUMBER,
...
create index SFDRISDDATA.APEX$_WS_FILES_IDX1 on SFDRISDDATA.APEX$_WS_FILES (WS_APP_ID, DATA_GRID_ID, ROW_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.APEX$_WS_FILES_IDX2 on SFDRISDDATA.APEX$_WS_FILES (WS_APP_ID, WEBPAGE_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.APEX$_WS_FILES
...
alter table SFDRISDDATA.APEX$_WS_FILES
  ...
  references SFDRISDDATA.APEX$_WS_ROWS (ID) on delete cascade;
alter table SFDRISDDATA.APEX$_WS_FILES
...
prompt ===============================
prompt
create table SFDRISDDATA.APEX$_WS_HISTORY
(
...
create index SFDRISDDATA.APEX$_WS_HISTORY_IDX on SFDRISDDATA.APEX$_WS_HISTORY (WS_APP_ID, DATA_GRID_ID, ROW_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt =============================
prompt
create table SFDRISDDATA.APEX$_WS_LINKS
(
  id               NUMBER not null,
  ws_app_id        NUMBER not null,
  data_grid_id     NUMBER,
...
create index SFDRISDDATA.APEX$_WS_LINKS_IDX1 on SFDRISDDATA.APEX$_WS_LINKS (WS_APP_ID, DATA_GRID_ID, ROW_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.APEX$_WS_LINKS_IDX2 on SFDRISDDATA.APEX$_WS_LINKS (WS_APP_ID, WEBPAGE_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.APEX$_WS_LINKS
...
prompt =============================
prompt
create table SFDRISDDATA.APEX$_WS_NOTES
(
  id              NUMBER not null,
  ws_app_id       NUMBER not null,
  data_grid_id    NUMBER,
...
create index SFDRISDDATA.APEX$_WS_NOTES_IDX1 on SFDRISDDATA.APEX$_WS_NOTES (WS_APP_ID, DATA_GRID_ID, ROW_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.APEX$_WS_NOTES_IDX2 on SFDRISDDATA.APEX$_WS_NOTES (WS_APP_ID, WEBPAGE_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.APEX$_WS_NOTES
...
prompt ============================
prompt
create table SFDRISDDATA.APEX$_WS_TAGS
(
  id              NUMBER not null,
  ws_app_id       NUMBER not null,
  data_grid_id    NUMBER,
...
create index SFDRISDDATA.APEX$_WS_TAGS_IDX1 on SFDRISDDATA.APEX$_WS_TAGS (WS_APP_ID, DATA_GRID_ID, ROW_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.APEX$_WS_TAGS_IDX2 on SFDRISDDATA.APEX$_WS_TAGS (WS_APP_ID, WEBPAGE_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.APEX$_WS_TAGS
...
prompt ======================================
prompt
create table SFDRISDDATA.APEX$_WS_WEBPG_SECTIONS
(
  id                   NUMBER not null,
  ws_app_id            NUMBER not null,
  webpage_id           NUMBER,
...
alter table SFDRISDDATA.APEX$_WS_WEBPG_SECTIONS
...
prompt =============================================
prompt
create table SFDRISDDATA.APEX$_WS_WEBPG_SECTION_HISTORY
(
...
create index SFDRISDDATA.APEX$_WS_WEBPG_SECHIST_IDX1 on SFDRISDDATA.APEX$_WS_WEBPG_SECTION_HISTORY (WS_APP_ID, WEBPAGE_ID, SECTION_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==========================
prompt
create table SFDRISDDATA.APPLICATION
(
...
comment on column SFDRISDDATA.APPLICATION.application_id
  is 'The APEX application number';
comment on column SFDRISDDATA.APPLICATION.active_flag
  is 'Indicates if the application is currently active and available.
Values: Y, N';
comment on column SFDRISDDATA.APPLICATION.description
  is 'Describes the Application';
comment on column SFDRISDDATA.APPLICATION.application_alias
...
Example: DWS,
               REVIDMGR';
alter table SFDRISDDATA.APPLICATION
...
prompt ==========================
prompt
create table SFDRISDDATA.ROLE_MASTER
(
...
comment on column SFDRISDDATA.ROLE_MASTER.role_sid
  is 'Surrogate Key for the User role';
comment on column SFDRISDDATA.ROLE_MASTER.role
  is 'Defines a role that can be applied to an application and a user.
Example: District,
              Campus';
alter table SFDRISDDATA.ROLE_MASTER
...
prompt ===============================
prompt
create table SFDRISDDATA.APPLICATION_ROLE
(
...
comment on column SFDRISDDATA.APPLICATION_ROLE.application_role_sid
  is 'Surrogate Key for the Application Role';
comment on column SFDRISDDATA.APPLICATION_ROLE.role_sid
  is 'Surrogate Key for the User role';
alter table SFDRISDDATA.APPLICATION_ROLE
...
alter table SFDRISDDATA.APPLICATION_ROLE
  ...
  references SFDRISDDATA.ROLE_MASTER (ROLE_SID);
alter table SFDRISDDATA.APPLICATION_ROLE
  add constraint FK_APPL_REF_APP_ROLE foreign key (APPLICATION_ID)
  references SFDRISDDATA.APPLICATION (APPLICATION_ID);

prompt
prompt Creating table CAMPUS_DIM
prompt =========================
prompt
create table SFDRISDDATA.CAMPUS_DIM
(
  campus_sid              NUMBER not null,
  district_sid            NUMBER not null,
...
comment on table SFDRISDDATA.CAMPUS_DIM
...
alter table SFDRISDDATA.CAMPUS_DIM
...
prompt =======================
prompt
create table SFDRISDDATA.DATE_DIM
(
...
comment on table SFDRISDDATA.DATE_DIM
  is 'Identifies the common and districts specific calendars.';
comment on column SFDRISDDATA.DATE_DIM.date_sid
...
comment on column SFDRISDDATA.DATE_DIM.district_sid
  is 'Surrogate key';
comment on column SFDRISDDATA.DATE_DIM.date_id
  is 'A specific day of the year';
comment on column SFDRISDDATA.DATE_DIM.calendar_year
  is 'Example: 2009';
comment on column SFDRISDDATA.DATE_DIM.calendar_year_quarter
  is 'Example: 2009 Q1';
comment on column SFDRISDDATA.DATE_DIM.calendar_quarter
  is 'Example: 1';
comment on column SFDRISDDATA.DATE_DIM.calendar_year_month
  is 'Example: 200912';
comment on column SFDRISDDATA.DATE_DIM.calendar_month
  is 'Example: 12';
comment on column SFDRISDDATA.DATE_DIM.calendar_month_name
  is 'Example: December';
comment on column SFDRISDDATA.DATE_DIM.calendar_month_short_name
  is 'Example: Dec';
comment on column SFDRISDDATA.DATE_DIM.calendar_week
  is 'Example: 50';
comment on column SFDRISDDATA.DATE_DIM.day_of_week
...
7 (Saturday)
';
comment on column SFDRISDDATA.DATE_DIM.day_of_week_name
  is 'Example: Thursday';
comment on column SFDRISDDATA.DATE_DIM.day_of_week_short_name
  is 'Example: Thu';
comment on column SFDRISDDATA.DATE_DIM.school_year
  is 'Begins Aug 1 of the calendar year and ends July 31 of the next calendar year.
Example: 2009';
comment on column SFDRISDDATA.DATE_DIM.school_year_description
  is 'Example: 2009/2010';
comment on column SFDRISDDATA.DATE_DIM.school_week
  is 'Example: 24';
comment on column SFDRISDDATA.DATE_DIM.year_month_day
  is 'Example: 20091215';
comment on column SFDRISDDATA.DATE_DIM.short_date
  is 'Example: 12/15/2009';
comment on column SFDRISDDATA.DATE_DIM.long_date
  is 'Example: December 15, 2009';
comment on column SFDRISDDATA.DATE_DIM.school_day_indicator
  is 'Denotes what type of school day this particular day represents.
Values:
Instructional
Professional
Non-Academic';
comment on column SFDRISDDATA.DATE_DIM.academic_6_weeks
...
comment on column SFDRISDDATA.DATE_DIM.academic_9_weeks
...
9
0 - non-instructional days';
comment on column SFDRISDDATA.DATE_DIM.semester
  is 'Example: 1';
comment on column SFDRISDDATA.DATE_DIM.first_day_academic_6_weeks
  is 'Values: Yes/No';
comment on column SFDRISDDATA.DATE_DIM.last_day_academic_6_weeks
  is 'Values: Yes/No';
comment on column SFDRISDDATA.DATE_DIM.first_day_academic_9_weeks
  is 'Values: Yes/No';
comment on column SFDRISDDATA.DATE_DIM.last_day_academic_9_weeks
  is 'Values: Yes/No';
comment on column SFDRISDDATA.DATE_DIM.first_day_semester
  is 'Values: Yes/No';
comment on column SFDRISDDATA.DATE_DIM.last_day_semester
  is 'Values: Yes/No';
comment on column SFDRISDDATA.DATE_DIM.date_key
...
alter table SFDRISDDATA.DATE_DIM
...
prompt ===========================
prompt
create table SFDRISDDATA.USER_ACCOUNT
(
...
comment on column SFDRISDDATA.USER_ACCOUNT.user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.USER_ACCOUNT.user_id
  is 'A unique name or email address that identifies a user of one or more applications.
example: jane.doe@anywhereISD.org';
comment on column SFDRISDDATA.USER_ACCOUNT.password
  is 'Users encrypted password';
comment on column SFDRISDDATA.USER_ACCOUNT.password_expiration_date
  is 'The date on which the users password will expire and need to be changed.';
comment on column SFDRISDDATA.USER_ACCOUNT.password_update_date
  is 'The date on which the user last changed their password.';
comment on column SFDRISDDATA.USER_ACCOUNT.user_first_name
  is 'First name of the user.';
comment on column SFDRISDDATA.USER_ACCOUNT.user_last_name
  is 'Surname of the user.';
comment on column SFDRISDDATA.USER_ACCOUNT.email_address
  is 'The email address of the user.';
comment on column SFDRISDDATA.USER_ACCOUNT.created_by
  is 'The SID of the user that created this user account.';
comment on column SFDRISDDATA.USER_ACCOUNT.create_date
  is 'The timestamp when the account was created.';
comment on column SFDRISDDATA.USER_ACCOUNT.updated_by
  is 'The SID of the user that updated this user account.';
comment on column SFDRISDDATA.USER_ACCOUNT.update_date
  is 'The timestamp when the account was updated.';
comment on column SFDRISDDATA.USER_ACCOUNT.account_locked
  is 'Indicates that the account is locked or not allowing or restricting access.
Values: Y, N';
comment on column SFDRISDDATA.USER_ACCOUNT.employee_id
  is 'The Employee identifier of number.';
comment on column SFDRISDDATA.USER_ACCOUNT.active_account_flag
  is 'Indicates that the account is currently active for use or has been deactivated.
Values: Y, N';
comment on column SFDRISDDATA.USER_ACCOUNT.last_login_date
  is 'The date and time that the user last successfully logged into a reveal application.';
comment on column SFDRISDDATA.USER_ACCOUNT.first_login_flag
  is 'A flag to indicate that the user has not logged in before and needs to complete additional

security setup.
Values: Y/N';
comment on column SFDRISDDATA.USER_ACCOUNT.attempt_ctr
  is 'Identifies the number failed attempts to log on by this user';
alter table SFDRISDDATA.USER_ACCOUNT
...
prompt ==========================
prompt
create table SFDRISDDATA.STUDENT_DIM
(
...
comment on table SFDRISDDATA.STUDENT_DIM
  is 'Identifies a person who receives instruction from a district/campus.';
comment on column SFDRISDDATA.STUDENT_DIM.postal_code
  is 'Students zip code. may include plus 4. Example: 75444-3333';
comment on column SFDRISDDATA.STUDENT_DIM.phone_number
  is 'Students Primary contact phone number digits only.  Example: 5558884444';
comment on column SFDRISDDATA.STUDENT_DIM.gender
  is 'Students Gender Values: Male/Female';
comment on column SFDRISDDATA.STUDENT_DIM.ethnicity
  is 'Hispanic or Not. Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.american_indian_alaska_native
  is 'Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.asian
  is 'Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.black_or_african_american
  is 'Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.native_hawaiian_pacific_island
  is 'Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.white
  is 'Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.two_or_more_races
  is 'Values Yes, No';
comment on column SFDRISDDATA.STUDENT_DIM.race_ethnicity_short_desc
  is 'Concatenation of Student ethnicity and races.
Example: Hispanic, Amer. Indian/Alaskan. , Asian, Black';
comment on column SFDRISDDATA.STUDENT_DIM.primary_language
  is 'Students primary spoken language.  Example: Spanish';
comment on column SFDRISDDATA.STUDENT_DIM.ninth_grade_cohort
  is 'The calculated year of graduation based on the year the student entered the ninth grade.';
comment on column SFDRISDDATA.STUDENT_DIM.limited_english_proficiency
...
Values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.lep_first_year_monitoring
  is 'Students who are in first year monitoring for limited english proficiency.
values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.lep_second_year_monitoring
  is 'Students who are in second year monitoring for limited english proficiency.
values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.immigrant
  is 'Students who are not naturalized citizens of the United States.
Values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.migrant
  is 'Student whose family frequently moves to follow seasonal work patterns.
Values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.economically_disadvantaged
...
Values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.special_education
  is 'Indicates that a student is participating a special education program.
Values: Yes/No';
comment on column SFDRISDDATA.STUDENT_DIM.meal_eligibility
...
examples:  Free
              ...
              , Unknown
';
comment on column SFDRISDDATA.STUDENT_DIM.primary_disability
...
';
comment on column SFDRISDDATA.STUDENT_DIM.secondary_disability
...
Examples: Emotional Disturbance,
  ...
  Learning Disability,
';
comment on column SFDRISDDATA.STUDENT_DIM.tertiary_disability
...
Examples: Emotional Disturbance,
  ...
  Learning Disability,
';
comment on column SFDRISDDATA.STUDENT_DIM.date_entered_ninth_grade
  is 'The date the student start the ninth grade.
Example: 8/24/2008';
comment on column SFDRISDDATA.STUDENT_DIM.student_photo
  is 'A picture of the student.';
comment on column SFDRISDDATA.STUDENT_DIM.race_ethnicity_key
...
------   =   Unknown
';
comment on column SFDRISDDATA.STUDENT_DIM.campus_security_key
...
comment on column SFDRISDDATA.STUDENT_DIM.district_security_key
  is 'The Current district of the student used to restrict data for security.
A concatenation of state code and district id.
Example: OK*8394839';
comment on column SFDRISDDATA.STUDENT_DIM.student_key
  is 'The business key for student.  A concatenation of State code, District id, and Student Id.';
comment on column SFDRISDDATA.STUDENT_DIM.campus_sid
  is 'Identifies the SID of the students currently enrolled campus.';
comment on column SFDRISDDATA.STUDENT_DIM.campus_id
  is 'Identifies the Campus Id of the students currently enrolled campus.';
comment on column SFDRISDDATA.STUDENT_DIM.user_sid
  is 'User Surrogate Key';
create bitmap index SFDRISDDATA.BMI_STU_DIM_DISTRICT_SID_FK on SFDRISDDATA.STUDENT_DIM (DISTRICT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.STUDENT_DIM
...
alter table SFDRISDDATA.STUDENT_DIM
  ...
  references SFDRISDDATA.USER_ACCOUNT (USER_SID);

prompt
prompt Creating table ATTENDANCE_RISK_FACTOR_FACT
prompt ==========================================
prompt
create table SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT
(
  campus_sid               NUMBER not null,
  student_sid              NUMBER not null,
  date_sid                 NUMBER not null,
...
comment on table SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  is 'Captures the results of the Risk Factor Calculation Engine for the attendance risk factor.';
comment on column SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT.period_absence_count
  is 'The number periods the student was absent on this day.
Example: 7';
comment on column SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT.ytd_period_absence_count
  is 'The total number of periods absent from the start of the school year unitl this date.
Example: 54';
comment on column SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT.ytd_days_enrolled
  is 'The total number days the student has been enrolled since the start of the school year unitl this date.
Example: 132';
comment on column SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT.period_absence_percent
  is 'The percent of instructional periods that the student has missed.
Example: .1323 (13.22%)';
comment on column SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT.last_update
  is 'The datetime that the row was insert/updated';
alter table SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_CAMPUS_D foreign key (CAMPUS_SID)
  references SFDRISDDATA.CAMPUS_DIM (CAMPUS_SID);
alter table SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_DATE_DIM foreign key (DATE_SID)
  references SFDRISDDATA.DATE_DIM (DATE_SID);
alter table SFDRISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_STUDENT_ foreign key (STUDENT_SID)
  references SFDRISDDATA.STUDENT_DIM (STUDENT_SID);

prompt
prompt Creating table BATCH_USER_ACCOUNT
prompt =================================
prompt
create table SFDRISDDATA.BATCH_USER_ACCOUNT
(
...
prompt ================================
prompt
create table SFDRISDDATA.BATCH_USER_CAMPUS
(
  district_id   VARCHAR2(50) not null,
  email_address VARCHAR2(75) not null,
...
prompt ==================================
prompt
create table SFDRISDDATA.BATCH_USER_LOAD_LOG
(
  district_id   VARCHAR2(50) not null,
  email_address VARCHAR2(75) not null,
...
prompt ==============================
prompt
create table SFDRISDDATA.BATCH_USER_ROLE
(
  district_id          VARCHAR2(50) not null,
  email_address        VARCHAR2(75) not null,
...
prompt ==========================
prompt
create table SFDRISDDATA.RISK_FACTOR
(
...
prompt ======================================
prompt
create table SFDRISDDATA.CAMPUS_FACTOR_SELECTION
(
  campus_sid      NUMBER not null,
  risk_factor_sid NUMBER not null,
  last_update     TIMESTAMP(6)
...
create bitmap index SFDRISDDATA.BMI_CAMPUS_FACT_SEL_RISK_SIDFK on SFDRISDDATA.CAMPUS_FACTOR_SELECTION (RISK_FACTOR_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.CAMPUS_FACTOR_SELECTION
...
alter table SFDRISDDATA.CAMPUS_FACTOR_SELECTION
  ...
  references SFDRISDDATA.RISK_FACTOR (RISK_FACTOR_SID);

prompt
prompt Creating table CAMPUS_MASTER
prompt ============================
prompt
create table SFDRISDDATA.CAMPUS_MASTER
(
...
nologging;
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_master_sid
  is 'Surrogate Key for the Campus Master';
comment on column SFDRISDDATA.CAMPUS_MASTER.school_id
  is 'The three digit identifier for the school.
Example: 102';
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_id
  is 'The nine digit identifier for the campus consisting of the district id and school id.
Example: 057901102';
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_name
  is 'The full name of the campus.
Example: SCHOOL FOR THE TALENTED AND GIFTED';
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_status
  is 'Identifies the current status of the school.
Example: ACTIVE,
              UNDER CONSTRUCTION,
              ';
comment on column SFDRISDDATA.CAMPUS_MASTER.region_name
  is 'The name of the regional service service center for this campus.
Example: Region 10,
                10';
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_state_code
  is 'The state abbreviation for the state that is campus resides in.';
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_grade_range
  is 'Defines the grade levels taught at this campus.
Example:  06-08,
                EE-05
';
comment on column SFDRISDDATA.CAMPUS_MASTER.periods_per_day
  is 'The number of scheduled periods per day at this campus.
Example: 7
8
4 (for A/B block schedule)';
comment on column SFDRISDDATA.CAMPUS_MASTER.attendance_threshold
  is 'The percentage threshold by which students will be flagged for the attendance risk factor.
Example: .10 - 10%
               .08 - 8%';
comment on column SFDRISDDATA.CAMPUS_MASTER.passing_grade_threshold
  is 'Defines the lowest pasing number grade at this campus.
Example: 70 (default),
                60,
                80';
comment on column SFDRISDDATA.CAMPUS_MASTER.default_grading_cycle
  is 'Defines the grading cycle to be used by the core/non-core risk factor for this campus.
Values: 6-Weeks,
             9-Weeks';
comment on column SFDRISDDATA.CAMPUS_MASTER.campus_key
  is 'Uniquely identifies a campus. A concatenation of the state code, district id, and campus id.
Example: TX*043901*043901001';
comment on column SFDRISDDATA.CAMPUS_MASTER.last_update
  is 'Date the row was created or last updated.';
alter table SFDRISDDATA.CAMPUS_MASTER
...
prompt =====================================
prompt
create table SFDRISDDATA.CAMPUS_RISK_FACTOR_DIM
(
...
alter table SFDRISDDATA.CAMPUS_RISK_FACTOR_DIM
...
prompt ===============================
prompt
create table SFDRISDDATA.CLASS_PERIOD_DIM
(
...
comment on table SFDRISDDATA.CLASS_PERIOD_DIM
  is 'Identifies the division of the day assigned the a particular class of instruction.';
comment on column SFDRISDDATA.CLASS_PERIOD_DIM.class_period_sid
  is 'Surrogate Key for Class Period Dim.';
comment on column SFDRISDDATA.CLASS_PERIOD_DIM.campus_sid
  is 'The Campus Sid of the campus that owns the class periods.';
comment on column SFDRISDDATA.CLASS_PERIOD_DIM.class_period
...
prompt =========================
prompt
create table SFDRISDDATA.COURSE_DIM
(
...
comment on table SFDRISDDATA.COURSE_DIM
  is 'A state or locally define curriculum of instruction.';
comment on column SFDRISDDATA.COURSE_DIM.course_sid
  is 'Surrogate Key for the Course Dim.';
comment on column SFDRISDDATA.COURSE_DIM.campus_id
  is 'Identifes the campus that owns this particular course.
example: 888888002';
comment on column SFDRISDDATA.COURSE_DIM.course_code
  is 'The local distrcit/campus identifier for course.';
comment on column SFDRISDDATA.COURSE_DIM.course_description
  is 'The local name or description of course.';
comment on column SFDRISDDATA.COURSE_DIM.school_year
  is 'The applicable school year for this course.
Example: 2010';
comment on column SFDRISDDATA.COURSE_DIM.state_course_code
  is 'The state defined code for the course
Example: 03330100';
comment on column SFDRISDDATA.COURSE_DIM.state_course_description
  is 'The name/description of the state defined course.
Example: US GOVT';
comment on column SFDRISDDATA.COURSE_DIM.core_course_flag
  is 'Indicates that this state course is a "core" course for the purposes of the Failed Course flags.
Values: Yes/No';
comment on column SFDRISDDATA.COURSE_DIM.course_key
...
alter table SFDRISDDATA.COURSE_DIM
...
prompt =================================
prompt
create table SFDRISDDATA.COURSE_SECTION_DIM
(
...
comment on table SFDRISDDATA.COURSE_SECTION_DIM
  is 'Identifies a scheduled course.';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.course_section_sid
  is 'Surrogate key for the Course Section Dim.';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.campus_id
  is 'Identifies the Campus where this section of the course is taught.
Example: 19902002
';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.course_code
  is 'Identifies the Course being taught.
Example: 1001';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.course_description
  is 'Describes the Course being taught.
Example: ENGLISH 1  ';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.course_section_number
  is 'Identifies the Course Section being taught.
Example: 001';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.school_year
  is 'Describes the school year for the Course Section being taught.
Example: 2011';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.term
...
Example: 1 (Semester or trimester)
                ...
                3 (trimester),
                 Y (Full Year)';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.state_course_code
  is 'Identifies the associated State course for the Course Section being taught.
Example: 03220100';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.state_course_description
  is 'Describes the associated State course for the Course Section being taught.
Example: English I (1 Unit) (ENG 1)';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.core_course_flag
  is 'Identifies if the Course Section being taught is a Core Course.
Values: Yes/No';
comment on column SFDRISDDATA.COURSE_SECTION_DIM.course_section_key
...
comment on column SFDRISDDATA.COURSE_SECTION_DIM.last_update
  is 'The Date/Time the row as last inserted or updated.';
alter table SFDRISDDATA.COURSE_SECTION_DIM
...
prompt =====================================
prompt
create table SFDRISDDATA.DEMO_CONSTRAINT_LOOKUP
(
...
alter table SFDRISDDATA.DEMO_CONSTRAINT_LOOKUP
...
prompt =============================
prompt
create table SFDRISDDATA.DEMO_CUSTOMERS
(
...
create index SFDRISDDATA.DEMO_CUST_NAME_IX on SFDRISDDATA.DEMO_CUSTOMERS (CUST_LAST_NAME, CUST_FIRST_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.DEMO_CUSTOMERS
...
prompt ==========================
prompt
create table SFDRISDDATA.DEMO_ORDERS
(
...
create index SFDRISDDATA.DEMO_ORD_CUSTOMER_IX on SFDRISDDATA.DEMO_ORDERS (CUSTOMER_ID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.DEMO_ORDERS
...
alter table SFDRISDDATA.DEMO_ORDERS
  ...
  references SFDRISDDATA.DEMO_CUSTOMERS (CUSTOMER_ID);
alter table SFDRISDDATA.DEMO_ORDERS
...
prompt ================================
prompt
create table SFDRISDDATA.DEMO_PRODUCT_INFO
(
...
alter table SFDRISDDATA.DEMO_PRODUCT_INFO
...
prompt ===============================
prompt
create table SFDRISDDATA.DEMO_ORDER_ITEMS
(
...
alter table SFDRISDDATA.DEMO_ORDER_ITEMS
...
alter table SFDRISDDATA.DEMO_ORDER_ITEMS
  ...
  references SFDRISDDATA.DEMO_ORDERS (ORDER_ID) on delete cascade;
alter table SFDRISDDATA.DEMO_ORDER_ITEMS
  add constraint DEMO_ORDER_ITEMS_PRODUCT_ID_FK foreign key (PRODUCT_ID)
  references SFDRISDDATA.DEMO_PRODUCT_INFO (PRODUCT_ID) on delete cascade;

prompt
prompt Creating table DEMO_STATES
prompt ==========================
prompt
create table SFDRISDDATA.DEMO_STATES
(
  st         VARCHAR2(30),
...
prompt =============================
prompt
create table SFDRISDDATA.DISCIPLINE_DIM
(
...
prompt =================================
prompt
create table SFDRISDDATA.DWS_GLOBAL_DEFAULT
(
...
comment on table SFDRISDDATA.DWS_GLOBAL_DEFAULT
  is 'Contains default vaules that are applied at various times during system operation.';
comment on column SFDRISDDATA.DWS_GLOBAL_DEFAULT.campus_periods_per_day
  is 'Defines the default number of periods per day to be applied to new campuses.
Default Value = 7';
comment on column SFDRISDDATA.DWS_GLOBAL_DEFAULT.campus_attendance_threshold
  is 'Defines the default attendance threshold to be applied to new campuses.
Default Value = .10 (10%)';
comment on column SFDRISDDATA.DWS_GLOBAL_DEFAULT.campus_passing_grade_threshold
  is 'Defines the default passing grade for students at a campus to be applied to new campuses.
Default Value: 70';
comment on column SFDRISDDATA.DWS_GLOBAL_DEFAULT.campus_default_grading_cycle
...
prompt ========================================
prompt
create table SFDRISDDATA.DWS_INTERVENTION_CATEGORY
(
...
comment on column SFDRISDDATA.DWS_INTERVENTION_CATEGORY.intervention_category_sid
  is 'Surrogate key for the intervention category';
comment on column SFDRISDDATA.DWS_INTERVENTION_CATEGORY.intervention_category
  is 'Describes a grouping of interventions.
Examples: Tutoring,
                Mentoring,
               Counseling';
comment on column SFDRISDDATA.DWS_INTERVENTION_CATEGORY.intervention_category_desc
  is 'Describes the intervention category.';
comment on column SFDRISDDATA.DWS_INTERVENTION_CATEGORY.active_flag
  is 'Indicates if the catefory is actively in use or not.
Values: Y/N';
alter table SFDRISDDATA.DWS_INTERVENTION_CATEGORY
...
prompt ===============================
prompt
create table SFDRISDDATA.DWS_INTERVENTION
(
...
comment on column SFDRISDDATA.DWS_INTERVENTION.intervention_sid
  is 'Surrogate Key for the Intervention';
comment on column SFDRISDDATA.DWS_INTERVENTION.create_by_user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.DWS_INTERVENTION.last_update_user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.DWS_INTERVENTION.intervention_name
  is 'The specific name of the intervention.
example : Math Tutoring,
                Parent Conference,
                Attendance Monitoring';
comment on column SFDRISDDATA.DWS_INTERVENTION.intervention_description
  is 'Describes the intervention.';
comment on column SFDRISDDATA.DWS_INTERVENTION.intervention_comment
  is 'User comments about the intervention';
comment on column SFDRISDDATA.DWS_INTERVENTION.active_flag
  is 'Indicates if the Intervention is in use or not.
Values: Y/N';
comment on column SFDRISDDATA.DWS_INTERVENTION.create_date
  is 'The date and time the Intervention was created.';
comment on column SFDRISDDATA.DWS_INTERVENTION.last_update
  is 'The date and time the Intervention was last updated.';
alter table SFDRISDDATA.DWS_INTERVENTION
...
alter table SFDRISDDATA.DWS_INTERVENTION
  ...
  references SFDRISDDATA.DWS_INTERVENTION_CATEGORY (INTERVENTION_CATEGORY_SID);
alter table SFDRISDDATA.DWS_INTERVENTION
...
prompt =========================================
prompt
create table SFDRISDDATA.DWS_INTERVENTION_NOTE_TYPE
(
...
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_sid
  is 'Surrogate key for the intervention note type';
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_name
  is 'The name of the type of note.
example: Status/Update
               Parent Conference
               Student Conference
                Other';
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_desc
  is 'describes the type of note.';
alter table SFDRISDDATA.DWS_INTERVENTION_NOTE_TYPE
...
prompt ==========================================
prompt
create table SFDRISDDATA.DWS_STU_INTERVENTION_STATUS
(
...
comment on column SFDRISDDATA.DWS_STU_INTERVENTION_STATUS.intervention_status_sid
  is 'Surrogate Key for the Student Intervention Status';
comment on column SFDRISDDATA.DWS_STU_INTERVENTION_STATUS.intervention_status
  is 'Indicates the state of the intervention.
Example: Open,
                Hold,
                Closed';
comment on column SFDRISDDATA.DWS_STU_INTERVENTION_STATUS.intervention_status_desc
  is 'describes the intervention status.
example: The "Hold" status indicates that the student is temporarily not 
participating in the intervention.';
alter table SFDRISDDATA.DWS_STU_INTERVENTION_STATUS
...
prompt =======================================
prompt
create table SFDRISDDATA.DWS_STUDENT_INTERVENTION
(
...
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.student_intervention_sid
  is 'Surrogate key for the student Intervention';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.created_by_user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.last_update_user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.intervention_begin_date
  is 'The date on which the student begins the intervention';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.intervention_end_date
  is 'The date on which the intervention for the student end or ended.';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.intervention_goal
...
of the semester.';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.intervention_plan
...
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.intervention_result_comment
...
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.intervention_result_rank
  is 'Ranks the result of the intervention on a scale of 1 to 5.
1 being unsuccessful and 5 being completely successful.
Values: 1 - 5';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.create_date
  is 'Date and time the Intervention was created';
comment on column SFDRISDDATA.DWS_STUDENT_INTERVENTION.last_update
  is 'Date and time the Intervention was last updated';
alter table SFDRISDDATA.DWS_STUDENT_INTERVENTION
...
alter table SFDRISDDATA.DWS_STUDENT_INTERVENTION
  ...
  references SFDRISDDATA.DWS_INTERVENTION (INTERVENTION_SID);
alter table SFDRISDDATA.DWS_STUDENT_INTERVENTION
  add constraint FK_DWS_STU_INV_REF_DWS_INV_STS foreign key (INTERVENTION_STATUS_SID)
  references SFDRISDDATA.DWS_STU_INTERVENTION_STATUS (INTERVENTION_STATUS_SID);
alter table SFDRISDDATA.DWS_STUDENT_INTERVENTION
...
prompt ====================================
prompt
create table SFDRISDDATA.DWS_INTERVENTION_NOTE
(
...
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE.intervention_note_sid
  is 'Surrogate Key for the intervention Note';
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE.user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE.intervention_note_dt
  is 'The date and time that the note was created';
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE.intervention_note_text
  is 'The user enter text describing some event related to the intervention.';
comment on column SFDRISDDATA.DWS_INTERVENTION_NOTE.last_update
  is 'The date and time the note was last updated.  Will initially be the same as the creation date.';
alter table SFDRISDDATA.DWS_INTERVENTION_NOTE
...
alter table SFDRISDDATA.DWS_INTERVENTION_NOTE
  ...
  references SFDRISDDATA.DWS_INTERVENTION_NOTE_TYPE (INTERVENTION_NOTE_TYPE_SID);
alter table SFDRISDDATA.DWS_INTERVENTION_NOTE
...
alter table SFDRISDDATA.DWS_INTERVENTION_NOTE
  ...
  references SFDRISDDATA.DWS_STUDENT_INTERVENTION (STUDENT_INTERVENTION_SID);

prompt
prompt Creating table DWS_STUDENT_NOTE
prompt ===============================
prompt
create table SFDRISDDATA.DWS_STUDENT_NOTE
(
...
comment on column SFDRISDDATA.DWS_STUDENT_NOTE.note_author_sid
  is 'User Surrogate Key';
alter table SFDRISDDATA.DWS_STUDENT_NOTE
...
prompt =========================
prompt
create table SFDRISDDATA.EMAIL_TYPE
(
...
comment on column SFDRISDDATA.EMAIL_TYPE.email_type_sid
  is 'Surrogate Key for the Email Type';
comment on column SFDRISDDATA.EMAIL_TYPE.email_type
  is 'Indicates the kind of email.
Example: New User,
                Password Reset,
                Welcome to Reveal,
                System Maintenance';
alter table SFDRISDDATA.EMAIL_TYPE
...
prompt ==================================
prompt
create table SFDRISDDATA.EMAIL_SPECIFICATION
(
...
comment on column SFDRISDDATA.EMAIL_SPECIFICATION.email_sid
  is 'Surrogate Key for the Email Specification.';
comment on column SFDRISDDATA.EMAIL_SPECIFICATION.email_type_sid
  is 'Surrogate Key for the Email Type';
comment on column SFDRISDDATA.EMAIL_SPECIFICATION.email_subject
  is 'Email Subject Line.
Example: Password Reset Request ';
comment on column SFDRISDDATA.EMAIL_SPECIFICATION.email_body
...
';
comment on column SFDRISDDATA.EMAIL_SPECIFICATION.application_link
  is 'The HTML link to the appliction login.';
comment on column SFDRISDDATA.EMAIL_SPECIFICATION.salutation
  is 'The closing of the email.
Example:
Sincerely,
The SchoolViz Support Team';
alter table SFDRISDDATA.EMAIL_SPECIFICATION
...
alter table SFDRISDDATA.EMAIL_SPECIFICATION
  ...
  references SFDRISDDATA.EMAIL_TYPE (EMAIL_TYPE_SID);

prompt
prompt Creating table EMP
prompt ==================
prompt
create table SFDRISDDATA.EMP
(
...
alter table SFDRISDDATA.EMP
  ...
  references SFDRISDDATA.DEPT (DEPTNO);
alter table SFDRISDDATA.EMP
  add foreign key (MGR)
  references SFDRISDDATA.EMP (EMPNO);

prompt
prompt Creating table ETL_EVENT_LOG
prompt ============================
prompt
create table SFDRISDDATA.ETL_EVENT_LOG
(
...
nologging;
comment on column SFDRISDDATA.ETL_EVENT_LOG.event_time
  is 'Defaults to SYSDATE';
comment on column SFDRISDDATA.ETL_EVENT_LOG.event_type
  is 'Values: Warning, Informational, Error';
comment on column SFDRISDDATA.ETL_EVENT_LOG.source_name
  is 'Values: Cognos, PL/SQL, Perl, SQL*Loader, Other';
comment on column SFDRISDDATA.ETL_EVENT_LOG.status
  is 'Values: Started, Running, Failed, Succeeded';
comment on column SFDRISDDATA.ETL_EVENT_LOG.elapsed_time
  is 'In seconds';
create index SFDRISDDATA.BMI_EVENT_LOG_EVENT_TYPE on SFDRISDDATA.ETL_EVENT_LOG (EVENT_TYPE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.BMI_EVENT_LOG_STATUS on SFDRISDDATA.ETL_EVENT_LOG (STATUS)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.ETL_EVENT_LOG
...
prompt =============================================
prompt
create table SFDRISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE
(
...
comment on table SFDRISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE
  is 'Converts CDM grading period to CORE Grade_Type as well as identifing the associated period number.';
comment on column SFDRISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.cdm_grading_period
  is 'The GradingPeriod from the TSDS CDM model.
Example: First Six Weeks,
                Second Nine Weeks,
                Second Semester';
comment on column SFDRISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.period_number
  is 'Grading Period for specific Grade Type';
comment on column SFDRISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.cycle_type
...
prompt ============================
prompt
create table SFDRISDDATA.EXECUTION_LOG
(
...
comment on table SFDRISDDATA.EXECUTION_LOG
  is 'Tracks information about each run of the risk factor calculation engine or the load process.';
comment on column SFDRISDDATA.EXECUTION_LOG.execution_start_time
  is 'The datetime that the engine started processing this risk factor';
comment on column SFDRISDDATA.EXECUTION_LOG.process_name
  is 'Name of the process being run
Example: Attendance
               CoreCourseFailure
               ';
comment on column SFDRISDDATA.EXECUTION_LOG.process_type
  is 'Type of process being run
Example: RCE
               District Load
               Campus Load';
comment on column SFDRISDDATA.EXECUTION_LOG.execution_end_time
  is 'The datetime that the engine stopped processing this risk factor';
comment on column SFDRISDDATA.EXECUTION_LOG.execution_result
  is 'The outcome of the execution.
Values: Successful
             Failed';
alter table SFDRISDDATA.EXECUTION_LOG
...
prompt ==================================
prompt
create table SFDRISDDATA.EXECUTION_PARAMETER
(
  execution_start_time TIMESTAMP(6) not null,
  campus_sid           NUMBER not null,
...
comment on table SFDRISDDATA.EXECUTION_PARAMETER
  is 'Contains the parameters used in the execution of a system process.';
comment on column SFDRISDDATA.EXECUTION_PARAMETER.execution_start_time
  is 'The datetime that the engine started processing this risk factor';
comment on column SFDRISDDATA.EXECUTION_PARAMETER.parameter_name
  is 'The name of the parameter used in the risk factor calculation.
Example: Periods Per Day
                Attendance Threshold';
comment on column SFDRISDDATA.EXECUTION_PARAMETER.parameter_value
  is 'The Value of the first parameter used in the risk factor calculation.
Example: 7';
alter table SFDRISDDATA.EXECUTION_PARAMETER
...
alter table SFDRISDDATA.EXECUTION_PARAMETER
  ...
  references SFDRISDDATA.EXECUTION_LOG (EXECUTION_START_TIME, CAMPUS_SID);

prompt
prompt Creating table GRADE_LEVEL_DIM
prompt ==============================
prompt
create table SFDRISDDATA.GRADE_LEVEL_DIM
(
...
comment on table SFDRISDDATA.GRADE_LEVEL_DIM
  is 'Identifies the student grade level.
Example: 01
                PK
                KG
                12';
comment on column SFDRISDDATA.GRADE_LEVEL_DIM.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column SFDRISDDATA.GRADE_LEVEL_DIM.grade_level
  is 'Identifies a students assigned grade.
Example: 01
                02
                12';
comment on column SFDRISDDATA.GRADE_LEVEL_DIM.grade_level_description
  is 'Describes a grade level.
Example: First Grade
               Second Grade
               Twelth Grade';
comment on column SFDRISDDATA.GRADE_LEVEL_DIM.grade_level_order
  is 'Indicates the order of the grade levels for sorting.
Example: 1
                2
                3
';
alter table SFDRISDDATA.GRADE_LEVEL_DIM
...
prompt =============================
prompt
create table SFDRISDDATA.GRADE_TYPE_DIM
(
...
comment on table SFDRISDDATA.GRADE_TYPE_DIM
...
Example: Progess Report
               ...
               Exam
';
comment on column SFDRISDDATA.GRADE_TYPE_DIM.grade_type_sid
  is 'Surrogate Key for the Grade Type dim';
comment on column SFDRISDDATA.GRADE_TYPE_DIM.grade_type
...
Example: Six Weeks,
                ...
                Exam,
                Final';
comment on column SFDRISDDATA.GRADE_TYPE_DIM.grade_type_description
  is 'The Full Description of the grade type.
Example: The six weeks grade revceived by the student';
comment on column SFDRISDDATA.GRADE_TYPE_DIM.last_update
  is 'The data time this row was last insert/updated';
alter table SFDRISDDATA.GRADE_TYPE_DIM
...
prompt ====================================
prompt
create table SFDRISDDATA.INCIDENT_BEHAVIOR_DIM
(
...
comment on table SFDRISDDATA.INCIDENT_BEHAVIOR_DIM
  is 'Identifies the student behaviors associated with a discipline event.';
comment on column SFDRISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_sid
  is 'Uniquely identifies an incident behavior.';
comment on column SFDRISDDATA.INCIDENT_BEHAVIOR_DIM.campus_id
  is 'Campus Id copied from the campus dim.';
comment on column SFDRISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_code
  is 'Local code that identifies a student behavior associated with an incident.';
comment on column SFDRISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_description
  is 'Describes a students behavior
Example: Permanent Removal By A Teacher From Class,
               Alcoholic Beverage,
               Bullying';
comment on column SFDRISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_category
  is 'Grouping of behaviors
Examples: School Code of Conduct,
                  State Offense';
comment on column SFDRISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_key
  is 'Business key for the incident behavior. Consisting of the state code, campus id
and behavior code.
Example: TX*849304001*37';
alter table SFDRISDDATA.INCIDENT_BEHAVIOR_DIM
...
prompt ====================================
prompt
create table SFDRISDDATA.INCIDENT_LOCATION_DIM
(
...
comment on table SFDRISDDATA.INCIDENT_LOCATION_DIM
  is 'The location where a discipline incident took place';
comment on column SFDRISDDATA.INCIDENT_LOCATION_DIM.incident_location_sid
  is 'Uniquely identifies the Incident Location';
comment on column SFDRISDDATA.INCIDENT_LOCATION_DIM.incident_location
  is 'Identifies the place where an incident took place.
Example: Classroom,
                Cafeteria area,
                Unknown';
comment on column SFDRISDDATA.INCIDENT_LOCATION_DIM.incident_location_key
  is 'Business key for the incident location.
Example: TX*108909*Classroom';
alter table SFDRISDDATA.INCIDENT_LOCATION_DIM
...
prompt =========================================
prompt
create table SFDRISDDATA.MERGED_STUDENT_RISK_FACTOR
(
  student_sid       NUMBER not null,
  risk_factor_sid   NUMBER not null,
...
comment on table SFDRISDDATA.MERGED_STUDENT_RISK_FACTOR
...
comment on column SFDRISDDATA.MERGED_STUDENT_RISK_FACTOR.flag_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.MERGED_STUDENT_RISK_FACTOR.end_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.MERGED_STUDENT_RISK_FACTOR.risk_factor_count
  is 'Measure used by report tools to count number of studnets with risk factors.
Value 1';
alter table SFDRISDDATA.MERGED_STUDENT_RISK_FACTOR
...
prompt ===============================
prompt
create table SFDRISDDATA.NINTH_GRD_COHORT
(
...
prompt =================================
prompt
create table SFDRISDDATA.RACE_ETHNICITY_DIM
(
...
comment on table SFDRISDDATA.RACE_ETHNICITY_DIM
  is 'Idenitfies the ethnicity and race selections of a person.';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_sid
  is 'Surrogate key';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.yes_no_key
...
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.binary_key
...
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_key
  is 'The race ethnicity key is used for look up puposes.  It is a positional map of the selected options.
values:
0 - not selected
HIABPW - selected
...
------   =   Unknown
';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.ethnicity
  is 'Indicates that the individual selected Hispanic/Latino(Yes) or Not Hispanic/Latino(No).
Values:
Yes
No';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.ethnicity_description
  is 'Values:
Hispanic/Latino
Not Hispanic/Latino';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.american_indian_alaska_native
  is 'Indicates that the individual selected American Indian/Alaska Native(Yes) or Not American Indian/Alaska Native(No).
Values:
Yes
No';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.amer_indian_alaskan_desc
  is 'Values:
American Indian or Alaska Native
Not American Indian or Alaska Native';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.asian
  is 'Indicates that the individual selected Asian(Yes) or Not Asian(No).
Values:
Yes
No';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.asian_description
  is 'Values:
Asian
Not Asian';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.black_or_african_american
  is 'Indicates that the individual selected Black or African American(Yes) or Not Black or African American(No).
Values:
Yes
No';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.black_african_amer_desc
  is 'Values:
Black or African American
Not Black or African American';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.native_hawaiian_pacific_island
...
Yes
No';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.hawaiian_pacific_island_desc
  is 'Values:
Native Hawaiian/Other Pacific Islander
Not Native Hawaiian/Other Pacific Islander';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.white
  is 'Indicates that the individual selected White(Yes) or Not White(No).
Values:
Yes
No';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.white_description
  is 'Values:
White
Not White';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.two_or_more_races
  is 'Indicates that two or more races were selected.
Example:
Asian, White';
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_long_desc
...
comment on column SFDRISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_short_desc
...
Black, White';
alter table SFDRISDDATA.RACE_ETHNICITY_DIM
...
prompt =====================
prompt
create table SFDRISDDATA.SOURCE
(
...
comment on table SFDRISDDATA.SOURCE
  is 'The source of data for the reporting category.';
comment on column SFDRISDDATA.SOURCE.source_sid
  is 'Uniquely identifies the source.';
comment on column SFDRISDDATA.SOURCE.source_name
  is 'The name of the source of the data of the reporting category.
Example: TxEIS,
                TexasStudentDataSystem(TSDS),
                 Jira';
comment on column SFDRISDDATA.SOURCE.source_description
  is 'Description of the Source.';
comment on column SFDRISDDATA.SOURCE.active_flag
  is 'Indicates if the source is available for use.
Values: Y/N';
alter table SFDRISDDATA.SOURCE
...
prompt ==============================
prompt
create table SFDRISDDATA.REPORT_CATEGORY
(
...
comment on table SFDRISDDATA.REPORT_CATEGORY
  is 'Defines the groupings of reports. Such as Student, Registration, Health, etc.';
comment on column SFDRISDDATA.REPORT_CATEGORY.source_sid
  is 'Uniquely identifies the source.';
comment on column SFDRISDDATA.REPORT_CATEGORY.report_category
  is 'Used to group reports together.
  Example: Student,
                  Finance';
comment on column SFDRISDDATA.REPORT_CATEGORY.report_category_description
  is 'Describes the REPORT CATEGORY';
comment on column SFDRISDDATA.REPORT_CATEGORY.active_flag
  is 'denotes if the category is in use.
Values: Y/N';
alter table SFDRISDDATA.REPORT_CATEGORY
...
alter table SFDRISDDATA.REPORT_CATEGORY
  ...
  references SFDRISDDATA.SOURCE (SOURCE_SID);

prompt
prompt Creating table REPORT_TYPE
prompt ==========================
prompt
create table SFDRISDDATA.REPORT_TYPE
(
...
comment on table SFDRISDDATA.REPORT_TYPE
  is 'The kind of report';
alter table SFDRISDDATA.REPORT_TYPE
...
prompt ==========================
prompt
create table SFDRISDDATA.REPORT_LIST
(
...
comment on column SFDRISDDATA.REPORT_LIST.report_name
  is 'The name of the report to be displayed on the main page.';
comment on column SFDRISDDATA.REPORT_LIST.report_description
  is 'Describes the REPORT';
comment on column SFDRISDDATA.REPORT_LIST.report_alias
  is 'The APEX page alias for the report, used in the link to the page';
comment on column SFDRISDDATA.REPORT_LIST.report_category_sid
  is 'Foriegn key to report_category table';
comment on column SFDRISDDATA.REPORT_LIST.active_flag
  is 'Used to indicate if a flag is active for use or not.
  values: Y,
           N';
alter table SFDRISDDATA.REPORT_LIST
...
alter table SFDRISDDATA.REPORT_LIST
  ...
  references SFDRISDDATA.REPORT_CATEGORY (REPORT_CATEGORY_SID)
  deferrable initially deferred;
alter table SFDRISDDATA.REPORT_LIST
  add constraint FK_REPORT_L_REFERENCE_REPORT_T foreign key (REPORT_TYPE_SID)
  references SFDRISDDATA.REPORT_TYPE (REPORT_TYPE_SID);

prompt
prompt Creating table RF_DISPLAY_COLUMNS
prompt =================================
prompt
create table SFDRISDDATA.RF_DISPLAY_COLUMNS
(
  campus_sid               NUMBER not null,
...
alter table SFDRISDDATA.RF_DISPLAY_COLUMNS
...
prompt =====================================
prompt
create table SFDRISDDATA.SECURITY_QUESTION_TYPE
(
...
comment on column SFDRISDDATA.SECURITY_QUESTION_TYPE.security_question_type_sid
  is 'Surrogate Key for the Security Question Type';
comment on column SFDRISDDATA.SECURITY_QUESTION_TYPE.security_question_type_name
  is 'Denotes the type of Security Question.
Values: Login,
            External IP Address,
            Password Reset';
comment on column SFDRISDDATA.SECURITY_QUESTION_TYPE.security_question_type_desc
...
system.';
alter table SFDRISDDATA.SECURITY_QUESTION_TYPE
...
prompt ================================
prompt
create table SFDRISDDATA.SECURITY_QUESTION
(
...
comment on column SFDRISDDATA.SECURITY_QUESTION.security_question_sid
  is 'Surrogate Key for the security Question';
comment on column SFDRISDDATA.SECURITY_QUESTION.security_question_type_sid
  is 'Surrogate Key for the Security Question Type';
comment on column SFDRISDDATA.SECURITY_QUESTION.security_question
  is 'A question used to identify a valid user.
Example: What is your birth city?';
alter table SFDRISDDATA.SECURITY_QUESTION
...
alter table SFDRISDDATA.SECURITY_QUESTION
  ...
  references SFDRISDDATA.SECURITY_QUESTION_TYPE (SECURITY_QUESTION_TYPE_SID);

prompt
prompt Creating table SECURITY_TRANSACTION_LOG
prompt =======================================
prompt
create table SFDRISDDATA.SECURITY_TRANSACTION_LOG
(
...
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.security_transaction_sid
  is 'Surrogate key for the logon transaction.';
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.user_id
  is 'The User ID of the person attempting to login.';
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.transaction_date
  is 'Date and time of the security transaction.';
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.log_message
...
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.action_type
...
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.action_result
  is 'Indicates the result of the users action. Example: Successful, Failed';
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.attempts
...
comment on column SFDRISDDATA.SECURITY_TRANSACTION_LOG.user_ip_address
...
alter table SFDRISDDATA.SECURITY_TRANSACTION_LOG
...
prompt ===============================
prompt
create table SFDRISDDATA.SO_DISTRICT_COPY
(
...
prompt ============================
prompt
create table SFDRISDDATA.SO_EMAIL_LDAP
(
  ldap_email     VARCHAR2(100),
  ldap_user_id   VARCHAR2(100),
  ldap_user_name VARCHAR2(100),
...
prompt =============================
prompt
create table SFDRISDDATA.SO_LDAP_EXPORT
(
...
create bitmap index SFDRISDDATA.BMI_TRANS_NBR on SFDRISDDATA.SO_LDAP_EXPORT (TRANS_NBR)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create bitmap index SFDRISDDATA.BMI_TRANS_TYPE on SFDRISDDATA.SO_LDAP_EXPORT (TRANS_TYPE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ===============================
prompt
create table SFDRISDDATA.STATE_COURSE_DIM
(
...
comment on table SFDRISDDATA.STATE_COURSE_DIM
  is 'Contains all of the state defined courses.';
comment on column SFDRISDDATA.STATE_COURSE_DIM.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column SFDRISDDATA.STATE_COURSE_DIM.state_code
  is 'The upper case two character state code for this course.
Example: TX';
comment on column SFDRISDDATA.STATE_COURSE_DIM.state_course_code
  is 'The state defined code for the course
Example: 03330100';
comment on column SFDRISDDATA.STATE_COURSE_DIM.state_course_description
  is 'The name/description of the state defined course.
Example: US GOVT';
comment on column SFDRISDDATA.STATE_COURSE_DIM.core_course_flag
  is 'Indicates that this state course is a "core" course for the purposes of the Failed Course flags.
Values: Yes/No';
comment on column SFDRISDDATA.STATE_COURSE_DIM.state_course_key
  is 'The business key used to look state courses. Consisting of the state code * state course code
Example: TX*049304939';
alter table SFDRISDDATA.STATE_COURSE_DIM
...
prompt ==================================
prompt
create table SFDRISDDATA.STUDENT_CREDIT_FACT
(
...
comment on table SFDRISDDATA.STUDENT_CREDIT_FACT
...
comment on column SFDRISDDATA.STUDENT_CREDIT_FACT.student_credit_fact_sid
  is 'A surrogate key for the fact.';
comment on column SFDRISDDATA.STUDENT_CREDIT_FACT.course_sid
  is 'Surrogate Key for the Course Dim.';
comment on column SFDRISDDATA.STUDENT_CREDIT_FACT.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column SFDRISDDATA.STUDENT_CREDIT_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_CREDIT_FACT.credits_earned
  is 'The number of credits earned by a student for a particular course.
Example: 1.0,
                0.5,
                0.25
                0.333';
comment on column SFDRISDDATA.STUDENT_CREDIT_FACT.local_credits_earned
  is 'This is the value for credits earned from the source.
Examples: 10
                  5
                  NC';
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
...
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
  ...
  references SFDRISDDATA.ACADEMIC_RECORD_SOURCE_DIM (ACADEMIC_SOURCE_CODE);
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
...
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
  ...
  references SFDRISDDATA.COURSE_DIM (COURSE_SID);
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
...
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
  ...
  references SFDRISDDATA.STATE_COURSE_DIM (STATE_COURSE_SID);
alter table SFDRISDDATA.STUDENT_CREDIT_FACT
...
prompt ======================================
prompt
create table SFDRISDDATA.STUDENT_CREDIT_FACT_ERR
(
...
prompt ======================================
prompt
create table SFDRISDDATA.STUDENT_CREDIT_FACT_REJ
(
  student_credit_fact_sid NUMBER not null,
  campus_sid              NUMBER not null,
  course_sid              NUMBER not null,
...
prompt =============================================
prompt
create table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
(
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  date_sid                      NUMBER not null,
...
comment on table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
  is 'Actions taken as a result of a student discipline incident.';
comment on column SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.date_sid
...
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_length_diff_reason_sid
  is 'Uniquely identifies the Action Length Diff Reason Dim';
comment on column SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.discipline_sid
  is 'Uniquely identifies the Discipline DIM';
comment on column SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.incident_number
  is 'The discipline incident number associated with this action.';
comment on column SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_assigned_days
  is 'The number of days assigned for the action.';
comment on column SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_actual_days
  is 'The number of days actually served for this action.';
alter table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
alter table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
  ...
  references SFDRISDDATA.ACTION_LENGTH_DIFF_REASON_DIM (ACTION_LENGTH_DIFF_REASON_SID);
alter table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
alter table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
  ...
  references SFDRISDDATA.DISCIPLINE_DIM (DISCIPLINE_SID);
alter table SFDRISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
prompt ========================================
prompt
create table SFDRISDDATA.STUDENT_DISC_ACT_FACT_ERR
(
  exception_type                VARCHAR2(75),
  campus_sid                    NUMBER,
  student_sid                   NUMBER,
...
prompt ========================================
prompt
create table SFDRISDDATA.STUDENT_DISC_ACT_FACT_REJ
(
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  date_sid                      NUMBER not null,
...
prompt ======================================
prompt
create table SFDRISDDATA.STUDENT_ENROLLMENT_FACT
(
  campus_sid          NUMBER not null,
  student_sid         NUMBER not null,
...
comment on column SFDRISDDATA.STUDENT_ENROLLMENT_FACT.entry_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_ENROLLMENT_FACT.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column SFDRISDDATA.STUDENT_ENROLLMENT_FACT.withdrawal_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_ENROLLMENT_FACT.last_update
  is 'Date that this records was last updated';
alter table SFDRISDDATA.STUDENT_ENROLLMENT_FACT
...
alter table SFDRISDDATA.STUDENT_ENROLLMENT_FACT
  ...
  references SFDRISDDATA.GRADE_LEVEL_DIM (GRADE_LEVEL_SID);
alter table SFDRISDDATA.STUDENT_ENROLLMENT_FACT
...
prompt ==========================================
prompt
create table SFDRISDDATA.STUDENT_ENROLLMENT_FACT_ERR
(
  load_sid            NUMBER,
...
prompt ==========================================
prompt
create table SFDRISDDATA.STUDENT_ENROLLMENT_FACT_REJ
(
  campus_sid          NUMBER not null,
  student_sid         NUMBER not null,
  entry_date_sid      NUMBER not null,
...
prompt =================================
prompt
create table SFDRISDDATA.STUDENT_GRADE_FACT
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
comment on table SFDRISDDATA.STUDENT_GRADE_FACT
  is 'Captures a students grade.
Grain = 1 Row/ student/Course Section/date/Grade Type';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.academic_source_code
  is 'A code that indicates what kind of Academic Source .
Example: T - transfer
               C - Classroom
               E - Exam
               O - online';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.number_grade
  is 'The numerical grade received by a student.
Example: 100,
                 75.6
                 50.07';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.letter_grade
  is 'The letter grade received by a student.
Example: A,
                B,
                 P,
                 NG';
comment on column SFDRISDDATA.STUDENT_GRADE_FACT.last_update
  is 'The date/time the row was inserted or updated.';
alter table SFDRISDDATA.STUDENT_GRADE_FACT
...
alter table SFDRISDDATA.STUDENT_GRADE_FACT
  ...
  references SFDRISDDATA.COURSE_SECTION_DIM (COURSE_SECTION_SID);
alter table SFDRISDDATA.STUDENT_GRADE_FACT
...
alter table SFDRISDDATA.STUDENT_GRADE_FACT
  ...
  references SFDRISDDATA.GRADE_TYPE_DIM (GRADE_TYPE_SID);

prompt
prompt Creating table STUDENT_GRADE_FACT_ERR
prompt =====================================
prompt
create table SFDRISDDATA.STUDENT_GRADE_FACT_ERR
(
  load_sid           NUMBER,
  exception_type     VARCHAR2(200),
...
prompt =====================================
prompt
create table SFDRISDDATA.STUDENT_GRADE_FACT_REJ
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
prompt ==========================================
prompt
create table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
comment on table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
  is 'Transactional fact to record when a student is abscent from a class period.';
comment on column SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT.period_absence_count
  is 'A measure for this fact table.  Value: 1';
create index SFDRISDDATA.NDX_STU_PRD_ABS_DATE_SID_FK on SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT (DATE_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
...
alter table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
  ...
  references SFDRISDDATA.ABSENCE_REASON_DIM (ABSENCE_REASON_SID);
alter table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
...
alter table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
  ...
  references SFDRISDDATA.CLASS_PERIOD_DIM (CLASS_PERIOD_SID);
alter table SFDRISDDATA.STUDENT_PERIOD_ABSENCE_FACT
...
prompt ==========================================
prompt
create table SFDRISDDATA.STUDENT_PERIOD_ABS_FACT_ERR
(
  exception_type     VARCHAR2(200),
...
prompt ==========================================
prompt
create table SFDRISDDATA.STUDENT_PERIOD_ABS_FACT_REJ
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
prompt ======================================
prompt
create table SFDRISDDATA.STUDENT_PERIOD_OVERRIDE
(
  campus_sid      NUMBER not null,
  student_sid     NUMBER not null,
  periods_per_day NUMBER,
...
comment on table SFDRISDDATA.STUDENT_PERIOD_OVERRIDE
  is 'Overides the default campus periods per day for a particular student for the current semester.
Example: 5';
alter table SFDRISDDATA.STUDENT_PERIOD_OVERRIDE
...
prompt =======================================
prompt
create table SFDRISDDATA.STUDENT_RISK_FACTOR_FACT
(
  campus_sid             NUMBER not null,
  student_sid            NUMBER not null,
  flag_date_sid          NUMBER not null,
...
comment on table SFDRISDDATA.STUDENT_RISK_FACTOR_FACT
  is 'Grain = 1 row /student/risk factor/effective date';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_FACT.flag_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_FACT.end_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_FACT.risk_factor_count
  is 'A measure defined for Cognos reporting; Value 1';
create index SFDRISDDATA.NDX_STU_RISK_FACTOR_STU_SID_FK on SFDRISDDATA.STUDENT_RISK_FACTOR_FACT (STUDENT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.STUDENT_RISK_FACTOR_FACT
...
alter table SFDRISDDATA.STUDENT_RISK_FACTOR_FACT
  ...
  references SFDRISDDATA.CAMPUS_RISK_FACTOR_DIM (CAMPUS_RISK_FACTOR_SID);
alter table SFDRISDDATA.STUDENT_RISK_FACTOR_FACT
...
prompt ============================================
prompt
create table SFDRISDDATA.STUDENT_RISK_FACTOR_PHASE_SUM
(
  campus_sid        NUMBER not null,
  date_sid          NUMBER not null,
  student_sid       NUMBER not null,
...
alter table SFDRISDDATA.STUDENT_RISK_FACTOR_PHASE_SUM
...
prompt ===========================================
prompt
create table SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT
(
  campus_sid                     NUMBER not null,
  student_sid                    NUMBER not null,
  date_sid                       NUMBER not null,
...
comment on table SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT
...
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.attendance_flag
  is 'Indicates that the student was flagged for attendance during this snapshot period.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_attendance_flag
  is 'Indicates that the student was flagged for attendance at the end of an academic semester.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.core_course_failure_flag
  is 'Indicates that the student was flagged for failing a core course during a marking period.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.non_core_course_failure_flag
  is 'Indicates that the student was flagged for failing a non-core course during a marking period.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_core_crs_failure_flag
  is 'Indicates that the student was flagged for failing a core course for a semester.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_noncore_crs_fail_flag
  is 'Indicates that the student was flagged for failing a non-core course for a semester.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.gpa_flag
  is 'Indicates that the student was flagged for a GPA below minium established standard.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.deficient_credits_flag
  is 'Indicates that the student was flagged for having to few credits for a semester.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.discipline_flag
  is 'Indicates that the student was flagged for behavorial problems.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.grade_6_thru_8_retention_flag
  is 'Indicates that the student was flagged for having been retained in grades 6 through 8 one or more times.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.cohort_flag
  is 'Indicates that the student was at risk of not graduating with his/her 9th grade class.
Values: Yes, No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.other_flag
...
Values: Yes/No';
comment on column SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.risk_factor_count
  is 'The total number of risk factors flagged Yes for this student on this date.
Example: 3';
create index SFDRISDDATA.NDX_STU_RISK_SNAPSHOT_DATE_FK on SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT (DATE_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SFDRISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT
...
prompt ===========================================
prompt
create table SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT
(
  campus_sid            NUMBER not null,
  student_sid           NUMBER not null,
  date_sid              NUMBER not null,
...
comment on table SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT
  is 'The occurrence of an incident that may or may not result in a student discipline action.';
comment on column SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian
...
Example:
120100708  for district with sid 1';
comment on column SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT.incident_location_sid
  is 'Uniquely identifies the Incident Location';
comment on column SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT.incident_behavior_sid
  is 'Uniquely identifies an incident behavior.';
alter table SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT
...
alter table SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT
  ...
  references SFDRISDDATA.INCIDENT_BEHAVIOR_DIM (INCIDENT_BEHAVIOR_SID);
alter table SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT
  add constraint FK_STU_DIS_INC_REF_INC_LOC foreign key (INCIDENT_LOCATION_SID)
  references SFDRISDDATA.INCIDENT_LOCATION_DIM (INCIDENT_LOCATION_SID);
alter table SFDRISDDATA.STU_DISCIPLINE_INCIDENT_FACT
...
prompt ====================================
prompt
create table SFDRISDDATA.STU_DISC_INC_FACT_ERR
(
  exception_type        VARCHAR2(75),
  campus_sid            NUMBER,
  student_sid           NUMBER,
...
prompt ====================================
prompt
create table SFDRISDDATA.STU_DISC_INC_FACT_REJ
(
  campus_sid            NUMBER not null,
  student_sid           NUMBER not null,
  date_sid              NUMBER not null,
...
prompt =================================
prompt
create table SFDRISDDATA.TALEND_ETL_PROCESS
(
...
alter table SFDRISDDATA.TALEND_ETL_PROCESS
...
prompt ========================================
prompt
create table SFDRISDDATA.TALEND_FLOW_METER_CATCHER
(
  moment            TIMESTAMP(6),
  pid               VARCHAR2(20),
...
create index SFDRISDDATA.IX_ACTION_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (ACTION)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_EXTRACT_DATE_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_JOB_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LABEL_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (LABEL)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LEA_NAME_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LEA_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_MOMENT_TFC on SFDRISDDATA.TALEND_FLOW_METER_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==================================
prompt
create table SFDRISDDATA.TALEND_LEA_CONTEXTS
(
  batch_gid     NUMBER,
...
prompt =================================
prompt
create table SFDRISDDATA.TALEND_LOG_CATCHER
(
  moment       TIMESTAMP(6),
  pid          VARCHAR2(20),
  root_pid     VARCHAR2(20),
...
create index SFDRISDDATA.IX_EXTRACT_DATE_TLC on SFDRISDDATA.TALEND_LOG_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_JOB_TLC on SFDRISDDATA.TALEND_LOG_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LEA_NAME_TLC on SFDRISDDATA.TALEND_LOG_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LEA_TLC on SFDRISDDATA.TALEND_LOG_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_MOMENT_TLC on SFDRISDDATA.TALEND_LOG_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==================================
prompt
create table SFDRISDDATA.TALEND_STAT_CATCHER
(
  moment            TIMESTAMP(6),
  pid               VARCHAR2(20),
  father_pid        VARCHAR2(20),
...
create index SFDRISDDATA.IX_EXTRACT_DATE_TSC on SFDRISDDATA.TALEND_STAT_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_JOB_TSC on SFDRISDDATA.TALEND_STAT_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LEA_NAME_TSC on SFDRISDDATA.TALEND_STAT_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_LEA_TSC on SFDRISDDATA.TALEND_STAT_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SFDRISDDATA.IX_MOMENT_TSC on SFDRISDDATA.TALEND_STAT_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==========================================
prompt
create table SFDRISDDATA.TXSTU_USER_STUDENT_SECURITY
(
...
alter table SFDRISDDATA.TXSTU_USER_STUDENT_SECURITY
...
prompt ==========================
prompt
create table SFDRISDDATA.USER_CAMPUS
(
...
comment on column SFDRISDDATA.USER_CAMPUS.user_campus_sid
  is 'Surrogate Key for the User Campus';
comment on column SFDRISDDATA.USER_CAMPUS.user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.USER_CAMPUS.campus_master_sid
  is 'Surrogate Key for the Campus Master';
alter table SFDRISDDATA.USER_CAMPUS
...
alter table SFDRISDDATA.USER_CAMPUS
  ...
  references SFDRISDDATA.CAMPUS_MASTER (CAMPUS_MASTER_SID);
alter table SFDRISDDATA.USER_CAMPUS
...
prompt ==========================
prompt
create table SFDRISDDATA.USER_REPORT
(
...
comment on table SFDRISDDATA.USER_REPORT
  is 'A specific report assigned to a user.';
comment on column SFDRISDDATA.USER_REPORT.user_sid
  is 'User Surrogate Key';
alter table SFDRISDDATA.USER_REPORT
...
alter table SFDRISDDATA.USER_REPORT
  ...
  references SFDRISDDATA.REPORT_LIST (REPORT_LIST_SID);
alter table SFDRISDDATA.USER_REPORT
...
prompt ===================================
prompt
create table SFDRISDDATA.USER_REPORT_CATEGORY
(
...
comment on table SFDRISDDATA.USER_REPORT_CATEGORY
  is 'Defines which report categorys a user is allowed acces.';
comment on column SFDRISDDATA.USER_REPORT_CATEGORY.user_sid
  is 'User Surrogate Key';
alter table SFDRISDDATA.USER_REPORT_CATEGORY
...
prompt ========================
prompt
create table SFDRISDDATA.USER_ROLE
(
...
comment on column SFDRISDDATA.USER_ROLE.user_role_sid
  is 'User Role Surrogate Key';
comment on column SFDRISDDATA.USER_ROLE.user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.USER_ROLE.application_role_sid
  is 'Surrogate Key for the Application Role';
comment on column SFDRISDDATA.USER_ROLE.default_application_flag
  is 'Denotes which application the user will be connected to after successful login(authorization).
Values: Y/N';
alter table SFDRISDDATA.USER_ROLE
...
alter table SFDRISDDATA.USER_ROLE
  ...
  references SFDRISDDATA.APPLICATION_ROLE (APPLICATION_ROLE_SID);
alter table SFDRISDDATA.USER_ROLE
...
prompt =====================================
prompt
create table SFDRISDDATA.USER_SECURITY_QUESTION
(
...
comment on column SFDRISDDATA.USER_SECURITY_QUESTION.user_security_question_sid
  is 'Surrogate Key for the User Security Question';
comment on column SFDRISDDATA.USER_SECURITY_QUESTION.security_question_sid
  is 'Surrogate Key for the security Question';
comment on column SFDRISDDATA.USER_SECURITY_QUESTION.user_sid
  is 'User Surrogate Key';
comment on column SFDRISDDATA.USER_SECURITY_QUESTION.user_response
  is 'The users answer to the security question.';
alter table SFDRISDDATA.USER_SECURITY_QUESTION
...
alter table SFDRISDDATA.USER_SECURITY_QUESTION
  ...
  references SFDRISDDATA.SECURITY_QUESTION (SECURITY_QUESTION_SID);
alter table SFDRISDDATA.USER_SECURITY_QUESTION
...
prompt ====================================
prompt
create table SFDRISDDATA.USER_STUDENT_SECURITY
(
  user_id      VARCHAR2(75) not null,
  district_sid NUMBER not null,
  student_sid  NUMBER not null
...
alter table SFDRISDDATA.USER_STUDENT_SECURITY
...
prompt ===============================
prompt
create sequence SFDRISDDATA.DEMO_CUST_SEQ
minvalue 1
...
prompt ======================================
prompt
create sequence SFDRISDDATA.DEMO_ORDER_ITEMS_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 50
increment by 1
...
prompt ==============================
prompt
create sequence SFDRISDDATA.DEMO_ORD_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 11
increment by 1
...
prompt ===============================
prompt
create sequence SFDRISDDATA.DEMO_PROD_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 11
increment by 1
...
prompt ==========================
prompt
create sequence SFDRISDDATA.DEPT_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 50
increment by 1
...
prompt =========================
prompt
create sequence SFDRISDDATA.EMP_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 8000
increment by 1
...
prompt ==============================
prompt
create sequence SFDRISDDATA.SID_SEQUENCE
minvalue 1
maxvalue 999999999999999999999999999
start with 8873904
increment by 1
...
prompt ===========================
prompt
create or replace synonym SFDRISDDATA.CR_ATT_CAL
  for ;
...
prompt ===========================
prompt
create or replace synonym SFDRISDDATA.CR_ATT_OPT
  for ;
...
prompt ========================
prompt
create or replace synonym SFDRISDDATA.CR_DEMO
  for ;
...
prompt =============================
prompt
create or replace synonym SFDRISDDATA.CR_INSTR_CYR
  for ;
...
prompt ===================================
prompt
create or replace synonym SFDRISDDATA.DR_CRS_OFFERED_CYR
  for ;
...
prompt ========================
prompt
create or replace synonym SFDRISDDATA.DR_DEMO
  for ;
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.ET_C012_GEN
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.ET_C035_INSTRUCTSET
  for ;
...
prompt =================================
prompt
create or replace synonym SFDRISDDATA.ET_C053_HANDICAP
  for ;
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.ET_C061_LEP
  for ;
...
prompt ===================================
prompt
create or replace synonym SFDRISDDATA.ET_C093_PARPERMISS
  for ;
...
prompt ================================
prompt
create or replace synonym SFDRISDDATA.ET_C095_SPTHRPY
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.ET_C131_YRENDSTATUS
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.ET_C175_BIL_PGM_TYP
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.ET_C176_ESL_PGM_TYP
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.PKG_REVEAL_SECURITY
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.SR_ATT_POST
  for ;
...
prompt ===========================
prompt
create or replace synonym SFDRISDDATA.SR_CRS_GRD
  for ;
...
prompt ===========================
prompt
create or replace synonym SFDRISDDATA.SR_DISCPLN
  for ;
...
prompt ================================
prompt
create or replace synonym SFDRISDDATA.SR_DISCPLN_ACTN
  for ;
...
prompt =================================
prompt
create or replace synonym SFDRISDDATA.SR_DISCPLN_OFENS
  for ;
...
prompt =====================================
prompt
create or replace synonym SFDRISDDATA.SR_GRADEBK_HINT_INST
  for ;
...
prompt =================================
prompt
create or replace synonym SFDRISDDATA.SR_GRADEBK_LOGIN
  for ;
...
prompt =============================
prompt
create or replace synonym SFDRISDDATA.SR_HINT_QUES
  for ;
...
prompt ===========================
prompt
create or replace synonym SFDRISDDATA.SR_IMMUNIZ
  for ;
...
prompt ==========================
prompt
create or replace synonym SFDRISDDATA.SR_PARENT
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.SR_SPEC_PGM_BIL_ESL
  for ;
...
prompt ==================================
prompt
create or replace synonym SFDRISDDATA.SR_SPEC_PGM_CHAP1
  for ;
...
prompt ===============================
prompt
create or replace synonym SFDRISDDATA.SR_SPEC_PGM_GT
  for ;
...
prompt ==================================
prompt
create or replace synonym SFDRISDDATA.SR_SPEC_PGM_OTHER
  for ;
...
prompt ========================================
prompt
create or replace synonym SFDRISDDATA.SR_SPEC_PGM_PREG_PUPILS
  for ;
...
prompt ====================================
prompt
create or replace synonym SFDRISDDATA.SR_SPEC_PGM_SPEC_ED
  for ;
...
prompt ==============================
prompt
create or replace synonym SFDRISDDATA.SR_STU_CAMPUS
  for ;
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.SR_STU_DEMO
  for ;
...
prompt ==================================
prompt
create or replace synonym SFDRISDDATA.SR_STU_DEMO_PEIMS
  for ;
...
prompt ==============================
prompt
create or replace synonym SFDRISDDATA.SR_STU_ENROLL
  for ;
...
prompt =============================
prompt
create or replace synonym SFDRISDDATA.ST_ACTIVE_CD
  for ;
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.ST_ATT_POST
  for ;
...
prompt ================================
prompt
create or replace synonym SFDRISDDATA.ST_DISCPLN_ACTN
  for ;
...
prompt ===============================
prompt
create or replace synonym SFDRISDDATA.ST_IMMUNIZ_TYP
  for ;
...
prompt ==========================
prompt
create or replace synonym SFDRISDDATA.ST_LOC_CD
  for ;
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.ST_OFENS_CD
  for ;
...
prompt =============================
prompt
create or replace synonym SFDRISDDATA.ST_OFENS_LVL
  for ;
...
prompt ==============================
prompt
create or replace synonym SFDRISDDATA.ST_REC_STATUS
  for ;
...
prompt ============================
prompt
create or replace synonym SFDRISDDATA.ST_RELATION
  for ;
...
prompt ===============================
prompt
create or replace synonym SFDRISDDATA.ST_REP_EXCLUSN
  for ;
...
prompt ===============================
prompt
create or replace synonym SFDRISDDATA.ST_SERIES_TYPE
  for ;
...
prompt ==========================
prompt
create or replace synonym SFDRISDDATA.ST_WD_RSN
  for ;
...
prompt ===========================
prompt
create or replace force view sfdrisddata.application_v as
select
--ROWID as "ROW_ID",
APPLICATION_ID,
ACTIVE_FLAG,
...
prompt ======================================
prompt
create or replace force view sfdrisddata.execution_load_campus_vw as
...
prompt =================================
prompt
create or replace force view sfdrisddata.reveal_lea_contexts as
...
prompt ================================
prompt
create or replace force view sfdrisddata.reveal_log_catcher as
...
prompt ======================================
prompt
create or replace force view sfdrisddata.security_question_user_v as
select
    u.user_id
  , security_question
...
prompt ============================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.USER_ACCOUNT_V AS
SELECT
...
prompt ===============================
prompt
create or replace force view sfdrisddata.user_apps_roles_v as
select
    a.application_id
  , a.active_flag
  , a.description
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_STUDENT_MASTER AS
...
prompt ====================================
prompt
create or replace force view sfdrisddata.v_dws_all_risk_factors as
select
        STUDENT_DIM.STUDENT_SID,
...
prompt ==============================
prompt
create or replace force view sfdrisddata.v_dws_as_of_date as
...
prompt ==========================================
prompt
create or replace force view sfdrisddata.v_dws_campus_risk_factor_sum as
select
       a.campus_id,
       a.campus_name,
...
prompt ==================================
prompt
create or replace force view sfdrisddata.v_dws_champions_list as
select
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_CREDITS_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_CREDITS_SUMMARY AS
SELECT
...
prompt =====================================
prompt
create or replace force view sfdrisddata.v_dws_curr_risk_factors as
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_DISC_ACT_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_DISC_INC_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt =======================================
prompt
create or replace force view sfdrisddata.v_dws_disc_inc_act_detail as
select
...
prompt ======================================
prompt
create or replace force view sfdrisddata.v_dws_enrollment_history as
...
prompt =================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_GRADES_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt =====================================
prompt
create or replace package sfdrisddata."PKG_DWS_INTERVENTION" is
/* *******************************************
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_INTERVENTION AS
SELECT
INTERVENTION_SID
...
prompt ========================================
prompt
create or replace package sfdrisddata.PKG_DWS_INTERV_CATEGORY is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_INTERVENTION_CATEGORY AS
SELECT
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_INTERVENTION_NOTES AS
...
prompt ==========================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_INTERVENTION_NOTE_TYPE AS
SELECT
INTERVENTION_NOTE_TYPE_NAME
...
prompt =====================================
prompt
create or replace force view sfdrisddata.v_dws_period_abs_detail as
select STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.CURRENTLY_ENROLLED_CAMPUS_ID,
...
prompt ==================================
prompt
create or replace force view sfdrisddata.v_dws_period_abs_sum as
...
prompt ======================================
prompt
create or replace force view sfdrisddata.v_dws_period_abs_sum_rpt as
with pivot_data AS (
select
"STUDENT_DIM".STUDENT_SID,
"STUDENT_DIM".STUDENT_ID,
...
prompt ===========================================
prompt
create or replace force view sfdrisddata.v_dws_recently_added_students as
select
"STUDENT_DIM"."STUDENT_SID",
"CAMPUS_DIM"."CAMPUS_NAME",
...
prompt ====================================
prompt
create or replace force view sfdrisddata.v_dws_risk_factor_flow as
select
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_RISK_FACTOR_HISTORY AS
WITH RUN_LOG AS (
...
prompt ========================================
prompt
create or replace force view sfdrisddata.v_dws_student_intervention as
select
...
prompt ===========================================
prompt
create or replace force view sfdrisddata.v_dws_student_intervention_ir as
select
  DWS_STUDENT_INTERVENTION.STUDENT_SID,
  DWS_STUDENT_INTERVENTION.STUDENT_INTERVENTION_SID,
  DWS_INTERVENTION_CATEGORY.INTERVENTION_CATEGORY,
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_STUDENT_NOTE AS
...
prompt ============================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_STUDENT_RISK_FACTOR_LIST AS
SELECT DISTINCT
       DISTRICT_SECURITY_KEY,
       CAMPUS_SECURITY_KEY,
       CAMPUS_DIM.CAMPUS_ID,
...
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_DWS_STU_INTERVENTION_STATUS AS
SELECT
INTERVENTION_STATUS
...
prompt ======================================
prompt
create or replace force view sfdrisddata.v_dws_stu_risk_histogram as
select
 STUDENT_RISK_FACTOR_SNAPSHOT.RISK_FACTOR_COUNT,
...
prompt ==========================================
prompt
create or replace force view sfdrisddata.v_dws_wkly_attendance_rf_cnt as
select
...
prompt ===========================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_SCHOOL_YEAR AS
...
prompt =============================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_SCHOOL_YEAR_D AS
SELECT DISTINCT sch_yr school_year
,sch_yr
FROM CR_ATT_CAL;
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_ATT_DETAIL_D AS
SELECT
 SR_ATT_POST.SCH_YR
...
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_ATT_STU_ENROLL_DETAIL AS
SELECT
...
prompt ====================================
prompt
create or replace force view sfdrisddata.v_txstu_contact_parent as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_CONTACT_PARENT_D AS
SELECT
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_GRADEBK_LOGIN AS
SELECT USER_ID,
       ACTIVE_CD,
...
prompt =====================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_GRADEBK_LOGIN_D AS
...
prompt ============================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_GRADES AS
SELECT
  STUDENT.SCH_YR
  ,STUDENT.CAMPUS_ID
  ,STUDENT.CAMPUS_NAME
...
prompt ==============================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_GRADES_D AS
SELECT
  SR_CRS_GRD.SCH_YR
...
prompt =============================
prompt
create or replace force view sfdrisddata.v_txstu_immuniz as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt ===============================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_IMMUNIZ_D AS
SELECT
STU_ID STUDENT_ID,
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_INSTRUCTOR AS
SELECT
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_INSTRUCTOR_D AS
SELECT
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_REGISTRATION AS
SELECT
...
prompt ====================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_REGISTRATION_D AS
SELECT
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_STU_CAMPUS_MASTER_D AS
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_TXSTU_STU_CAMPUS_MASTER AS
SELECT SCH_YR,
       GRD,
       GRDSORT,
       ENTRY_DT,
...
prompt =================================
prompt
create or replace force view sfdrisddata.v_tx_stu_discipline as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt ===================================
prompt
create or replace force view sfdrisddata.v_tx_stu_discipline_d as
select
d.sch_yr as SCH_YR,
...
prompt =============================
prompt
CREATE OR REPLACE FORCE VIEW SFDRISDDATA.V_USER_APP_LIST AS
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_CR_ATT_CAL
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_CR_ATT_OPT
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =====================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_CR_DEMO
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_CR_INSTR_CYR
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_DR_CRS_OFFERED_CYR
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =====================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_DR_DEMO
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C012_GEN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C035_INSTRUCTSET
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ==============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C053_HANDICAP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C061_LEP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C093_PARPERMISS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C095_SPTHRPY
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C131_YRENDSTATUS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C175_BIL_PGM_TYP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ET_C176_ESL_PGM_TYP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_ATT_POST
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_CRS_GRD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_DISCPLN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_DISCPLN_ACTN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_DISCPLN_OFENS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_GRADEBK_HINT_INST
REFRESH COMPLETE ON DEMAND
AS
SELECT
USER_ID,
...
prompt ==============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_GRADEBK_LOGIN
REFRESH COMPLETE ON DEMAND
AS
SELECT
USER_ID,
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_HINT_QUES
REFRESH COMPLETE ON DEMAND
AS
SELECT
QUES_ID,
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_IMMUNIZ
REFRESH COMPLETE ON DEMAND
AS
SELECT
STU_ID,
...
prompt =======================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_PARENT
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_SPEC_PGM_BIL_ESL
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ===============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_SPEC_PGM_CHAP1
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_SPEC_PGM_GT
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ===============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_SPEC_PGM_OTHER
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =====================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_SPEC_PGM_PREG_PUPILS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_SPEC_PGM_SPEC_ED
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ===========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_STU_CAMPUS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_STU_DEMO
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ===============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_STU_DEMO_PEIMS
REFRESH COMPLETE ON DEMAND
AS
SELECT
  SCH_YR,
...
prompt ===========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_SR_STU_ENROLL
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_ACTIVE_CD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_ATT_POST
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_DISCPLN_ACTN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_IMMUNIZ_TYP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =======================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_LOC_CD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_OFENS_CD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_OFENS_LVL
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ===========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_REC_STATUS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_RELATION
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_REP_EXCLUSN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_SERIES_TYPE
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =======================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_ST_WD_RSN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =====================================================
prompt
CREATE MATERIALIZED VIEW SFDRISDDATA.MV_TXSTU_STU_CAMPUS_BASE_D
REFRESH COMPLETE ON DEMAND
...
prompt ====================================================
prompt
create materialized view SFDRISDDATA.STUDENT_CREDIT_SUMMARY_MV
refresh complete on demand
as
select  distinct
    student_sid
...
prompt =========================================
prompt
create or replace package sfdrisddata.pkg_core_load_processing is
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE SFDRISDDATA."PKG_CORE_UTILITIES" is
...
prompt ==========================================
prompt
create or replace package sfdrisddata."PKG_DWS_INTERVENTION_NOTE" is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =================================
prompt
create or replace package sfdrisddata.PKG_DWS_SECURITY is
...
prompt =============================================
prompt
create or replace package sfdrisddata.PKG_DWS_STUDENT_INTERVENTION is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =====================================
prompt
create or replace package sfdrisddata.PKG_DWS_STUDENT_NOTE is
--------------------------------------------------------------
...
prompt ==========================
prompt
create or replace package sfdrisddata.PKG_EMAIL is
...
prompt ===============================================
prompt
create or replace package sfdrisddata.pkg_enrollment_post_processing is
...
prompt ============================================
prompt
create or replace package sfdrisddata.pkg_Risk_Calculation_Engine is
...
prompt =======================================
prompt
create or replace package sfdrisddata.PKG_RISK_FACTOR_CONFIG is
...
prompt =================================
prompt
CREATE OR REPLACE PACKAGE SFDRISDDATA.pkg_sv_acct_mgmt
AS
...
prompt ================================
prompt
CREATE OR REPLACE PACKAGE SFDRISDDATA."PKG_SV_SECURITY"
AS
...
prompt ===================================
prompt
create or replace package sfdrisddata.PKG_TXEIS_SECURITY is
...
prompt ==============================
prompt
CREATE OR REPLACE PACKAGE SFDRISDDATA."PKG_UTILITIES"
...
prompt =====================================
prompt
create or replace function sfdrisddata.demo_error_handling (
...
prompt ==============================================
prompt
create or replace package body sfdrisddata.pkg_core_load_processing is
...
prompt ========================================
prompt
CREATE OR REPLACE PACKAGE BODY SFDRISDDATA."PKG_CORE_UTILITIES" is
...
prompt ==========================================
prompt
create or replace package body sfdrisddata.PKG_DWS_INTERVENTION is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION
   procedure INS_DWS_INTERVENTION (
      P_INTERVENTION_CATEGORY_SID in number,
...
prompt ===============================================
prompt
create or replace package body sfdrisddata.PKG_DWS_INTERVENTION_NOTE is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION_NOTE
   procedure INS_DWS_INTERVENTION_NOTE (
      P_STUDENT_INTERVENTION_SID   in number,
...
prompt =============================================
prompt
create or replace package body sfdrisddata.PKG_DWS_INTERV_CATEGORY is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION_CATEGORY
   procedure INS_DWS_INTERVENTION_CATEGORY (
      P_INTERVENTION_CATEGORY      in varchar2,
...
prompt ======================================
prompt
create or replace package body sfdrisddata.PKG_DWS_SECURITY is
...
prompt ==================================================
prompt
create or replace package body sfdrisddata.PKG_DWS_STUDENT_INTERVENTION is
...
prompt ==========================================
prompt
create or replace package body sfdrisddata.PKG_DWS_STUDENT_NOTE is
--------------------------------------------------------------
-- create procedure for table DWS_STUDENT_NOTE
   procedure INS_DWS_STUDENT_NOTE (
      P_STUDENT_SID     in number,
...
prompt ===============================
prompt
create or replace package body sfdrisddata.PKG_EMAIL is
...
prompt ====================================================
prompt
create or replace package body sfdrisddata.pkg_enrollment_post_processing is
...
prompt =================================================
prompt
create or replace package body sfdrisddata.pkg_risk_calculation_engine is
...
prompt ============================================
prompt
create or replace package body sfdrisddata.PKG_RISK_FACTOR_CONFIG is
...
prompt ======================================
prompt
CREATE OR REPLACE PACKAGE BODY SFDRISDDATA.pkg_sv_acct_mgmt
AS
PROCEDURE proc_reset_email
          (  p_email_to IN VARCHAR2
            ,p_email_from IN VARCHAR2
...
prompt =====================================
prompt
CREATE OR REPLACE PACKAGE BODY SFDRISDDATA.pkg_sv_security
AS
PROCEDURE proc_login
          (
           p_uname IN VARCHAR2
...
prompt ========================================
prompt
create or replace package body sfdrisddata.PKG_TXEIS_SECURITY is
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE BODY SFDRISDDATA."PKG_UTILITIES"
AS
...
prompt =============================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_ACL_T1"
...
prompt ==================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_WS_FILES_T1"
...
prompt ==================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_WS_LINKS_T1"
...
prompt ==================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_WS_NOTES_T1"
...
prompt =================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_WS_ROWS_T1"
...
prompt =================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_WS_TAGS_T1"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."APEX$_WS_WEBPG_SECTIONS_T1"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."DEMO_ORDER_ITEMS_GET_PRICE"
...
prompt ==========================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA.dept_trg1
...
prompt =========================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA.emp_trg1
...
prompt =================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."INSERT_DEMO_CUST"
...
prompt ========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."INSERT_DEMO_ORDER_ITEMS"
...
prompt =================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."INSERT_DEMO_PROD"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA.maintain_campus_selections
...
prompt ============================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."TRG_ABS_RSN_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."TRG_CAMPUS_DIM_LAST_UPDATE"
...
prompt ==============================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."TRG_CLASS_PRD_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."TRG_COURSE_DIM_LAST_UPDATE"
...
prompt =============================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."TRG_CRS_SECT_DIM_LAST_UPDATE"
...
prompt =========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA.TRG_DIST_DIM_LAST_UPDATE
...
prompt ========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."TRG_STU_DIM_LAST_UPDATE"
...
prompt ===================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."UPDATE_ORDER_TOTAL"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."USER_ACCOUNT_BEFORE_INSERT"
BEFORE INSERT
    ON USER_ACCOUNT
    FOR EACH ROW
...
prompt ==========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."USER_CAMPUS_BEFORE_INSERT"
BEFORE INSERT
    ON USER_CAMPUS
    FOR EACH ROW
...
prompt ============================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."USER_QUESTION_BEFORE_INSERT"
BEFORE INSERT
...
prompt ========================================
prompt
CREATE OR REPLACE TRIGGER SFDRISDDATA."USER_ROLE_BEFORE_INSERT"
BEFORE INSERT
    ON USER_ROLE
    FOR EACH ROW
