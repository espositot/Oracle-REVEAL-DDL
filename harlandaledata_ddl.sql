-----------------------------------------------------------
-- Export file for user HARLANDALEDATA@DATAWH            --
-- Created by espositot on 5/26/2016, 15:59:12 15:59:12  --
-----------------------------------------------------------

set define off
spool harlandaledata_ddl.log

prompt
prompt Creating table DISTRICT_DIM
prompt ===========================
prompt
create table HARLANDALEDATA.DISTRICT_DIM
(
...
comment on table HARLANDALEDATA.DISTRICT_DIM
  is 'A local education agency.
Example: Dallas Independent School District';
comment on column HARLANDALEDATA.DISTRICT_DIM.district_area
  is 'The educational area or region in which the district is located.
Example: Region 10
';
comment on column HARLANDALEDATA.DISTRICT_DIM.district_key
  is 'Uniquely identifies a district.  A concatenation of state code and district id.
Example: TX*043901';
comment on column HARLANDALEDATA.DISTRICT_DIM.region_name
  is 'The name of the regional service service center for this campus.
Example: Region 10,
                10';
comment on column HARLANDALEDATA.DISTRICT_DIM.web_site
  is 'District Website address.';
comment on column HARLANDALEDATA.DISTRICT_DIM.password_expire_days
  is 'The number of days before since the last password change before a user must change their

password.';
comment on column HARLANDALEDATA.DISTRICT_DIM.password_max_attempts
  is 'The maximum number of times a user will be allowed to try to log on before their account is

locked.';
comment on column HARLANDALEDATA.DISTRICT_DIM.password_expire_month
  is 'The month number that user passwords will have to be changed.';
comment on column HARLANDALEDATA.DISTRICT_DIM.password_expire_day
  is 'The day of the month that user passwords will have to be changed.';
comment on column HARLANDALEDATA.DISTRICT_DIM.password_expiration_method
  is 'Specifies which method will be used to force users to change their passwords.
Values: Number Of Days
             Specific Month/Day';
comment on column HARLANDALEDATA.DISTRICT_DIM.district_security_question
  is 'A question to validate first time users.';
comment on column HARLANDALEDATA.DISTRICT_DIM.district_security_answer
  is 'The answer to the district security question.';
comment on column HARLANDALEDATA.DISTRICT_DIM.district_ip_range
...
alter table HARLANDALEDATA.DISTRICT_DIM
...
prompt =================================
prompt
create table HARLANDALEDATA.ABSENCE_REASON_DIM
(
...
comment on table HARLANDALEDATA.ABSENCE_REASON_DIM
  is 'The reason that a student missed instruction such as excused or unexcused.';
comment on column HARLANDALEDATA.ABSENCE_REASON_DIM.absence_reason_key
...
comment on column HARLANDALEDATA.ABSENCE_REASON_DIM.exclude_absence_reason
  is 'Indicates that the Absence Reason should be excluded from Risk Calculation Engine processing.
Values: Yes/No';
alter table HARLANDALEDATA.ABSENCE_REASON_DIM
...
alter table HARLANDALEDATA.ABSENCE_REASON_DIM
  ...
  references HARLANDALEDATA.DISTRICT_DIM (DISTRICT_SID);

prompt
prompt Creating table ACADEMIC_RECORD_SOURCE_DIM
prompt =========================================
prompt
create table HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM
(
...
comment on table HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM
  is 'Indicates the where the record of academic achievement came from, classroom, transfer, exam, etc...';
comment on column HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM.academic_source_code
  is 'A code that indicates what kind of Academic Source .
Example: T - transfer
               C - Classroom
               E - Exam
               O - online';
comment on column HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM.academic_source_description
  is 'Describes the Academic Source Code.
Examples: Transfer,
                 Classroom,
                 Exam,
                 Online';
create unique index HARLANDALEDATA.PK_CREDIT_TYPE_DIM on HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM (ACADEMIC_SOURCE_CODE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM
...
prompt ============================================
prompt
create table HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM
(
...
comment on table HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM
  is 'Describes why the assigned action length varies from the actual days served.';
comment on column HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason_sid
  is 'Uniquely identifies the Action Length Diff Reason Dim';
comment on column HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason
  is 'Description of why the assigned days varies from the actual days.
Example: Term Modified by District';
comment on column HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason_key
  is 'Business key for the Action Length Diff Reason Dim.
Example: TX*849395*Other';
alter table HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM
...
prompt =============================
prompt
create table HARLANDALEDATA.AD_CAMPUS_XREF
(
...
prompt ============================
prompt
create table HARLANDALEDATA.AD_FIRST_NAME
(
...
prompt ===========================
prompt
create table HARLANDALEDATA.AD_LAST_NAME
(
  name_sid  NUMBER not null,
...
prompt =============================
prompt
create table HARLANDALEDATA.AD_SCHOOL_NAME
(
  name_sid    NUMBER not null,
...
prompt =============================
prompt
create table HARLANDALEDATA.AD_STREET_NAME
(
  name_sid    NUMBER not null,
...
prompt ==============================
prompt
create table HARLANDALEDATA.AD_STUDENT_XREF
(
...
prompt ==========================
prompt
create table HARLANDALEDATA.APPLICATION
(
...
comment on column HARLANDALEDATA.APPLICATION.application_id
  is 'The APEX application number';
comment on column HARLANDALEDATA.APPLICATION.active_flag
  is 'Indicates if the application is currently active and available.
Values: Y, N';
comment on column HARLANDALEDATA.APPLICATION.description
  is 'Describes the Application';
comment on column HARLANDALEDATA.APPLICATION.application_alias
...
Example: DWS,
               REVIDMGR';
alter table HARLANDALEDATA.APPLICATION
...
prompt ==========================
prompt
create table HARLANDALEDATA.ROLE_MASTER
(
...
comment on column HARLANDALEDATA.ROLE_MASTER.role_sid
  is 'Surrogate Key for the User role';
comment on column HARLANDALEDATA.ROLE_MASTER.role
  is 'Defines a role that can be applied to an application and a user.
Example: District,
              Campus';
alter table HARLANDALEDATA.ROLE_MASTER
...
prompt ===============================
prompt
create table HARLANDALEDATA.APPLICATION_ROLE
(
...
comment on column HARLANDALEDATA.APPLICATION_ROLE.application_role_sid
  is 'Surrogate Key for the Application Role';
comment on column HARLANDALEDATA.APPLICATION_ROLE.role_sid
  is 'Surrogate Key for the User role';
alter table HARLANDALEDATA.APPLICATION_ROLE
...
alter table HARLANDALEDATA.APPLICATION_ROLE
  ...
  references HARLANDALEDATA.ROLE_MASTER (ROLE_SID);
alter table HARLANDALEDATA.APPLICATION_ROLE
  add constraint FK_APPL_REF_APP_ROLE foreign key (APPLICATION_ID)
  references HARLANDALEDATA.APPLICATION (APPLICATION_ID);

prompt
prompt Creating table CAMPUS_DIM
prompt =========================
prompt
create table HARLANDALEDATA.CAMPUS_DIM
(
  campus_sid              NUMBER not null,
  district_sid            NUMBER not null,
...
comment on table HARLANDALEDATA.CAMPUS_DIM
...
comment on column HARLANDALEDATA.CAMPUS_DIM.campus_name
  is 'Full name of the campus.
Example: McKinney Central High School,
               Frisco High School';
comment on column HARLANDALEDATA.CAMPUS_DIM.campus_short_name
  is 'Short name of the campus
Example: Central,
               Frisco HS';
comment on column HARLANDALEDATA.CAMPUS_DIM.periods_per_day
  is 'The number of scheduled periods per day at this campus.
Example: 7
8
4 (for A/B block schedule)';
comment on column HARLANDALEDATA.CAMPUS_DIM.attendance_threshold
  is 'The percentage threshold by which students will be flagged for the attendance risk factor.
Example: .10 - 10%
               .08 - 8%';
comment on column HARLANDALEDATA.CAMPUS_DIM.campus_key
  is 'Uniquely identifies a campus. A concatenation of the state code, district id, and campus id.
Example: TX*043901*043901001';
comment on column HARLANDALEDATA.CAMPUS_DIM.passing_grade_threshold
  is 'Defines the lowest pasing number grade at this campus.
Example: 70 (default),
                60,
                80';
comment on column HARLANDALEDATA.CAMPUS_DIM.default_grading_cycle
  is 'Defines the grading cycle to be used by the core/non-core risk factor for this campus.
Values: 6-Weeks,
             9-Weeks';
create bitmap index HARLANDALEDATA.BMI_CAMPUS_DIM_DISTRICT_FK on HARLANDALEDATA.CAMPUS_DIM (DISTRICT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.CAMPUS_DIM
...
prompt =======================
prompt
create table HARLANDALEDATA.DATE_DIM
(
...
comment on table HARLANDALEDATA.DATE_DIM
  is 'Identifies the common and districts specific calendars.';
comment on column HARLANDALEDATA.DATE_DIM.date_sid
...
comment on column HARLANDALEDATA.DATE_DIM.district_sid
  is 'Surrogate key';
comment on column HARLANDALEDATA.DATE_DIM.date_id
  is 'A specific day of the year';
comment on column HARLANDALEDATA.DATE_DIM.calendar_year
  is 'Example: 2009';
comment on column HARLANDALEDATA.DATE_DIM.calendar_year_quarter
  is 'Example: 2009 Q1';
comment on column HARLANDALEDATA.DATE_DIM.calendar_quarter
  is 'Example: 1';
comment on column HARLANDALEDATA.DATE_DIM.calendar_year_month
  is 'Example: 200912';
comment on column HARLANDALEDATA.DATE_DIM.calendar_month
  is 'Example: 12';
comment on column HARLANDALEDATA.DATE_DIM.calendar_month_name
  is 'Example: December';
comment on column HARLANDALEDATA.DATE_DIM.calendar_month_short_name
  is 'Example: Dec';
comment on column HARLANDALEDATA.DATE_DIM.calendar_week
  is 'Example: 50';
comment on column HARLANDALEDATA.DATE_DIM.day_of_week
...
7 (Saturday)
';
comment on column HARLANDALEDATA.DATE_DIM.day_of_week_name
  is 'Example: Thursday';
comment on column HARLANDALEDATA.DATE_DIM.day_of_week_short_name
  is 'Example: Thu';
comment on column HARLANDALEDATA.DATE_DIM.school_year
  is 'Begins Aug 1 of the calendar year and ends July 31 of the next calendar year.
Example: 2009';
comment on column HARLANDALEDATA.DATE_DIM.school_year_description
  is 'Example: 2009/2010';
comment on column HARLANDALEDATA.DATE_DIM.school_week
  is 'Example: 24';
comment on column HARLANDALEDATA.DATE_DIM.year_month_day
  is 'Example: 20091215';
comment on column HARLANDALEDATA.DATE_DIM.short_date
  is 'Example: 12/15/2009';
comment on column HARLANDALEDATA.DATE_DIM.long_date
  is 'Example: December 15, 2009';
comment on column HARLANDALEDATA.DATE_DIM.school_day_indicator
  is 'Denotes what type of school day this particular day represents.
Values:
Instructional
Professional
Non-Academic';
comment on column HARLANDALEDATA.DATE_DIM.academic_6_weeks
...
comment on column HARLANDALEDATA.DATE_DIM.academic_9_weeks
...
9
0 - non-instructional days';
comment on column HARLANDALEDATA.DATE_DIM.semester
  is 'Example: 1';
comment on column HARLANDALEDATA.DATE_DIM.first_day_academic_6_weeks
  is 'Values: Yes/No';
comment on column HARLANDALEDATA.DATE_DIM.last_day_academic_6_weeks
  is 'Values: Yes/No';
comment on column HARLANDALEDATA.DATE_DIM.first_day_academic_9_weeks
  is 'Values: Yes/No';
comment on column HARLANDALEDATA.DATE_DIM.last_day_academic_9_weeks
  is 'Values: Yes/No';
comment on column HARLANDALEDATA.DATE_DIM.first_day_semester
  is 'Values: Yes/No';
comment on column HARLANDALEDATA.DATE_DIM.last_day_semester
  is 'Values: Yes/No';
comment on column HARLANDALEDATA.DATE_DIM.date_key
...
alter table HARLANDALEDATA.DATE_DIM
...
prompt ===========================
prompt
create table HARLANDALEDATA.USER_ACCOUNT
(
...
comment on column HARLANDALEDATA.USER_ACCOUNT.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.USER_ACCOUNT.user_id
  is 'A unique name or email address that identifies a user of one or more applications.
example: jane.doe@anywhereISD.org';
comment on column HARLANDALEDATA.USER_ACCOUNT.password
  is 'Users encrypted password';
comment on column HARLANDALEDATA.USER_ACCOUNT.password_expiration_date
  is 'The date on which the users password will expire and need to be changed.';
comment on column HARLANDALEDATA.USER_ACCOUNT.password_update_date
  is 'The date on which the user last changed their password.';
comment on column HARLANDALEDATA.USER_ACCOUNT.user_first_name
  is 'First name of the user.';
comment on column HARLANDALEDATA.USER_ACCOUNT.user_last_name
  is 'Surname of the user.';
comment on column HARLANDALEDATA.USER_ACCOUNT.email_address
  is 'The email address of the user.';
comment on column HARLANDALEDATA.USER_ACCOUNT.created_by
  is 'The SID of the user that created this user account.';
comment on column HARLANDALEDATA.USER_ACCOUNT.create_date
  is 'The timestamp when the account was created.';
comment on column HARLANDALEDATA.USER_ACCOUNT.updated_by
  is 'The SID of the user that updated this user account.';
comment on column HARLANDALEDATA.USER_ACCOUNT.update_date
  is 'The timestamp when the account was updated.';
comment on column HARLANDALEDATA.USER_ACCOUNT.account_locked
  is 'Indicates that the account is locked or not allowing or restricting access.
Values: Y, N';
comment on column HARLANDALEDATA.USER_ACCOUNT.employee_id
  is 'The Employee identifier of number.';
comment on column HARLANDALEDATA.USER_ACCOUNT.active_account_flag
  is 'Indicates that the account is currently active for use or has been deactivated.
Values: Y, N';
comment on column HARLANDALEDATA.USER_ACCOUNT.last_login_date
  is 'The date and time that the user last successfully logged into a reveal application.';
comment on column HARLANDALEDATA.USER_ACCOUNT.first_login_flag
  is 'A flag to indicate that the user has not logged in before and needs to complete additional

security setup.
Values: Y/N';
comment on column HARLANDALEDATA.USER_ACCOUNT.attempt_ctr
  is 'Identifies the number failed attempts to log on by this user';
alter table HARLANDALEDATA.USER_ACCOUNT
...
prompt ==========================
prompt
create table HARLANDALEDATA.STUDENT_DIM
(
...
comment on table HARLANDALEDATA.STUDENT_DIM
  is 'Identifies a person who receives instruction from a district/campus.';
comment on column HARLANDALEDATA.STUDENT_DIM.postal_code
  is 'Students zip code. may include plus 4. Example: 75444-3333';
comment on column HARLANDALEDATA.STUDENT_DIM.phone_number
  is 'Students Primary contact phone number digits only.  Example: 5558884444';
comment on column HARLANDALEDATA.STUDENT_DIM.gender
  is 'Students Gender Values: Male/Female';
comment on column HARLANDALEDATA.STUDENT_DIM.ethnicity
  is 'Hispanic or Not. Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.american_indian_alaska_native
  is 'Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.asian
  is 'Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.black_or_african_american
  is 'Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.native_hawaiian_pacific_island
  is 'Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.white
  is 'Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.two_or_more_races
  is 'Values Yes, No';
comment on column HARLANDALEDATA.STUDENT_DIM.race_ethnicity_short_desc
  is 'Concatenation of Student ethnicity and races.
Example: Hispanic, Amer. Indian/Alaskan. , Asian, Black';
comment on column HARLANDALEDATA.STUDENT_DIM.primary_language
  is 'Students primary spoken language.  Example: Spanish';
comment on column HARLANDALEDATA.STUDENT_DIM.ninth_grade_cohort
  is 'The calculated year of graduation based on the year the student entered the ninth grade.';
comment on column HARLANDALEDATA.STUDENT_DIM.limited_english_proficiency
...
Values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.lep_first_year_monitoring
  is 'Students who are in first year monitoring for limited english proficiency.
values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.lep_second_year_monitoring
  is 'Students who are in second year monitoring for limited english proficiency.
values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.immigrant
  is 'Students who are not naturalized citizens of the United States.
Values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.migrant
  is 'Student whose family frequently moves to follow seasonal work patterns.
Values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.economically_disadvantaged
...
Values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.special_education
  is 'Indicates that a student is participating a special education program.
Values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_DIM.meal_eligibility
...
examples:  Free
              ...
              , Unknown
';
comment on column HARLANDALEDATA.STUDENT_DIM.primary_disability
...
';
comment on column HARLANDALEDATA.STUDENT_DIM.secondary_disability
...
Examples: Emotional Disturbance,
  ...
  Learning Disability,
';
comment on column HARLANDALEDATA.STUDENT_DIM.tertiary_disability
...
Examples: Emotional Disturbance,
  ...
  Learning Disability,
';
comment on column HARLANDALEDATA.STUDENT_DIM.date_entered_ninth_grade
  is 'The date the student start the ninth grade.
Example: 8/24/2008';
comment on column HARLANDALEDATA.STUDENT_DIM.student_photo
  is 'A picture of the student.';
comment on column HARLANDALEDATA.STUDENT_DIM.race_ethnicity_key
...
------   =   Unknown
';
comment on column HARLANDALEDATA.STUDENT_DIM.campus_security_key
...
comment on column HARLANDALEDATA.STUDENT_DIM.district_security_key
  is 'The Current district of the student used to restrict data for security.
A concatenation of state code and district id.
Example: OK*8394839';
comment on column HARLANDALEDATA.STUDENT_DIM.student_key
  is 'The business key for student.  A concatenation of State code, District id, and Student Id.';
comment on column HARLANDALEDATA.STUDENT_DIM.campus_sid
  is 'Identifies the SID of the students currently enrolled campus.';
comment on column HARLANDALEDATA.STUDENT_DIM.campus_id
  is 'Identifies the Campus Id of the students currently enrolled campus.';
comment on column HARLANDALEDATA.STUDENT_DIM.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.STUDENT_DIM.unique_state_id
  is 'Unique student id assigned by the state.';
create bitmap index HARLANDALEDATA.BMI_STU_DIM_DISTRICT_SID_FK on HARLANDALEDATA.STUDENT_DIM (DISTRICT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.STUDENT_DIM
...
alter table HARLANDALEDATA.STUDENT_DIM
  ...
  references HARLANDALEDATA.USER_ACCOUNT (USER_SID);

prompt
prompt Creating table ATTENDANCE_RISK_FACTOR_FACT
prompt ==========================================
prompt
create table HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT
(
  campus_sid               NUMBER not null,
  student_sid              NUMBER not null,
  date_sid                 NUMBER not null,
...
comment on table HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT
  is 'Captures the results of the Risk Factor Calculation Engine for the attendance risk factor.';
comment on column HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT.period_absence_count
  is 'The number periods the student was absent on this day.
Example: 7';
comment on column HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT.ytd_period_absence_count
  is 'The total number of periods absent from the start of the school year unitl this date.
Example: 54';
comment on column HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT.ytd_days_enrolled
  is 'The total number days the student has been enrolled since the start of the school year unitl this date.
Example: 132';
comment on column HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT.period_absence_percent
  is 'The percent of instructional periods that the student has missed.
Example: .1323 (13.22%)';
comment on column HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT.last_update
  is 'The datetime that the row was insert/updated';
alter table HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_CAMPUS_D foreign key (CAMPUS_SID)
  references HARLANDALEDATA.CAMPUS_DIM (CAMPUS_SID);
alter table HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_DATE_DIM foreign key (DATE_SID)
  references HARLANDALEDATA.DATE_DIM (DATE_SID);
alter table HARLANDALEDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_STUDENT_ foreign key (STUDENT_SID)
  references HARLANDALEDATA.STUDENT_DIM (STUDENT_SID);

prompt
prompt Creating table BATCH_USER_ACCOUNT
prompt =================================
prompt
create table HARLANDALEDATA.BATCH_USER_ACCOUNT
(
...
prompt ================================
prompt
create table HARLANDALEDATA.BATCH_USER_CAMPUS
(
  district_id   VARCHAR2(50) not null,
  email_address VARCHAR2(75) not null,
...
prompt ==================================
prompt
create table HARLANDALEDATA.BATCH_USER_LOAD_LOG
(
  district_id   VARCHAR2(50) not null,
  email_address VARCHAR2(75) not null,
...
prompt ==============================
prompt
create table HARLANDALEDATA.BATCH_USER_ROLE
(
  district_id          VARCHAR2(50) not null,
  email_address        VARCHAR2(75) not null,
...
prompt ==========================
prompt
create table HARLANDALEDATA.RISK_FACTOR
(
...
comment on column HARLANDALEDATA.RISK_FACTOR.risk_factor_type
  is 'Indicates that the Factor is either a primary or secondary.
Values: Primary,
Secondary';
comment on column HARLANDALEDATA.RISK_FACTOR.mandatory_flag
  is 'Indicates if the campus is required to select this risk factor or if it is optional.
Values: Yes/No';
comment on column HARLANDALEDATA.RISK_FACTOR.risk_factor_order
  is 'Defines the sort order for the presentation of the risk factors.';
alter table HARLANDALEDATA.RISK_FACTOR
...
prompt ======================================
prompt
create table HARLANDALEDATA.CAMPUS_FACTOR_SELECTION
(
  campus_sid      NUMBER not null,
  risk_factor_sid NUMBER not null,
  last_update     TIMESTAMP(6)
...
create bitmap index HARLANDALEDATA.BMI_CAMPUS_FACT_SEL_RISK_SIDFK on HARLANDALEDATA.CAMPUS_FACTOR_SELECTION (RISK_FACTOR_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.CAMPUS_FACTOR_SELECTION
...
alter table HARLANDALEDATA.CAMPUS_FACTOR_SELECTION
  ...
  references HARLANDALEDATA.RISK_FACTOR (RISK_FACTOR_SID);

prompt
prompt Creating table CAMPUS_MASTER
prompt ============================
prompt
create table HARLANDALEDATA.CAMPUS_MASTER
(
...
nologging;
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_master_sid
  is 'Surrogate Key for the Campus Master';
comment on column HARLANDALEDATA.CAMPUS_MASTER.school_id
  is 'The three digit identifier for the school.
Example: 102';
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_id
  is 'The nine digit identifier for the campus consisting of the district id and school id.
Example: 057901102';
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_name
  is 'The full name of the campus.
Example: SCHOOL FOR THE TALENTED AND GIFTED';
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_status
  is 'Identifies the current status of the school.
Example: ACTIVE,
              UNDER CONSTRUCTION,
              ';
comment on column HARLANDALEDATA.CAMPUS_MASTER.region_name
  is 'The name of the regional service service center for this campus.
Example: Region 10,
                10';
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_state_code
  is 'The state abbreviation for the state that is campus resides in.';
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_grade_range
  is 'Defines the grade levels taught at this campus.
Example:  06-08,
                EE-05
';
comment on column HARLANDALEDATA.CAMPUS_MASTER.periods_per_day
  is 'The number of scheduled periods per day at this campus.
Example: 7
8
4 (for A/B block schedule)';
comment on column HARLANDALEDATA.CAMPUS_MASTER.attendance_threshold
  is 'The percentage threshold by which students will be flagged for the attendance risk factor.
Example: .10 - 10%
               .08 - 8%';
comment on column HARLANDALEDATA.CAMPUS_MASTER.passing_grade_threshold
  is 'Defines the lowest pasing number grade at this campus.
Example: 70 (default),
                60,
                80';
comment on column HARLANDALEDATA.CAMPUS_MASTER.default_grading_cycle
  is 'Defines the grading cycle to be used by the core/non-core risk factor for this campus.
Values: 6-Weeks,
             9-Weeks';
comment on column HARLANDALEDATA.CAMPUS_MASTER.campus_key
  is 'Uniquely identifies a campus. A concatenation of the state code, district id, and campus id.
Example: TX*043901*043901001';
comment on column HARLANDALEDATA.CAMPUS_MASTER.last_update
  is 'Date the row was created or last updated.';
alter table HARLANDALEDATA.CAMPUS_MASTER
...
prompt =====================================
prompt
create table HARLANDALEDATA.CAMPUS_RISK_FACTOR_DIM
(
...
alter table HARLANDALEDATA.CAMPUS_RISK_FACTOR_DIM
...
prompt ===============================
prompt
create table HARLANDALEDATA.CLASS_PERIOD_DIM
(
...
comment on table HARLANDALEDATA.CLASS_PERIOD_DIM
  is 'Identifies the division of the day assigned the a particular class of instruction.';
comment on column HARLANDALEDATA.CLASS_PERIOD_DIM.class_period_sid
  is 'Surrogate Key for Class Period Dim.';
comment on column HARLANDALEDATA.CLASS_PERIOD_DIM.campus_sid
  is 'The Campus Sid of the campus that owns the class periods.';
comment on column HARLANDALEDATA.CLASS_PERIOD_DIM.class_period
...
prompt =========================
prompt
create table HARLANDALEDATA.COURSE_DIM
(
...
comment on table HARLANDALEDATA.COURSE_DIM
  is 'A state or locally define curriculum of instruction.';
comment on column HARLANDALEDATA.COURSE_DIM.course_sid
  is 'Surrogate Key for the Course Dim.';
comment on column HARLANDALEDATA.COURSE_DIM.campus_id
  is 'Identifes the campus that owns this particular course.
example: 888888002';
comment on column HARLANDALEDATA.COURSE_DIM.course_code
  is 'The local distrcit/campus identifier for course.';
comment on column HARLANDALEDATA.COURSE_DIM.course_description
  is 'The local name or description of course.';
comment on column HARLANDALEDATA.COURSE_DIM.school_year
  is 'The applicable school year for this course.
Example: 2010';
comment on column HARLANDALEDATA.COURSE_DIM.state_course_code
  is 'The state defined code for the course
Example: 03330100';
comment on column HARLANDALEDATA.COURSE_DIM.state_course_description
  is 'The name/description of the state defined course.
Example: US GOVT';
comment on column HARLANDALEDATA.COURSE_DIM.core_course_flag
  is 'Indicates that this state course is a "core" course for the purposes of the Failed Course flags.
Values: Yes/No';
comment on column HARLANDALEDATA.COURSE_DIM.course_key
...
alter table HARLANDALEDATA.COURSE_DIM
...
prompt =================================
prompt
create table HARLANDALEDATA.COURSE_SECTION_DIM
(
...
comment on table HARLANDALEDATA.COURSE_SECTION_DIM
  is 'Identifies a scheduled course.';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.course_section_sid
  is 'Surrogate key for the Course Section Dim.';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.campus_id
  is 'Identifies the Campus where this section of the course is taught.
Example: 19902002
';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.course_code
  is 'Identifies the Course being taught.
Example: 1001';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.course_description
  is 'Describes the Course being taught.
Example: ENGLISH 1  ';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.course_section_number
  is 'Identifies the Course Section being taught.
Example: 001';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.school_year
  is 'Describes the school year for the Course Section being taught.
Example: 2011';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.term
...
Example: 1 (Semester or trimester)
                ...
                3 (trimester),
                 Y (Full Year)';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.state_course_code
  is 'Identifies the associated State course for the Course Section being taught.
Example: 03220100';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.state_course_description
  is 'Describes the associated State course for the Course Section being taught.
Example: English I (1 Unit) (ENG 1)';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.core_course_flag
  is 'Identifies if the Course Section being taught is a Core Course.
Values: Yes/No';
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.course_section_key
...
comment on column HARLANDALEDATA.COURSE_SECTION_DIM.last_update
  is 'The Date/Time the row as last inserted or updated.';
alter table HARLANDALEDATA.COURSE_SECTION_DIM
...
prompt =============================
prompt
create table HARLANDALEDATA.DISCIPLINE_DIM
(
...
prompt =================================
prompt
create table HARLANDALEDATA.DWS_GLOBAL_DEFAULT
(
...
comment on table HARLANDALEDATA.DWS_GLOBAL_DEFAULT
  is 'Contains default vaules that are applied at various times during system operation.';
comment on column HARLANDALEDATA.DWS_GLOBAL_DEFAULT.campus_periods_per_day
  is 'Defines the default number of periods per day to be applied to new campuses.
Default Value = 7';
comment on column HARLANDALEDATA.DWS_GLOBAL_DEFAULT.campus_attendance_threshold
  is 'Defines the default attendance threshold to be applied to new campuses.
Default Value = .10 (10%)';
comment on column HARLANDALEDATA.DWS_GLOBAL_DEFAULT.campus_passing_grade_threshold
  is 'Defines the default passing grade for students at a campus to be applied to new campuses.
Default Value: 70';
comment on column HARLANDALEDATA.DWS_GLOBAL_DEFAULT.campus_default_grading_cycle
...
prompt ========================================
prompt
create table HARLANDALEDATA.DWS_INTERVENTION_CATEGORY
(
...
comment on column HARLANDALEDATA.DWS_INTERVENTION_CATEGORY.intervention_category_sid
  is 'Surrogate key for the intervention category';
comment on column HARLANDALEDATA.DWS_INTERVENTION_CATEGORY.intervention_category
  is 'Describes a grouping of interventions.
Examples: Tutoring,
                Mentoring,
               Counseling';
comment on column HARLANDALEDATA.DWS_INTERVENTION_CATEGORY.intervention_category_desc
  is 'Describes the intervention category.';
comment on column HARLANDALEDATA.DWS_INTERVENTION_CATEGORY.active_flag
  is 'Indicates if the catefory is actively in use or not.
Values: Y/N';
alter table HARLANDALEDATA.DWS_INTERVENTION_CATEGORY
...
prompt ===============================
prompt
create table HARLANDALEDATA.DWS_INTERVENTION
(
...
comment on column HARLANDALEDATA.DWS_INTERVENTION.intervention_sid
  is 'Surrogate Key for the Intervention';
comment on column HARLANDALEDATA.DWS_INTERVENTION.create_by_user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.DWS_INTERVENTION.last_update_user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.DWS_INTERVENTION.intervention_name
  is 'The specific name of the intervention.
example : Math Tutoring,
                Parent Conference,
                Attendance Monitoring';
comment on column HARLANDALEDATA.DWS_INTERVENTION.intervention_description
  is 'Describes the intervention.';
comment on column HARLANDALEDATA.DWS_INTERVENTION.intervention_comment
  is 'User comments about the intervention';
comment on column HARLANDALEDATA.DWS_INTERVENTION.active_flag
  is 'Indicates if the Intervention is in use or not.
Values: Y/N';
comment on column HARLANDALEDATA.DWS_INTERVENTION.create_date
  is 'The date and time the Intervention was created.';
comment on column HARLANDALEDATA.DWS_INTERVENTION.last_update
  is 'The date and time the Intervention was last updated.';
alter table HARLANDALEDATA.DWS_INTERVENTION
...
alter table HARLANDALEDATA.DWS_INTERVENTION
  ...
  references HARLANDALEDATA.DWS_INTERVENTION_CATEGORY (INTERVENTION_CATEGORY_SID);
alter table HARLANDALEDATA.DWS_INTERVENTION
...
prompt =========================================
prompt
create table HARLANDALEDATA.DWS_INTERVENTION_NOTE_TYPE
(
...
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_sid
  is 'Surrogate key for the intervention note type';
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_name
  is 'The name of the type of note.
example: Status/Update
               Parent Conference
               Student Conference
                Other';
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_desc
  is 'describes the type of note.';
alter table HARLANDALEDATA.DWS_INTERVENTION_NOTE_TYPE
...
prompt ==========================================
prompt
create table HARLANDALEDATA.DWS_STU_INTERVENTION_STATUS
(
...
comment on column HARLANDALEDATA.DWS_STU_INTERVENTION_STATUS.intervention_status_sid
  is 'Surrogate Key for the Student Intervention Status';
comment on column HARLANDALEDATA.DWS_STU_INTERVENTION_STATUS.intervention_status
  is 'Indicates the state of the intervention.
Example: Open,
                Hold,
                Closed';
comment on column HARLANDALEDATA.DWS_STU_INTERVENTION_STATUS.intervention_status_desc
  is 'describes the intervention status.
example: The "Hold" status indicates that the student is temporarily not
participating in the intervention.';
alter table HARLANDALEDATA.DWS_STU_INTERVENTION_STATUS
...
prompt =======================================
prompt
create table HARLANDALEDATA.DWS_STUDENT_INTERVENTION
(
...
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.student_intervention_sid
  is 'Surrogate key for the student Intervention';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.created_by_user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.last_update_user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.intervention_begin_date
  is 'The date on which the student begins the intervention';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.intervention_end_date
  is 'The date on which the intervention for the student end or ended.';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.intervention_goal
...
of the semester.';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.intervention_plan
...
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.intervention_result_comment
...
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.intervention_result_rank
  is 'Ranks the result of the intervention on a scale of 1 to 5.
1 being unsuccessful and 5 being completely successful.
Values: 1 - 5';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.create_date
  is 'Date and time the Intervention was created';
comment on column HARLANDALEDATA.DWS_STUDENT_INTERVENTION.last_update
  is 'Date and time the Intervention was last updated';
alter table HARLANDALEDATA.DWS_STUDENT_INTERVENTION
...
alter table HARLANDALEDATA.DWS_STUDENT_INTERVENTION
  ...
  references HARLANDALEDATA.DWS_INTERVENTION (INTERVENTION_SID);
alter table HARLANDALEDATA.DWS_STUDENT_INTERVENTION
  add constraint FK_DWS_STU_INV_REF_DWS_INV_STS foreign key (INTERVENTION_STATUS_SID)
  references HARLANDALEDATA.DWS_STU_INTERVENTION_STATUS (INTERVENTION_STATUS_SID);
alter table HARLANDALEDATA.DWS_STUDENT_INTERVENTION
...
prompt ====================================
prompt
create table HARLANDALEDATA.DWS_INTERVENTION_NOTE
(
...
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE.intervention_note_sid
  is 'Surrogate Key for the intervention Note';
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE.intervention_note_dt
  is 'The date and time that the note was created';
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE.intervention_note_text
  is 'The user enter text describing some event related to the intervention.';
comment on column HARLANDALEDATA.DWS_INTERVENTION_NOTE.last_update
  is 'The date and time the note was last updated.  Will initially be the same as the creation date.';
alter table HARLANDALEDATA.DWS_INTERVENTION_NOTE
...
alter table HARLANDALEDATA.DWS_INTERVENTION_NOTE
  ...
  references HARLANDALEDATA.DWS_INTERVENTION_NOTE_TYPE (INTERVENTION_NOTE_TYPE_SID);
alter table HARLANDALEDATA.DWS_INTERVENTION_NOTE
...
alter table HARLANDALEDATA.DWS_INTERVENTION_NOTE
  ...
  references HARLANDALEDATA.DWS_STUDENT_INTERVENTION (STUDENT_INTERVENTION_SID);

prompt
prompt Creating table DWS_STUDENT_NOTE
prompt ===============================
prompt
create table HARLANDALEDATA.DWS_STUDENT_NOTE
(
...
comment on column HARLANDALEDATA.DWS_STUDENT_NOTE.note_author_sid
  is 'User Surrogate Key';
alter table HARLANDALEDATA.DWS_STUDENT_NOTE
...
prompt =========================
prompt
create table HARLANDALEDATA.EMAIL_TYPE
(
...
comment on column HARLANDALEDATA.EMAIL_TYPE.email_type_sid
  is 'Surrogate Key for the Email Type';
comment on column HARLANDALEDATA.EMAIL_TYPE.email_type
  is 'Indicates the kind of email.
Example: New User,
                Password Reset,
                Welcome to Reveal,
                System Maintenance';
alter table HARLANDALEDATA.EMAIL_TYPE
...
prompt ==================================
prompt
create table HARLANDALEDATA.EMAIL_SPECIFICATION
(
...
comment on column HARLANDALEDATA.EMAIL_SPECIFICATION.email_sid
  is 'Surrogate Key for the Email Specification.';
comment on column HARLANDALEDATA.EMAIL_SPECIFICATION.email_type_sid
  is 'Surrogate Key for the Email Type';
comment on column HARLANDALEDATA.EMAIL_SPECIFICATION.email_subject
  is 'Email Subject Line.
Example: Password Reset Request ';
comment on column HARLANDALEDATA.EMAIL_SPECIFICATION.email_body
...
';
comment on column HARLANDALEDATA.EMAIL_SPECIFICATION.application_link
  is 'The HTML link to the appliction login.';
comment on column HARLANDALEDATA.EMAIL_SPECIFICATION.salutation
  is 'The closing of the email.
Example:
Sincerely,
The SchoolViz Support Team';
alter table HARLANDALEDATA.EMAIL_SPECIFICATION
...
alter table HARLANDALEDATA.EMAIL_SPECIFICATION
  ...
  references HARLANDALEDATA.EMAIL_TYPE (EMAIL_TYPE_SID);

prompt
prompt Creating table ETL_EVENT_LOG
prompt ============================
prompt
create table HARLANDALEDATA.ETL_EVENT_LOG
(
...
nologging;
comment on column HARLANDALEDATA.ETL_EVENT_LOG.event_time
  is 'Defaults to SYSDATE';
comment on column HARLANDALEDATA.ETL_EVENT_LOG.event_type
  is 'Values: Warning, Informational, Error';
comment on column HARLANDALEDATA.ETL_EVENT_LOG.source_name
  is 'Values: Cognos, PL/SQL, Perl, SQL*Loader, Other';
comment on column HARLANDALEDATA.ETL_EVENT_LOG.status
  is 'Values: Started, Running, Failed, Succeeded';
comment on column HARLANDALEDATA.ETL_EVENT_LOG.elapsed_time
  is 'In seconds';
create index HARLANDALEDATA.BMI_EVENT_LOG_EVENT_TYPE on HARLANDALEDATA.ETL_EVENT_LOG (EVENT_TYPE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.BMI_EVENT_LOG_STATUS on HARLANDALEDATA.ETL_EVENT_LOG (STATUS)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.ETL_EVENT_LOG
...
prompt =============================================
prompt
create table HARLANDALEDATA.ETL_GRADINGPERIOD_TO_GRADETYPE
(
...
comment on table HARLANDALEDATA.ETL_GRADINGPERIOD_TO_GRADETYPE
  is 'Converts CDM grading period to CORE Grade_Type as well as identifing the associated period number.';
comment on column HARLANDALEDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.cdm_grading_period
  is 'The GradingPeriod from the TSDS CDM model.
Example: First Six Weeks,
                Second Nine Weeks,
                Second Semester';
comment on column HARLANDALEDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.period_number
  is 'Grading Period for specific Grade Type';
comment on column HARLANDALEDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.cycle_type
...
prompt ============================
prompt
create table HARLANDALEDATA.EXECUTION_LOG
(
...
comment on table HARLANDALEDATA.EXECUTION_LOG
  is 'Tracks information about each run of the risk factor calculation engine or the load process.';
comment on column HARLANDALEDATA.EXECUTION_LOG.execution_start_time
  is 'The datetime that the engine started processing this risk factor';
comment on column HARLANDALEDATA.EXECUTION_LOG.process_name
  is 'Name of the process being run
Example: Attendance
               CoreCourseFailure
               ';
comment on column HARLANDALEDATA.EXECUTION_LOG.process_type
  is 'Type of process being run
Example: RCE
               District Load
               Campus Load';
comment on column HARLANDALEDATA.EXECUTION_LOG.execution_end_time
  is 'The datetime that the engine stopped processing this risk factor';
comment on column HARLANDALEDATA.EXECUTION_LOG.execution_result
  is 'The outcome of the execution.
Values: Successful
             Failed';
alter table HARLANDALEDATA.EXECUTION_LOG
...
prompt ==================================
prompt
create table HARLANDALEDATA.EXECUTION_PARAMETER
(
  execution_start_time TIMESTAMP(6) not null,
  campus_sid           NUMBER not null,
...
comment on table HARLANDALEDATA.EXECUTION_PARAMETER
  is 'Contains the parameters used in the execution of a system process.';
comment on column HARLANDALEDATA.EXECUTION_PARAMETER.execution_start_time
  is 'The datetime that the engine started processing this risk factor';
comment on column HARLANDALEDATA.EXECUTION_PARAMETER.parameter_name
  is 'The name of the parameter used in the risk factor calculation.
Example: Periods Per Day
                Attendance Threshold';
comment on column HARLANDALEDATA.EXECUTION_PARAMETER.parameter_value
  is 'The Value of the first parameter used in the risk factor calculation.
Example: 7';
alter table HARLANDALEDATA.EXECUTION_PARAMETER
...
alter table HARLANDALEDATA.EXECUTION_PARAMETER
  ...
  references HARLANDALEDATA.EXECUTION_LOG (EXECUTION_START_TIME, CAMPUS_SID);

prompt
prompt Creating table GRADE_LEVEL_DIM
prompt ==============================
prompt
create table HARLANDALEDATA.GRADE_LEVEL_DIM
(
...
comment on table HARLANDALEDATA.GRADE_LEVEL_DIM
  is 'Identifies the student grade level.
Example: 01
                PK
                KG
                12';
comment on column HARLANDALEDATA.GRADE_LEVEL_DIM.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column HARLANDALEDATA.GRADE_LEVEL_DIM.grade_level
  is 'Identifies a students assigned grade.
Example: 01
                02
                12';
comment on column HARLANDALEDATA.GRADE_LEVEL_DIM.grade_level_description
  is 'Describes a grade level.
Example: First Grade
               Second Grade
               Twelth Grade';
comment on column HARLANDALEDATA.GRADE_LEVEL_DIM.grade_level_order
  is 'Indicates the order of the grade levels for sorting.
Example: 1
                2
                3
';
alter table HARLANDALEDATA.GRADE_LEVEL_DIM
...
prompt =============================
prompt
create table HARLANDALEDATA.GRADE_TYPE_DIM
(
...
comment on table HARLANDALEDATA.GRADE_TYPE_DIM
...
Example: Progess Report
               ...
               Exam
';
comment on column HARLANDALEDATA.GRADE_TYPE_DIM.grade_type_sid
  is 'Surrogate Key for the Grade Type dim';
comment on column HARLANDALEDATA.GRADE_TYPE_DIM.grade_type
...
Example: Six Weeks,
                ...
                Exam,
                Final';
comment on column HARLANDALEDATA.GRADE_TYPE_DIM.grade_type_description
  is 'The Full Description of the grade type.
Example: The six weeks grade revceived by the student';
comment on column HARLANDALEDATA.GRADE_TYPE_DIM.last_update
  is 'The data time this row was last insert/updated';
alter table HARLANDALEDATA.GRADE_TYPE_DIM
...
prompt ====================================
prompt
create table HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM
(
...
comment on table HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM
  is 'Identifies the student behaviors associated with a discipline event.';
comment on column HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_sid
  is 'Uniquely identifies an incident behavior.';
comment on column HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM.campus_id
  is 'Campus Id copied from the campus dim.';
comment on column HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_code
  is 'Local code that identifies a student behavior associated with an incident.';
comment on column HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_description
  is 'Describes a students behavior
Example: Permanent Removal By A Teacher From Class,
               Alcoholic Beverage,
               Bullying';
comment on column HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_category
  is 'Grouping of behaviors
Examples: School Code of Conduct,
                  State Offense';
comment on column HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_key
  is 'Business key for the incident behavior. Consisting of the state code, campus id
and behavior code.
Example: TX*849304001*37';
alter table HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM
...
prompt ====================================
prompt
create table HARLANDALEDATA.INCIDENT_LOCATION_DIM
(
...
comment on table HARLANDALEDATA.INCIDENT_LOCATION_DIM
  is 'The location where a discipline incident took place';
comment on column HARLANDALEDATA.INCIDENT_LOCATION_DIM.incident_location_sid
  is 'Uniquely identifies the Incident Location';
comment on column HARLANDALEDATA.INCIDENT_LOCATION_DIM.incident_location
  is 'Identifies the place where an incident took place.
Example: Classroom,
                Cafeteria area,
                Unknown';
comment on column HARLANDALEDATA.INCIDENT_LOCATION_DIM.incident_location_key
  is 'Business key for the incident location.
Example: TX*108909*Classroom';
alter table HARLANDALEDATA.INCIDENT_LOCATION_DIM
...
prompt =========================================
prompt
create table HARLANDALEDATA.MERGED_STUDENT_RISK_FACTOR
(
  student_sid       NUMBER not null,
  risk_factor_sid   NUMBER not null,
...
comment on table HARLANDALEDATA.MERGED_STUDENT_RISK_FACTOR
...
comment on column HARLANDALEDATA.MERGED_STUDENT_RISK_FACTOR.flag_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.MERGED_STUDENT_RISK_FACTOR.end_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.MERGED_STUDENT_RISK_FACTOR.risk_factor_count
  is 'Measure used by report tools to count number of studnets with risk factors.
Value 1';
alter table HARLANDALEDATA.MERGED_STUDENT_RISK_FACTOR
...
prompt ===============================
prompt
create table HARLANDALEDATA.NINTH_GRD_COHORT
(
...
prompt =================================
prompt
create table HARLANDALEDATA.RACE_ETHNICITY_DIM
(
...
comment on table HARLANDALEDATA.RACE_ETHNICITY_DIM
  is 'Idenitfies the ethnicity and race selections of a person.';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.race_ethnicity_sid
  is 'Surrogate key';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.yes_no_key
...
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.binary_key
...
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.race_ethnicity_key
  is 'The race ethnicity key is used for look up puposes.  It is a positional map of the selected options.
values:
0 - not selected
HIABPW - selected
...
------   =   Unknown
';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.ethnicity
  is 'Indicates that the individual selected Hispanic/Latino(Yes) or Not Hispanic/Latino(No).
Values:
Yes
No';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.ethnicity_description
  is 'Values:
Hispanic/Latino
Not Hispanic/Latino';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.american_indian_alaska_native
  is 'Indicates that the individual selected American Indian/Alaska Native(Yes) or Not American Indian/Alaska Native(No).
Values:
Yes
No';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.amer_indian_alaskan_desc
  is 'Values:
American Indian or Alaska Native
Not American Indian or Alaska Native';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.asian
  is 'Indicates that the individual selected Asian(Yes) or Not Asian(No).
Values:
Yes
No';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.asian_description
  is 'Values:
Asian
Not Asian';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.black_or_african_american
  is 'Indicates that the individual selected Black or African American(Yes) or Not Black or African American(No).
Values:
Yes
No';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.black_african_amer_desc
  is 'Values:
Black or African American
Not Black or African American';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.native_hawaiian_pacific_island
...
Yes
No';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.hawaiian_pacific_island_desc
  is 'Values:
Native Hawaiian/Other Pacific Islander
Not Native Hawaiian/Other Pacific Islander';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.white
  is 'Indicates that the individual selected White(Yes) or Not White(No).
Values:
Yes
No';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.white_description
  is 'Values:
White
Not White';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.two_or_more_races
  is 'Indicates that two or more races were selected.
Example:
Asian, White';
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.race_ethnicity_long_desc
...
comment on column HARLANDALEDATA.RACE_ETHNICITY_DIM.race_ethnicity_short_desc
...
Black, White';
alter table HARLANDALEDATA.RACE_ETHNICITY_DIM
...
prompt =====================
prompt
create table HARLANDALEDATA.SOURCE
(
...
comment on table HARLANDALEDATA.SOURCE
  is 'The source of data for the reporting category.';
comment on column HARLANDALEDATA.SOURCE.source_sid
  is 'Uniquely identifies the source.';
comment on column HARLANDALEDATA.SOURCE.source_name
  is 'The name of the source of the data of the reporting category.
Example: TxEIS,
                TexasStudentDataSystem(TSDS),
                 Jira';
comment on column HARLANDALEDATA.SOURCE.source_description
  is 'Description of the Source.';
comment on column HARLANDALEDATA.SOURCE.active_flag
  is 'Indicates if the source is available for use.
Values: Y/N';
alter table HARLANDALEDATA.SOURCE
...
prompt ==============================
prompt
create table HARLANDALEDATA.REPORT_CATEGORY
(
...
comment on table HARLANDALEDATA.REPORT_CATEGORY
  is 'Defines the groupings of reports. Such as Student, Registration, Health, etc.';
comment on column HARLANDALEDATA.REPORT_CATEGORY.source_sid
  is 'Uniquely identifies the source.';
comment on column HARLANDALEDATA.REPORT_CATEGORY.report_category
  is 'Used to group reports together.
  Example: Student,
                  Finance';
comment on column HARLANDALEDATA.REPORT_CATEGORY.report_category_description
  is 'Describes the REPORT CATEGORY';
comment on column HARLANDALEDATA.REPORT_CATEGORY.active_flag
  is 'denotes if the category is in use.
Values: Y/N';
alter table HARLANDALEDATA.REPORT_CATEGORY
...
alter table HARLANDALEDATA.REPORT_CATEGORY
  ...
  references HARLANDALEDATA.SOURCE (SOURCE_SID);

prompt
prompt Creating table REPORT_TYPE
prompt ==========================
prompt
create table HARLANDALEDATA.REPORT_TYPE
(
...
comment on table HARLANDALEDATA.REPORT_TYPE
  is 'The kind of report';
alter table HARLANDALEDATA.REPORT_TYPE
...
prompt ==========================
prompt
create table HARLANDALEDATA.REPORT_LIST
(
...
comment on column HARLANDALEDATA.REPORT_LIST.report_name
  is 'The name of the report to be displayed on the main page.';
comment on column HARLANDALEDATA.REPORT_LIST.report_description
  is 'Describes the REPORT';
comment on column HARLANDALEDATA.REPORT_LIST.report_alias
  is 'The APEX page alias for the report, used in the link to the page';
comment on column HARLANDALEDATA.REPORT_LIST.report_category_sid
  is 'Foriegn key to report_category table';
comment on column HARLANDALEDATA.REPORT_LIST.active_flag
  is 'Used to indicate if a flag is active for use or not.
  values: Y,
           N';
alter table HARLANDALEDATA.REPORT_LIST
...
alter table HARLANDALEDATA.REPORT_LIST
  ...
  references HARLANDALEDATA.REPORT_CATEGORY (REPORT_CATEGORY_SID)
  deferrable initially deferred;
alter table HARLANDALEDATA.REPORT_LIST
  add constraint FK_REPORT_L_REFERENCE_REPORT_T foreign key (REPORT_TYPE_SID)
  references HARLANDALEDATA.REPORT_TYPE (REPORT_TYPE_SID);

prompt
prompt Creating table RF_DISPLAY_COLUMNS
prompt =================================
prompt
create table HARLANDALEDATA.RF_DISPLAY_COLUMNS
(
  campus_sid               NUMBER not null,
...
alter table HARLANDALEDATA.RF_DISPLAY_COLUMNS
...
prompt =====================================
prompt
create table HARLANDALEDATA.SECURITY_QUESTION_TYPE
(
...
comment on column HARLANDALEDATA.SECURITY_QUESTION_TYPE.security_question_type_sid
  is 'Surrogate Key for the Security Question Type';
comment on column HARLANDALEDATA.SECURITY_QUESTION_TYPE.security_question_type_name
  is 'Denotes the type of Security Question.
Values: Login,
            External IP Address,
            Password Reset';
comment on column HARLANDALEDATA.SECURITY_QUESTION_TYPE.security_question_type_desc
...
system.';
alter table HARLANDALEDATA.SECURITY_QUESTION_TYPE
...
prompt ================================
prompt
create table HARLANDALEDATA.SECURITY_QUESTION
(
...
comment on column HARLANDALEDATA.SECURITY_QUESTION.security_question_sid
  is 'Surrogate Key for the security Question';
comment on column HARLANDALEDATA.SECURITY_QUESTION.security_question_type_sid
  is 'Surrogate Key for the Security Question Type';
comment on column HARLANDALEDATA.SECURITY_QUESTION.security_question
  is 'A question used to identify a valid user.
Example: What is your birth city?';
alter table HARLANDALEDATA.SECURITY_QUESTION
...
alter table HARLANDALEDATA.SECURITY_QUESTION
  ...
  references HARLANDALEDATA.SECURITY_QUESTION_TYPE (SECURITY_QUESTION_TYPE_SID);

prompt
prompt Creating table SECURITY_TRANSACTION_LOG
prompt =======================================
prompt
create table HARLANDALEDATA.SECURITY_TRANSACTION_LOG
(
...
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.security_transaction_sid
  is 'Surrogate key for the logon transaction.';
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.user_id
  is 'The User ID of the person attempting to login.';
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.transaction_date
  is 'Date and time of the security transaction.';
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.log_message
...
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.action_type
...
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.action_result
  is 'Indicates the result of the users action. Example: Successful, Failed';
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.attempts
...
comment on column HARLANDALEDATA.SECURITY_TRANSACTION_LOG.user_ip_address
...
alter table HARLANDALEDATA.SECURITY_TRANSACTION_LOG
...
prompt ===============================
prompt
create table HARLANDALEDATA.SO_DISTRICT_COPY
(
...
prompt ============================
prompt
create table HARLANDALEDATA.SO_EMAIL_LDAP
(
  ldap_email     VARCHAR2(100),
  ldap_user_id   VARCHAR2(100),
  ldap_user_name VARCHAR2(100),
...
prompt =============================
prompt
create table HARLANDALEDATA.SO_LDAP_EXPORT
(
...
create bitmap index HARLANDALEDATA.BMI_TRANS_NBR on HARLANDALEDATA.SO_LDAP_EXPORT (TRANS_NBR)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create bitmap index HARLANDALEDATA.BMI_TRANS_TYPE on HARLANDALEDATA.SO_LDAP_EXPORT (TRANS_TYPE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ===============================
prompt
create table HARLANDALEDATA.STATE_COURSE_DIM
(
...
comment on table HARLANDALEDATA.STATE_COURSE_DIM
  is 'Contains all of the state defined courses.';
comment on column HARLANDALEDATA.STATE_COURSE_DIM.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column HARLANDALEDATA.STATE_COURSE_DIM.state_code
  is 'The upper case two character state code for this course.
Example: TX';
comment on column HARLANDALEDATA.STATE_COURSE_DIM.state_course_code
  is 'The state defined code for the course
Example: 03330100';
comment on column HARLANDALEDATA.STATE_COURSE_DIM.state_course_description
  is 'The name/description of the state defined course.
Example: US GOVT';
comment on column HARLANDALEDATA.STATE_COURSE_DIM.core_course_flag
  is 'Indicates that this state course is a "core" course for the purposes of the Failed Course flags.
Values: Yes/No';
comment on column HARLANDALEDATA.STATE_COURSE_DIM.state_course_key
  is 'The business key used to look state courses. Consisting of the state code * state course code
Example: TX*049304939';
alter table HARLANDALEDATA.STATE_COURSE_DIM
...
prompt ==================================
prompt
create table HARLANDALEDATA.STUDENT_CREDIT_FACT
(
...
comment on table HARLANDALEDATA.STUDENT_CREDIT_FACT
...
comment on column HARLANDALEDATA.STUDENT_CREDIT_FACT.student_credit_fact_sid
  is 'A surrogate key for the fact.';
comment on column HARLANDALEDATA.STUDENT_CREDIT_FACT.course_sid
  is 'Surrogate Key for the Course Dim.';
comment on column HARLANDALEDATA.STUDENT_CREDIT_FACT.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column HARLANDALEDATA.STUDENT_CREDIT_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_CREDIT_FACT.credits_earned
  is 'The number of credits earned by a student for a particular course.
Example: 1.0,
                0.5,
                0.25
                0.333';
comment on column HARLANDALEDATA.STUDENT_CREDIT_FACT.local_credits_earned
  is 'This is the value for credits earned from the source.
Examples: 10
                  5
                  NC';
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
...
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
  ...
  references HARLANDALEDATA.ACADEMIC_RECORD_SOURCE_DIM (ACADEMIC_SOURCE_CODE);
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
...
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
  ...
  references HARLANDALEDATA.COURSE_DIM (COURSE_SID);
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
...
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
  ...
  references HARLANDALEDATA.STATE_COURSE_DIM (STATE_COURSE_SID);
alter table HARLANDALEDATA.STUDENT_CREDIT_FACT
...
prompt ======================================
prompt
create table HARLANDALEDATA.STUDENT_CREDIT_FACT_ERR
(
...
prompt ======================================
prompt
create table HARLANDALEDATA.STUDENT_CREDIT_FACT_REJ
(
  student_credit_fact_sid NUMBER not null,
  campus_sid              NUMBER not null,
  course_sid              NUMBER not null,
...
prompt =============================================
prompt
create table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
(
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  date_sid                      NUMBER not null,
...
comment on table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
  is 'Actions taken as a result of a student discipline incident.';
comment on column HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT.date_sid
...
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_length_diff_reason_sid
  is 'Uniquely identifies the Action Length Diff Reason Dim';
comment on column HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT.discipline_sid
  is 'Uniquely identifies the Discipline DIM';
comment on column HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT.incident_number
  is 'The discipline incident number associated with this action.';
comment on column HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_assigned_days
  is 'The number of days assigned for the action.';
comment on column HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_actual_days
  is 'The number of days actually served for this action.';
alter table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
  add constraint PK_STUDENT_DISCIPLINE_ACTION_F primary key (CAMPUS_SID, STUDENT_SID, DATE_SID, INCIDENT_NUMBER, DISCIPLINE_SID)
  using index 
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
...
alter table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
  ...
  references HARLANDALEDATA.ACTION_LENGTH_DIFF_REASON_DIM (ACTION_LENGTH_DIFF_REASON_SID);
alter table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
alter table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
  ...
  references HARLANDALEDATA.DISCIPLINE_DIM (DISCIPLINE_SID);
alter table HARLANDALEDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
prompt ========================================
prompt
create table HARLANDALEDATA.STUDENT_DISC_ACT_FACT_ERR
(
  exception_type                VARCHAR2(75),
  campus_sid                    NUMBER,
  student_sid                   NUMBER,
...
prompt ========================================
prompt
create table HARLANDALEDATA.STUDENT_DISC_ACT_FACT_REJ
(
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  date_sid                      NUMBER not null,
...
prompt ======================================
prompt
create table HARLANDALEDATA.STUDENT_ENROLLMENT_FACT
(
  campus_sid          NUMBER not null,
  student_sid         NUMBER not null,
...
comment on column HARLANDALEDATA.STUDENT_ENROLLMENT_FACT.entry_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_ENROLLMENT_FACT.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column HARLANDALEDATA.STUDENT_ENROLLMENT_FACT.withdrawal_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_ENROLLMENT_FACT.last_update
  is 'Date that this records was last updated';
alter table HARLANDALEDATA.STUDENT_ENROLLMENT_FACT
...
alter table HARLANDALEDATA.STUDENT_ENROLLMENT_FACT
  ...
  references HARLANDALEDATA.GRADE_LEVEL_DIM (GRADE_LEVEL_SID);
alter table HARLANDALEDATA.STUDENT_ENROLLMENT_FACT
...
prompt ==========================================
prompt
create table HARLANDALEDATA.STUDENT_ENROLLMENT_FACT_ERR
(
  load_sid            NUMBER,
...
prompt ==========================================
prompt
create table HARLANDALEDATA.STUDENT_ENROLLMENT_FACT_REJ
(
  campus_sid          NUMBER not null,
  student_sid         NUMBER not null,
  entry_date_sid      NUMBER not null,
...
prompt =================================
prompt
create table HARLANDALEDATA.STUDENT_GRADE_FACT
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
comment on table HARLANDALEDATA.STUDENT_GRADE_FACT
  is 'Captures a students grade.
Grain = 1 Row/ student/Course Section/date/Grade Type';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.academic_source_code
  is 'A code that indicates what kind of Academic Source .
Example: T - transfer
               C - Classroom
               E - Exam
               O - online';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.number_grade
  is 'The numerical grade received by a student.
Example: 100,
                 75.6
                 50.07';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.letter_grade
  is 'The letter grade received by a student.
Example: A,
                B,
                 P,
                 NG';
comment on column HARLANDALEDATA.STUDENT_GRADE_FACT.last_update
  is 'The date/time the row was inserted or updated.';
alter table HARLANDALEDATA.STUDENT_GRADE_FACT
...
alter table HARLANDALEDATA.STUDENT_GRADE_FACT
  ...
  references HARLANDALEDATA.COURSE_SECTION_DIM (COURSE_SECTION_SID);
alter table HARLANDALEDATA.STUDENT_GRADE_FACT
...
alter table HARLANDALEDATA.STUDENT_GRADE_FACT
  ...
  references HARLANDALEDATA.GRADE_TYPE_DIM (GRADE_TYPE_SID);

prompt
prompt Creating table STUDENT_GRADE_FACT_ERR
prompt =====================================
prompt
create table HARLANDALEDATA.STUDENT_GRADE_FACT_ERR
(
  load_sid           NUMBER,
  exception_type     VARCHAR2(200),
...
prompt =====================================
prompt
create table HARLANDALEDATA.STUDENT_GRADE_FACT_REJ
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
prompt ==========================================
prompt
create table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
comment on table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
  is 'Transactional fact to record when a student is abscent from a class period.';
comment on column HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT.period_absence_count
  is 'A measure for this fact table.  Value: 1';
create index HARLANDALEDATA.NDX_STU_PRD_ABS_DATE_SID_FK on HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT (DATE_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
...
alter table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
  ...
  references HARLANDALEDATA.ABSENCE_REASON_DIM (ABSENCE_REASON_SID);
alter table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
...
alter table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
  ...
  references HARLANDALEDATA.CLASS_PERIOD_DIM (CLASS_PERIOD_SID);
alter table HARLANDALEDATA.STUDENT_PERIOD_ABSENCE_FACT
...
prompt ==========================================
prompt
create table HARLANDALEDATA.STUDENT_PERIOD_ABS_FACT_ERR
(
  exception_type     VARCHAR2(200),
...
prompt ==========================================
prompt
create table HARLANDALEDATA.STUDENT_PERIOD_ABS_FACT_REJ
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
prompt ======================================
prompt
create table HARLANDALEDATA.STUDENT_PERIOD_OVERRIDE
(
  campus_sid      NUMBER not null,
  student_sid     NUMBER not null,
  periods_per_day NUMBER,
...
comment on table HARLANDALEDATA.STUDENT_PERIOD_OVERRIDE
  is 'Overides the default campus periods per day for a particular student for the current semester.
Example: 5';
alter table HARLANDALEDATA.STUDENT_PERIOD_OVERRIDE
...
prompt =======================================
prompt
create table HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT
(
  campus_sid             NUMBER not null,
  student_sid            NUMBER not null,
  flag_date_sid          NUMBER not null,
...
comment on table HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT
  is 'Grain = 1 row /student/risk factor/effective date';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT.flag_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT.end_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT.risk_factor_count
  is 'A measure defined for Cognos reporting; Value 1';
create index HARLANDALEDATA.NDX_STU_RISK_FACTOR_STU_SID_FK on HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT (STUDENT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT
...
alter table HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT
  ...
  references HARLANDALEDATA.CAMPUS_RISK_FACTOR_DIM (CAMPUS_RISK_FACTOR_SID);
alter table HARLANDALEDATA.STUDENT_RISK_FACTOR_FACT
...
prompt ============================================
prompt
create table HARLANDALEDATA.STUDENT_RISK_FACTOR_PHASE_SUM
(
  campus_sid        NUMBER not null,
  date_sid          NUMBER not null,
  student_sid       NUMBER not null,
...
alter table HARLANDALEDATA.STUDENT_RISK_FACTOR_PHASE_SUM
...
prompt ===========================================
prompt
create table HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT
(
  campus_sid                     NUMBER not null,
  student_sid                    NUMBER not null,
  date_sid                       NUMBER not null,
...
comment on table HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT
...
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.attendance_flag
  is 'Indicates that the student was flagged for attendance during this snapshot period.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_attendance_flag
  is 'Indicates that the student was flagged for attendance at the end of an academic semester.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.core_course_failure_flag
  is 'Indicates that the student was flagged for failing a core course during a marking period.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.non_core_course_failure_flag
  is 'Indicates that the student was flagged for failing a non-core course during a marking period.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_core_crs_failure_flag
  is 'Indicates that the student was flagged for failing a core course for a semester.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_noncore_crs_fail_flag
  is 'Indicates that the student was flagged for failing a non-core course for a semester.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.gpa_flag
  is 'Indicates that the student was flagged for a GPA below minium established standard.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.deficient_credits_flag
  is 'Indicates that the student was flagged for having to few credits for a semester.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.discipline_flag
  is 'Indicates that the student was flagged for behavorial problems.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.grade_6_thru_8_retention_flag
  is 'Indicates that the student was flagged for having been retained in grades 6 through 8 one or more times.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.cohort_flag
  is 'Indicates that the student was at risk of not graduating with his/her 9th grade class.
Values: Yes, No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.other_flag
...
Values: Yes/No';
comment on column HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT.risk_factor_count
  is 'The total number of risk factors flagged Yes for this student on this date.
Example: 3';
create index HARLANDALEDATA.NDX_STU_RISK_SNAPSHOT_DATE_FK on HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT (DATE_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.STUDENT_RISK_FACTOR_SNAPSHOT
...
prompt ===========================================
prompt
create table HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT
(
  campus_sid            NUMBER not null,
  student_sid           NUMBER not null,
  date_sid              NUMBER not null,
...
comment on table HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT
  is 'The occurrence of an incident that may or may not result in a student discipline action.';
comment on column HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian
...
Example:
120100708  for district with sid 1';
comment on column HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT.incident_location_sid
  is 'Uniquely identifies the Incident Location';
comment on column HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT.incident_behavior_sid
  is 'Uniquely identifies an incident behavior.';
alter table HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT
...
alter table HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT
  ...
  references HARLANDALEDATA.INCIDENT_BEHAVIOR_DIM (INCIDENT_BEHAVIOR_SID);
alter table HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT
  add constraint FK_STU_DIS_INC_REF_INC_LOC foreign key (INCIDENT_LOCATION_SID)
  references HARLANDALEDATA.INCIDENT_LOCATION_DIM (INCIDENT_LOCATION_SID);
alter table HARLANDALEDATA.STU_DISCIPLINE_INCIDENT_FACT
...
prompt ====================================
prompt
create table HARLANDALEDATA.STU_DISC_INC_FACT_ERR
(
  exception_type        VARCHAR2(75),
  campus_sid            NUMBER,
  student_sid           NUMBER,
...
prompt ====================================
prompt
create table HARLANDALEDATA.STU_DISC_INC_FACT_REJ
(
  campus_sid            NUMBER not null,
  student_sid           NUMBER not null,
  date_sid              NUMBER not null,
...
prompt =================================
prompt
create table HARLANDALEDATA.SYS_IMPORT_FULL_01
(
...
comment on table HARLANDALEDATA.SYS_IMPORT_FULL_01
  is 'Data Pump Master Table IMPORT                         FULL                          ';
create index HARLANDALEDATA.SYS_MTABLE_000052C15_IND_1 on HARLANDALEDATA.SYS_IMPORT_FULL_01 (OBJECT_SCHEMA, OBJECT_NAME, OBJECT_TYPE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.SYS_MTABLE_000052C15_IND_2 on HARLANDALEDATA.SYS_IMPORT_FULL_01 (BASE_PROCESS_ORDER)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.SYS_MTABLE_000052C15_IND_3 on HARLANDALEDATA.SYS_IMPORT_FULL_01 (OBJECT_PATH_SEQNO)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table HARLANDALEDATA.SYS_IMPORT_FULL_01
...
prompt =================================
prompt
create table HARLANDALEDATA.TALEND_ETL_PROCESS
(
...
alter table HARLANDALEDATA.TALEND_ETL_PROCESS
...
prompt ========================================
prompt
create table HARLANDALEDATA.TALEND_FLOW_METER_CATCHER
(
  moment            TIMESTAMP(6),
  pid               VARCHAR2(20),
...
create index HARLANDALEDATA.IX_ACTION_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (ACTION)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_EXTRACT_DATE_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_JOB_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LABEL_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (LABEL)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LEA_NAME_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LEA_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_MOMENT_TFC on HARLANDALEDATA.TALEND_FLOW_METER_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==================================
prompt
create table HARLANDALEDATA.TALEND_LEA_CONTEXTS
(
  batch_gid     NUMBER,
...
prompt =================================
prompt
create table HARLANDALEDATA.TALEND_LOG_CATCHER
(
  moment       TIMESTAMP(6),
  pid          VARCHAR2(20),
  root_pid     VARCHAR2(20),
...
create index HARLANDALEDATA.IX_EXTRACT_DATE_TLC on HARLANDALEDATA.TALEND_LOG_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_JOB_TLC on HARLANDALEDATA.TALEND_LOG_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LEA_NAME_TLC on HARLANDALEDATA.TALEND_LOG_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LEA_TLC on HARLANDALEDATA.TALEND_LOG_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_MOMENT_TLC on HARLANDALEDATA.TALEND_LOG_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==================================
prompt
create table HARLANDALEDATA.TALEND_STAT_CATCHER
(
  moment            TIMESTAMP(6),
  pid               VARCHAR2(20),
  father_pid        VARCHAR2(20),
...
create index HARLANDALEDATA.IX_EXTRACT_DATE_TSC on HARLANDALEDATA.TALEND_STAT_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_JOB_TSC on HARLANDALEDATA.TALEND_STAT_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LEA_NAME_TSC on HARLANDALEDATA.TALEND_STAT_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_LEA_TSC on HARLANDALEDATA.TALEND_STAT_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index HARLANDALEDATA.IX_MOMENT_TSC on HARLANDALEDATA.TALEND_STAT_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==========================================
prompt
create table HARLANDALEDATA.TXSTU_USER_STUDENT_SECURITY
(
...
alter table HARLANDALEDATA.TXSTU_USER_STUDENT_SECURITY
...
prompt ==========================
prompt
create table HARLANDALEDATA.USER_CAMPUS
(
...
comment on column HARLANDALEDATA.USER_CAMPUS.user_campus_sid
  is 'Surrogate Key for the User Campus';
comment on column HARLANDALEDATA.USER_CAMPUS.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.USER_CAMPUS.campus_master_sid
  is 'Surrogate Key for the Campus Master';
alter table HARLANDALEDATA.USER_CAMPUS
...
alter table HARLANDALEDATA.USER_CAMPUS
  ...
  references HARLANDALEDATA.CAMPUS_MASTER (CAMPUS_MASTER_SID);
alter table HARLANDALEDATA.USER_CAMPUS
...
prompt ==========================
prompt
create table HARLANDALEDATA.USER_REPORT
(
...
comment on table HARLANDALEDATA.USER_REPORT
  is 'A specific report assigned to a user.';
comment on column HARLANDALEDATA.USER_REPORT.user_sid
  is 'User Surrogate Key';
alter table HARLANDALEDATA.USER_REPORT
...
alter table HARLANDALEDATA.USER_REPORT
  ...
  references HARLANDALEDATA.REPORT_LIST (REPORT_LIST_SID);
alter table HARLANDALEDATA.USER_REPORT
...
prompt ===================================
prompt
create table HARLANDALEDATA.USER_REPORT_CATEGORY
(
...
comment on table HARLANDALEDATA.USER_REPORT_CATEGORY
  is 'Defines which report categorys a user is allowed acces.';
comment on column HARLANDALEDATA.USER_REPORT_CATEGORY.user_sid
  is 'User Surrogate Key';
alter table HARLANDALEDATA.USER_REPORT_CATEGORY
...
prompt ========================
prompt
create table HARLANDALEDATA.USER_ROLE
(
...
comment on column HARLANDALEDATA.USER_ROLE.user_role_sid
  is 'User Role Surrogate Key';
comment on column HARLANDALEDATA.USER_ROLE.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.USER_ROLE.application_role_sid
  is 'Surrogate Key for the Application Role';
comment on column HARLANDALEDATA.USER_ROLE.default_application_flag
  is 'Denotes which application the user will be connected to after successful login(authorization).
Values: Y/N';
alter table HARLANDALEDATA.USER_ROLE
...
alter table HARLANDALEDATA.USER_ROLE
  ...
  references HARLANDALEDATA.APPLICATION_ROLE (APPLICATION_ROLE_SID);
alter table HARLANDALEDATA.USER_ROLE
...
prompt =====================================
prompt
create table HARLANDALEDATA.USER_SECURITY_QUESTION
(
...
comment on column HARLANDALEDATA.USER_SECURITY_QUESTION.user_security_question_sid
  is 'Surrogate Key for the User Security Question';
comment on column HARLANDALEDATA.USER_SECURITY_QUESTION.security_question_sid
  is 'Surrogate Key for the security Question';
comment on column HARLANDALEDATA.USER_SECURITY_QUESTION.user_sid
  is 'User Surrogate Key';
comment on column HARLANDALEDATA.USER_SECURITY_QUESTION.user_response
  is 'The users answer to the security question.';
alter table HARLANDALEDATA.USER_SECURITY_QUESTION
...
alter table HARLANDALEDATA.USER_SECURITY_QUESTION
  ...
  references HARLANDALEDATA.SECURITY_QUESTION (SECURITY_QUESTION_SID);
alter table HARLANDALEDATA.USER_SECURITY_QUESTION
...
prompt ====================================
prompt
create table HARLANDALEDATA.USER_STUDENT_SECURITY
(
  user_id      VARCHAR2(75) not null,
  district_sid NUMBER not null,
  student_sid  NUMBER not null
...
alter table HARLANDALEDATA.USER_STUDENT_SECURITY
...
prompt ===============================
prompt
create sequence HARLANDALEDATA.DEMO_CUST_SEQ
minvalue 1
...
prompt ======================================
prompt
create sequence HARLANDALEDATA.DEMO_ORDER_ITEMS_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 50
increment by 1
...
prompt ==============================
prompt
create sequence HARLANDALEDATA.DEMO_ORD_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 11
increment by 1
...
prompt ===============================
prompt
create sequence HARLANDALEDATA.DEMO_PROD_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 11
increment by 1
...
prompt ==========================
prompt
create sequence HARLANDALEDATA.DEPT_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 50
increment by 1
...
prompt =========================
prompt
create sequence HARLANDALEDATA.EMP_SEQ
minvalue 1
maxvalue 999999999999999999999999999
start with 8000
increment by 1
...
prompt ==============================
prompt
create sequence HARLANDALEDATA.SID_SEQUENCE
minvalue 1
maxvalue 999999999999999999999999999
start with 17422503
increment by 1
...
prompt ===========================
prompt
create or replace synonym HARLANDALEDATA.CR_ATT_CAL
  for ;
...
prompt ===========================
prompt
create or replace synonym HARLANDALEDATA.CR_ATT_OPT
  for ;
...
prompt ========================
prompt
create or replace synonym HARLANDALEDATA.CR_DEMO
  for ;
...
prompt =============================
prompt
create or replace synonym HARLANDALEDATA.CR_INSTR_CYR
  for ;
...
prompt ===================================
prompt
create or replace synonym HARLANDALEDATA.DR_CRS_OFFERED_CYR
  for ;
...
prompt ========================
prompt
create or replace synonym HARLANDALEDATA.DR_DEMO
  for ;
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.ET_C012_GEN
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.ET_C035_INSTRUCTSET
  for ;
...
prompt =================================
prompt
create or replace synonym HARLANDALEDATA.ET_C053_HANDICAP
  for ;
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.ET_C061_LEP
  for ;
...
prompt ===================================
prompt
create or replace synonym HARLANDALEDATA.ET_C093_PARPERMISS
  for ;
...
prompt ================================
prompt
create or replace synonym HARLANDALEDATA.ET_C095_SPTHRPY
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.ET_C131_YRENDSTATUS
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.ET_C175_BIL_PGM_TYP
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.ET_C176_ESL_PGM_TYP
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.PKG_REVEAL_SECURITY
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.SR_ATT_POST
  for ;
...
prompt ===========================
prompt
create or replace synonym HARLANDALEDATA.SR_CRS_GRD
  for ;
...
prompt ===========================
prompt
create or replace synonym HARLANDALEDATA.SR_DISCPLN
  for ;
...
prompt ================================
prompt
create or replace synonym HARLANDALEDATA.SR_DISCPLN_ACTN
  for ;
...
prompt =================================
prompt
create or replace synonym HARLANDALEDATA.SR_DISCPLN_OFENS
  for ;
...
prompt =====================================
prompt
create or replace synonym HARLANDALEDATA.SR_GRADEBK_HINT_INST
  for ;
...
prompt =================================
prompt
create or replace synonym HARLANDALEDATA.SR_GRADEBK_LOGIN
  for ;
...
prompt =============================
prompt
create or replace synonym HARLANDALEDATA.SR_HINT_QUES
  for ;
...
prompt ===========================
prompt
create or replace synonym HARLANDALEDATA.SR_IMMUNIZ
  for ;
...
prompt ==========================
prompt
create or replace synonym HARLANDALEDATA.SR_PARENT
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.SR_SPEC_PGM_BIL_ESL
  for ;
...
prompt ==================================
prompt
create or replace synonym HARLANDALEDATA.SR_SPEC_PGM_CHAP1
  for ;
...
prompt ===============================
prompt
create or replace synonym HARLANDALEDATA.SR_SPEC_PGM_GT
  for ;
...
prompt ==================================
prompt
create or replace synonym HARLANDALEDATA.SR_SPEC_PGM_OTHER
  for ;
...
prompt ========================================
prompt
create or replace synonym HARLANDALEDATA.SR_SPEC_PGM_PREG_PUPILS
  for ;
...
prompt ====================================
prompt
create or replace synonym HARLANDALEDATA.SR_SPEC_PGM_SPEC_ED
  for ;
...
prompt ==============================
prompt
create or replace synonym HARLANDALEDATA.SR_STU_CAMPUS
  for ;
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.SR_STU_DEMO
  for ;
...
prompt ==================================
prompt
create or replace synonym HARLANDALEDATA.SR_STU_DEMO_PEIMS
  for ;
...
prompt ==============================
prompt
create or replace synonym HARLANDALEDATA.SR_STU_ENROLL
  for ;
...
prompt =============================
prompt
create or replace synonym HARLANDALEDATA.ST_ACTIVE_CD
  for ;
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.ST_ATT_POST
  for ;
...
prompt ================================
prompt
create or replace synonym HARLANDALEDATA.ST_DISCPLN_ACTN
  for ;
...
prompt ===============================
prompt
create or replace synonym HARLANDALEDATA.ST_IMMUNIZ_TYP
  for ;
...
prompt ==========================
prompt
create or replace synonym HARLANDALEDATA.ST_LOC_CD
  for ;
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.ST_OFENS_CD
  for ;
...
prompt =============================
prompt
create or replace synonym HARLANDALEDATA.ST_OFENS_LVL
  for ;
...
prompt ==============================
prompt
create or replace synonym HARLANDALEDATA.ST_REC_STATUS
  for ;
...
prompt ============================
prompt
create or replace synonym HARLANDALEDATA.ST_RELATION
  for ;
...
prompt ===============================
prompt
create or replace synonym HARLANDALEDATA.ST_REP_EXCLUSN
  for ;
...
prompt ===============================
prompt
create or replace synonym HARLANDALEDATA.ST_SERIES_TYPE
  for ;
...
prompt ==========================
prompt
create or replace synonym HARLANDALEDATA.ST_WD_RSN
  for ;
...
prompt ===========================
prompt
create or replace force view harlandaledata.application_v as
select
--ROWID as "ROW_ID",
APPLICATION_ID,
ACTIVE_FLAG,
...
prompt ======================================
prompt
create or replace force view harlandaledata.execution_load_campus_vw as
...
prompt =================================
prompt
create or replace force view harlandaledata.reveal_lea_contexts as
...
prompt ================================
prompt
create or replace force view harlandaledata.reveal_log_catcher as
...
prompt ======================================
prompt
create or replace force view harlandaledata.security_question_user_v as
select
    u.user_id
  , security_question
...
prompt ============================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.USER_ACCOUNT_V AS
SELECT
...
prompt ===============================
prompt
create or replace force view harlandaledata.user_apps_roles_v as
select
    a.application_id
  , a.active_flag
  , a.description
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_STUDENT_MASTER AS
...
prompt ====================================
prompt
create or replace force view harlandaledata.v_dws_all_risk_factors as
select
        STUDENT_DIM.STUDENT_SID,
...
prompt ==============================
prompt
create or replace force view harlandaledata.v_dws_as_of_date as
...
prompt ==========================================
prompt
create or replace force view harlandaledata.v_dws_campus_risk_factor_sum as
select
       a.campus_id,
       a.campus_name,
...
prompt ==================================
prompt
create or replace force view harlandaledata.v_dws_champions_list as
select
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_CREDITS_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_CREDITS_SUMMARY AS
SELECT
...
prompt =====================================
prompt
create or replace force view harlandaledata.v_dws_curr_risk_factors as
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_DISC_ACT_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_DISC_INC_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt =======================================
prompt
create or replace force view harlandaledata.v_dws_disc_inc_act_detail as
select
...
prompt ======================================
prompt
create or replace force view harlandaledata.v_dws_enrollment_history as
...
prompt =================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_GRADES_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt =====================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_DWS_INTERVENTION" is
/* *******************************************
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_INTERVENTION AS
SELECT
INTERVENTION_SID
...
prompt ========================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_DWS_INTERV_CATEGORY" is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_INTERVENTION_CATEGORY AS
SELECT
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_INTERVENTION_NOTES AS
...
prompt ==========================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_INTERVENTION_NOTE_TYPE AS
SELECT
INTERVENTION_NOTE_TYPE_NAME
...
prompt =====================================
prompt
create or replace force view harlandaledata.v_dws_period_abs_detail as
select STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.CURRENTLY_ENROLLED_CAMPUS_ID,
...
prompt ==================================
prompt
create or replace force view harlandaledata.v_dws_period_abs_sum as
...
prompt ======================================
prompt
create or replace force view harlandaledata.v_dws_period_abs_sum_rpt as
with pivot_data AS (
select
"STUDENT_DIM".STUDENT_SID,
"STUDENT_DIM".STUDENT_ID,
...
from
 ...
 "CLASS_PERIOD_DIM" "CLASS_PERIOD_DIM"
where
 --"STUDENT_DIM".STUDENT_ID = '15019' AND
--and
 "STUDENT_DIM"."CURRENTLY_ENROLLED_FLAG"='Yes'
 and "DATE_DIM"."DATE_SID"="STUDENT_PERIOD_ABSENCE_FACT"."DATE_SID"
 and "CLASS_PERIOD_DIM"."CLASS_PERIOD_SID"="STUDENT_PERIOD_ABSENCE_FACT"."CLASS_PERIOD_SID"
...
prompt ===========================================
prompt
create or replace force view harlandaledata.v_dws_recently_added_students as
select
"STUDENT_DIM"."STUDENT_SID",
"CAMPUS_DIM"."CAMPUS_NAME",
...
prompt ====================================
prompt
create or replace force view harlandaledata.v_dws_risk_factor_flow as
select
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_RISK_FACTOR_HISTORY AS
WITH RUN_LOG AS (
...
SELECT
       ...
       STUDENT_DIM.MIGRANT,
       STUDENT_DIM.IMMIGRANT,
      -- STUDENT_DIM.USER_SID as STUDENT_CHAMPION,
       STUDENT_DIM.STUDENT_CHAMPION,
...
prompt
prompt Creating view V_DWS_RISK_FACTOR_HIST_EMAIL
prompt ==========================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_RISK_FACTOR_HIST_EMAIL AS
WITH RUN_LOG AS (
   SELECT MAX(RUN_DATE) RUN_DATE FROM EXECUTION_LOAD_CAMPUS_VW
   )
SELECT
...
prompt ========================================
prompt
create or replace force view harlandaledata.v_dws_student_intervention as
select
...
prompt ===========================================
prompt
create or replace force view harlandaledata.v_dws_student_intervention_ir as
select
  DWS_STUDENT_INTERVENTION.STUDENT_SID,
  DWS_STUDENT_INTERVENTION.STUDENT_INTERVENTION_SID,
  DWS_INTERVENTION_CATEGORY.INTERVENTION_CATEGORY,
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_STUDENT_NOTE AS
...
prompt ============================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_STUDENT_RISK_FACTOR_LIST AS
SELECT DISTINCT
       DISTRICT_SECURITY_KEY,
       CAMPUS_SECURITY_KEY,
       CAMPUS_DIM.CAMPUS_ID,
...
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_DWS_STU_INTERVENTION_STATUS AS
SELECT
INTERVENTION_STATUS
...
prompt ======================================
prompt
create or replace force view harlandaledata.v_dws_stu_risk_histogram as
select
 STUDENT_RISK_FACTOR_SNAPSHOT.RISK_FACTOR_COUNT,
...
prompt ==========================================
prompt
create or replace force view harlandaledata.v_dws_wkly_attendance_rf_cnt as
select
...
prompt =============================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_SCHOOL_YEAR_D AS
...
prompt ===========================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_SCHOOL_YEAR AS
SELECT DISTINCT sch_yr school_year
,sch_yr
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_ATT_DETAIL_D AS
SELECT
 SR_ATT_POST.SCH_YR
...
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_ATT_STU_ENROLL_DETAIL AS
SELECT
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_CONTACT_PARENT_D AS
SELECT
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_STU_CAMPUS_MASTER_D AS
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_STU_CAMPUS_MASTER AS
SELECT SCH_YR,
       GRD,
       GRDSORT,
       ENTRY_DT,
...
prompt ====================================
prompt
create or replace force view harlandaledata.v_txstu_contact_parent as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt =====================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_GRADEBK_LOGIN_D AS
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_GRADEBK_LOGIN AS
SELECT USER_ID,
       ACTIVE_CD,
...
prompt ==============================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_GRADES_D AS
SELECT
  SR_CRS_GRD.SCH_YR
...
prompt ============================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_GRADES AS
SELECT
  STUDENT.SCH_YR
  ,STUDENT.CAMPUS_ID
  ,STUDENT.CAMPUS_NAME
...
prompt ===============================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_IMMUNIZ_D AS
SELECT
STU_ID STUDENT_ID,
...
prompt =============================
prompt
create or replace force view harlandaledata.v_txstu_immuniz as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_INSTRUCTOR_D AS
SELECT
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_INSTRUCTOR AS
SELECT
...
prompt ====================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_REGISTRATION_D AS
SELECT
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_TXSTU_REGISTRATION AS
SELECT
...
prompt ===================================
prompt
create or replace force view harlandaledata.v_tx_stu_discipline_d as
select
d.sch_yr as SCH_YR,
...
prompt =================================
prompt
create or replace force view harlandaledata.v_tx_stu_discipline as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt =============================
prompt
CREATE OR REPLACE FORCE VIEW HARLANDALEDATA.V_USER_APP_LIST AS
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_CR_ATT_CAL
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_CR_ATT_OPT
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =====================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_CR_DEMO
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_CR_INSTR_CYR
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_DR_CRS_OFFERED_CYR
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =====================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_DR_DEMO
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C012_GEN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C035_INSTRUCTSET
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ==============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C053_HANDICAP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C061_LEP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C093_PARPERMISS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C095_SPTHRPY
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C131_YRENDSTATUS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C175_BIL_PGM_TYP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ET_C176_ESL_PGM_TYP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_ATT_POST
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_CRS_GRD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_DISCPLN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_DISCPLN_ACTN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_DISCPLN_OFENS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_GRADEBK_HINT_INST
REFRESH COMPLETE ON DEMAND
AS
SELECT
USER_ID,
...
prompt ==============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_GRADEBK_LOGIN
REFRESH COMPLETE ON DEMAND
AS
SELECT
USER_ID,
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_HINT_QUES
REFRESH COMPLETE ON DEMAND
AS
SELECT
QUES_ID,
...
prompt ========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_IMMUNIZ
REFRESH COMPLETE ON DEMAND
AS
SELECT
STU_ID,
...
prompt =======================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_PARENT
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_SPEC_PGM_BIL_ESL
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ===============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_SPEC_PGM_CHAP1
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_SPEC_PGM_GT
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt ===============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_SPEC_PGM_OTHER
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =====================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_SPEC_PGM_PREG_PUPILS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_SPEC_PGM_SPEC_ED
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ===========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_STU_CAMPUS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_STU_DEMO
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ===============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_STU_DEMO_PEIMS
REFRESH COMPLETE ON DEMAND
AS
SELECT
  SCH_YR,
...
prompt ===========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_SR_STU_ENROLL
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_ACTIVE_CD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_ATT_POST
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_DISCPLN_ACTN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_IMMUNIZ_TYP
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =======================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_LOC_CD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_OFENS_CD
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ==========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_OFENS_LVL
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ===========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_REC_STATUS
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =========================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_RELATION
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_REP_EXCLUSN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt ============================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_SERIES_TYPE
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR,
...
prompt =======================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_ST_WD_RSN
REFRESH COMPLETE ON DEMAND
AS
SELECT
SCH_YR
...
prompt =====================================================
prompt
CREATE MATERIALIZED VIEW HARLANDALEDATA.MV_TXSTU_STU_CAMPUS_BASE_D
REFRESH COMPLETE ON DEMAND
AS
SELECT
       	SR_STU_ENROLL.SCH_YR
...
prompt ====================================================
prompt
create materialized view HARLANDALEDATA.STUDENT_CREDIT_SUMMARY_MV
refresh complete on demand
as
select  distinct
    student_sid
...
prompt =========================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_CORE_LOAD_PROCESSING" is
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_CORE_UTILITIES" is
...
prompt ==========================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_DWS_INTERVENTION_NOTE" is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_DWS_SECURITY" is
...
prompt =============================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_DWS_STUDENT_INTERVENTION" is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =====================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_DWS_STUDENT_NOTE" is
--------------------------------------------------------------
...
prompt ==========================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_EMAIL" is
...
prompt
prompt Creating package PKG_EMAIL_AT_RISK_STU_INFO
prompt ===========================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_EMAIL_AT_RISK_STU_INFO" is

  /*--------------------------------
  
  Code: pkg_email_at_risk_stu_info
        prc_build_email (private)
        prc_send_email  (private)
        prc_get_and_email_info
        
  Use:
        to email district clients with risk factor counts by campus.
        
  Revision History:
  20131219       T. Esposito      original version
    
  Note:
        - Need to create ACL for schema for district in order for email to work.
        - Possible improvement -- pass run_days_since_flag as a parameter in SELECT.
        
  $Revision: 77 $
  $Author: espositot $ 
  $Date: 2014-01-07 16:20:44 -0600 (Tue, 07 Jan 2014) $
  $HeadURL: https://10.10.1.70/svn/revealdws/trunk/pkg_email_at_risk_stu_info.pck $ 
  
  ---------------------------------*/  
  
  procedure prc_get_and_email_info;

end pkg_email_at_risk_stu_info;
/
...
prompt ===============================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_ENROLLMENT_POST_PROCESSING" is
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_IDMGR_DISTRICT" is
--------------------------------------------------------------
...
prompt =======================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_IDMGR_USER_ACCOUNT" is
--------------------------------------------------------------
...
prompt ============================================
prompt
create or replace package harlandaledata.pkg_Risk_Calculation_Engine is
...
prompt =======================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_RISK_FACTOR_CONFIG" is
...
prompt ====================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_RPT_DATA_SOURCE" is
...
prompt =================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_SV_ACCT_MGMT"
AS
...
prompt ================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_SV_SECURITY"
AS
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_TXEIS_SECURITY" is
...
prompt ==============================
prompt
CREATE OR REPLACE PACKAGE HARLANDALEDATA."PKG_UTILITIES"
...
prompt =====================================
prompt
CREATE OR REPLACE FUNCTION HARLANDALEDATA."DEMO_ERROR_HANDLING" (
...
prompt ==============================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_CORE_LOAD_PROCESSING" is
...
prompt ========================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_CORE_UTILITIES" is
...
prompt ==========================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_DWS_INTERVENTION" is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION
   procedure INS_DWS_INTERVENTION (
      P_INTERVENTION_CATEGORY_SID in number,
...
prompt ===============================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_DWS_INTERVENTION_NOTE" is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION_NOTE
   procedure INS_DWS_INTERVENTION_NOTE (
      P_STUDENT_INTERVENTION_SID   in number,
...
prompt =============================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_DWS_INTERV_CATEGORY" is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION_CATEGORY
   procedure INS_DWS_INTERVENTION_CATEGORY (
      P_INTERVENTION_CATEGORY      in varchar2,
...
prompt ======================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_DWS_SECURITY" is
...
prompt ==================================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_DWS_STUDENT_INTERVENTION" is
...
prompt ==========================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_DWS_STUDENT_NOTE" is
--------------------------------------------------------------
-- create procedure for table DWS_STUDENT_NOTE
   procedure INS_DWS_STUDENT_NOTE (
      P_STUDENT_SID     in number,
...
prompt ===============================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_EMAIL" is
...
prompt
prompt Creating package body PKG_EMAIL_AT_RISK_STU_INFO
prompt ================================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_EMAIL_AT_RISK_STU_INFO" is
  ...
  Revision History:
  20131219       T. Esposito      original version.
  20140106       T. Esposito      tweaked HTML formating.
  20140107       T. Esposito      corrected exception handling for NO_DATA_FOUND,
                                  send email to 'reveal@region10.org' for status.
  
  Note:
        - Need to create ACL for schema for district in order for email to work.
        - Possible improvement -- pass in, as a parameter, run_days_since_flag value for SELECT statement.
  ...
  --------------------------------
  -- Type declarations and globals
  --------------------------------
  type risk_rec is record (district_name district_dim.district_name%TYPE
                          ,district_id varchar2(6)
                          ,campus_name campus_master.campus_name%TYPE
                          ,risk_factor_short_name v_dws_risk_factor_history.risk_factor_short_name%TYPE
                          ,risk_factor_count number
                          ,user_id user_account.user_id%TYPE);
                            
  type risk_tab is table of risk_rec index by pls_integer; 
  
  v_email_rec_info clob;
  v_start_time timestamp;
  v_end_time timestamp;
  v_errcode number;
  v_errmsg varchar2(200);
  v_email_cnt number := 0;
  v_errline pls_integer := $$PLSQL_LINE;
  v_errproc varchar2(240) := $$PLSQL_UNIT;
  
  --**************************************************************
  -- Build (mostly) dynamic part of email containing at risk info
  -- which contains the campus, risk factor and risk factor count.
  --**************************************************************
  procedure prc_build_email (ir_risk_info_rec in risk_rec) 
  as
  begin
    -- build a row in table, one for each campus-risk factor and provide count
    v_email_rec_info := v_email_rec_info || 
                       '<tr>
                        <td width="300" align="center">' || ir_risk_info_rec.campus_name || '</td>
                        <td width="100" align="center">' || ir_risk_info_rec.risk_factor_short_name || '</td>
                        <td width="400" align="center">' || ir_risk_info_rec.risk_factor_count || '</td>
                        </tr>';  
  
  -- let main procedure handle errors and log to etl_event_log
  exception
      when others then
        raise;
  ...
  --********************************************************
  -- Send email after creating (mostly) static part of email
  -- which contains user name and URL.
  --********************************************************
  procedure prc_send_email (ir_risk_info_rec in risk_rec) 
  as
    v_recipient_name varchar2(100) := initcap(substr(ir_risk_info_rec.user_id,1,instr(ir_risk_info_rec.user_id,'.')-1));
    v_recipient_email varchar2(100) := ir_risk_info_rec.user_id;
    v_subject_line varchar2(100) := 'Student Status Changes as of: ' || to_char(sysdate,'FMMonth DD, YYYY');
    v_link varchar2(4000) := '<a href="http://revealweb01.region10.org:8080/apexprod/f?p=117' || ir_risk_info_rec.district_id || '"> Link to Reveal</a>' ;
    v_email_body clob;
  ...
  begin
    ...
    v_email_body := '<html>
                     ...
                     <body>
                       <p>Dear ' || v_recipient_name || ',</p>
                       <p>Below is a count of students who have been added to the dropout risk factor list in the past week.</p>
                       <table border="1">
                         <tr>
                           <td width="300" align="center"><b>Campus</b></td>
                           <td width="100" align="center"><b>Risk Factor</b></td>
                           <td width="400" align="center"><b>Risk Factor Count</b></td>
                         </tr>'
                         || v_email_rec_info || 
                       '</table>
                       <p>Please use the following link to review the details in the Reveal DWS application. </p>
                       <p> '
                       || v_link ||
                       '</p>
                       <p>
                       Once you log on use the graph in the upper right quadrant to drill through to see the students added.
                       </p>
                       Sincerely,<br/>
                       <span class="sig">The Reveal Team, Region 10 ESC</span><br/>
                     </body>
                     </html>';

    -- send email to district users 
    utl_mail.send (sender => 'reveal@region10.org',
                   recipients => v_recipient_email,
                   cc  => '',
                   -- bcc => 'reveal@region10.org',   -- used for debugging purposes only
                   subject => v_subject_line,
                   message => v_email_body,
                   mime_type => 'text/html; charset=us-ascii',
                   priority => '');
    
    -- keep count of emails sent
    v_email_cnt := v_email_cnt + 1;
  ...
  --**********************************************
  -- Get at-risk student and email recipient data
  -- by pulling data from source system and using
  -- logic to format the email via procedure calls
  -- defined above.
  --**********************************************
  procedure prc_get_and_email_info
  as
    t_risk_info risk_tab;
    r_curr risk_rec;
    r_prev risk_rec;
    n_next_idx number;
    v_errcode number;
    v_errmsg varchar2(200);
    v_district_name district_dim.district_name%TYPE;
          
  begin
    -- log start of process
    v_start_time := SYSTIMESTAMP;
    pkg_utilities.proc_etl_log_event(v_errproc
                                    ,'Started'
                                    ,'PL/SQL'
                                    ,'Running'
                                    ,'0'
    ...
    select c.district_name
          ,c.district_id
          ,c.campus_name
          ,v.risk_factor_short_name 
          ,sum(v.risk_factor_count) risk_factor_count
          ,c.user_id
    bulk collect into t_risk_info      
    from v_dws_risk_factor_hist_email v
        ,(select dd.district_name
                ,ua.user_id
                ,cm.campus_name
                ,substr(cm.campus_id,1,6) as district_id
            from user_campus uc 
            join user_account ua using (user_sid)
            join campus_master cm using (campus_master_sid)
            join district_dim dd on dd.district_id = substr(cm.campus_id,1,6)
           where ua.active_account_flag = 'Y'
             and ua.account_locked = 'N') c
    where v.campus_name = c.campus_name
    and v.run_days_since_flag <= 7                 -- 7 days but may need to change during debugging to get data returned
    ...
    -- build and send email control logic   
    r_curr := t_risk_info(1);
    r_prev := t_risk_info(1);
    for idx in t_risk_info.first..t_risk_info.last -- loop thru user info
    loop
      n_next_idx := t_risk_info.next(idx); 
      if n_next_idx is not null then               -- if not end of user info
        r_curr := t_risk_info(n_next_idx);
        if r_curr.user_id != r_prev.user_id then   -- the last row for this user so send email
          prc_build_email(t_risk_info(idx));
          prc_send_email(t_risk_info(idx));
          r_prev.user_id := r_curr.user_id;
          v_email_rec_info := '';
        else                                       -- same user so continue to build table of risk factors
          prc_build_email(t_risk_info(idx));       
        end if;
      else                                         -- end of user info so make sure you get last row and email sent
         prc_build_email(t_risk_info(idx)); 
         prc_send_email(t_risk_info(idx)); 
      end if;     
    end loop;
    ...
    pkg_utilities.proc_etl_log_event(v_errproc
                                    ...
                                    ,'Success'
                                    ,0
                                    ,'Success running ' || v_errproc || ' to completion'
                                    ,v_start_time
                                    ,v_end_time
                                    ,pkg_utilities.fn_get_elapsed_time(v_start_time, v_end_time));
                                    
    -- send email to R10 admin 
    utl_mail.send (sender => 'reveal@region10.org',
                   recipients => 'reveal@region10.org',
                   cc  => '',
                   subject => 'Emails to district ' || t_risk_info(1).district_name || ' ran successfully.', 
                   message => 'Count of emails sent: ' || v_email_cnt,
                   mime_type => 'text/html; charset=us-ascii',
                   priority => '');                                 
 
    -- handle errors and log to etl_event_log
    exception
      when NO_DATA_FOUND then
        v_end_time := SYSTIMESTAMP;
        
        -- get district name from district_dim since no risk factor data found
        ...
        pkg_utilities.proc_etl_log_event(v_errproc
                                        ...
                                        ,'Warning'
                                        ,'0'
                                        ,'Warning - No data found to email for district ' || v_district_name
                                        ,0
                                        ,'Warning - No data found to email in ' || v_errproc || ' at line ' || v_errline
                                        ,v_start_time
                                        ,v_end_time
                                        ,pkg_utilities.fn_get_elapsed_time(v_start_time, v_end_time));
        ...
        utl_mail.send (sender => 'reveal@region10.org',
                       recipients => 'reveal@region10.org',
                       cc  => '',
                       subject => 'Warning: No emails sent to district ' || v_district_name || '.  See ETL_EVENT_LOG for warnings.',  
                       message => 'No risk factor data found so no emails sent to district ' || v_district_name,
                       mime_type => 'text/html; charset=us-ascii',
                       priority => '');                                   
      ...
      when others then
        ...
        pkg_utilities.proc_etl_log_event(v_errproc
                                        ...
                                        ,v_errmsg
                                        ,0
                                        ,'Error in ' || v_errproc || ' at line ' || v_errline || ':' || v_errcode || ' ' || v_errmsg
                                        ,v_start_time
                                        ,v_end_time
                                        ,pkg_utilities.fn_get_elapsed_time(v_start_time, v_end_time));
        ...
        utl_mail.send (sender => 'reveal@region10.org',
                       recipients => 'reveal@region10.org',
                       cc  => '',
                       subject => 'Error: Emails to district ' || t_risk_info(1).district_name || ' failed. See ETL_EVENT_LOG for errors.',
                       message => 'Count of emails sent: ' || v_email_cnt,
                       mime_type => 'text/html; charset=us-ascii',
                       priority => '');                                         
    
  end prc_get_and_email_info;  
...
prompt ====================================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_ENROLLMENT_POST_PROCESSING" is
...
prompt ========================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_IDMGR_DISTRICT" is
--------------------------------------------------------------
-- update procedure for table "DISTRICT_DIM
   procedure PROC_UPD_DISTRICT_DIM (
      P_DISTRICT_SID in number,
...
prompt ============================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_IDMGR_USER_ACCOUNT" is
--------------------------------------------------------------
-- build MD5 function for table "USER_ACCOUNT
--------------------------------------------------------------
   function FN_BUILD_USER_ACCOUNT_MD5 (
...
-- delete procedure for table "USER_ACCOUNT
--
-- 20131127 TE      Added exception handling for DWS-exclusive tables
--                  during DELETE and UPDATE should the tables not
--                  exist.
--------------------------------------------------------------
   procedure PROC_DEL_USER_ACCOUNT (
      P_USER_SID in number
...
prompt =================================================
prompt
create or replace package body harlandaledata.pkg_risk_calculation_engine is
...
prompt ============================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_RISK_FACTOR_CONFIG" is
  ...
  begin
    ...
    if p_campus_id is not null then
       ...
       select campus_dim.campus_sid
        ...
        -- delete log data --
        delete from execution_parameter 
          where campus_sid = v_campus_sid;
...
prompt =========================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_RPT_DATA_SOURCE" is
...
prompt ======================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_SV_ACCT_MGMT"
AS
PROCEDURE proc_reset_email
          (  p_email_to IN VARCHAR2
            ,p_email_from IN VARCHAR2
...
prompt =====================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_SV_SECURITY"
AS
PROCEDURE proc_login
          (
           p_uname IN VARCHAR2
...
BEGIN
   ...
   --dbms_output.put_line(v_name);
   htp.prn('<span style=black;font-size:175%;>'||v_name||'</span>');
...
prompt ========================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_TXEIS_SECURITY" is
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE BODY HARLANDALEDATA."PKG_UTILITIES"
AS
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."MAINTAIN_CAMPUS_SELECTIONS"
...
prompt ============================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_ABS_RSN_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_CAMPUS_DIM_LAST_UPDATE"
...
prompt ==============================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_CLASS_PRD_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_COURSE_DIM_LAST_UPDATE"
...
prompt =============================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_CRS_SECT_DIM_LAST_UPDATE"
...
prompt =========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_DIST_DIM_LAST_UPDATE"
...
prompt ========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."TRG_STU_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."USER_ACCOUNT_BEFORE_INSERT"
BEFORE INSERT
    ON USER_ACCOUNT
    FOR EACH ROW
...
prompt ==========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."USER_CAMPUS_BEFORE_INSERT"
BEFORE INSERT
    ON USER_CAMPUS
    FOR EACH ROW
...
prompt ============================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."USER_QUESTION_BEFORE_INSERT"
BEFORE INSERT
...
prompt ========================================
prompt
CREATE OR REPLACE TRIGGER HARLANDALEDATA."USER_ROLE_BEFORE_INSERT"
BEFORE INSERT
    ON USER_ROLE
    FOR EACH ROW
