-----------------------------------------------------------
-- Export file for user SOMEWHEREISDDATA@DATAWH          --
-- Created by espositot on 5/26/2016, 16:43:46 16:43:46  --
-----------------------------------------------------------

set define off
spool somewhereisddata_ddl.log

prompt
prompt Creating table DISTRICT_DIM
prompt ===========================
prompt
create table SOMEWHEREISDDATA.DISTRICT_DIM
(
  ...
  password_minimum_length       NUMBER(2) default 8
)
...
comment on table SOMEWHEREISDDATA.DISTRICT_DIM
  is 'A local education agency.
Example: Dallas Independent School District';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.district_area
  is 'The educational area or region in which the district is located.
Example: Region 10
';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.district_key
  is 'Uniquely identifies a district.  A concatenation of state code and district id.
Example: TX*043901';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.region_name
  is 'The name of the regional service service center for this campus.
Example: Region 10,
                10';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.web_site
  is 'District Website address.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.password_expire_days
  is 'The number of days before since the last password change before a user must change their

password.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.password_max_attempts
  is 'The maximum number of times a user will be allowed to try to log on before their account is

locked.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.password_expire_month
  is 'The month number that user passwords will have to be changed.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.password_expire_day
  is 'The day of the month that user passwords will have to be changed.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.password_expiration_method
  is 'Specifies which method will be used to force users to change their passwords.
Values: Number Of Days
             Specific Month/Day';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.district_security_question
  is 'A question to validate first time users.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.district_security_answer
  is 'The answer to the district security question.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.district_ip_range
...
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.login_message
  is 'A message displayed on the login page for all users.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.login_message_start_date_time
  is 'The start date and time of the login message.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.login_message_end_date_time
  is 'The end date and time of the login message.';
comment on column SOMEWHEREISDDATA.DISTRICT_DIM.password_minimum_length
  is 'Specifies the minimum length for the users password.';
alter table SOMEWHEREISDDATA.DISTRICT_DIM
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.ABSENCE_REASON_DIM
(
...
comment on table SOMEWHEREISDDATA.ABSENCE_REASON_DIM
  is 'The reason that a student missed instruction such as excused or unexcused.';
comment on column SOMEWHEREISDDATA.ABSENCE_REASON_DIM.absence_reason_key
...
comment on column SOMEWHEREISDDATA.ABSENCE_REASON_DIM.exclude_absence_reason
  is 'Indicates that the Absence Reason should be excluded from Risk Calculation Engine processing.
Values: Yes/No';
alter table SOMEWHEREISDDATA.ABSENCE_REASON_DIM
...
alter table SOMEWHEREISDDATA.ABSENCE_REASON_DIM
  ...
  references SOMEWHEREISDDATA.DISTRICT_DIM (DISTRICT_SID);

prompt
prompt Creating table ACADEMIC_RECORD_SOURCE_DIM
prompt =========================================
prompt
create table SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM
(
...
comment on table SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM
  is 'Indicates the where the record of academic achievement came from, classroom, transfer, exam, etc...';
comment on column SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM.academic_source_code
  is 'A code that indicates what kind of Academic Source .
Example: T - transfer
               C - Classroom
               E - Exam
               O - online';
comment on column SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM.academic_source_description
  is 'Describes the Academic Source Code.
Examples: Transfer,
                 Classroom,
                 Exam,
                 Online';
create unique index SOMEWHEREISDDATA.PK_CREDIT_TYPE_DIM on SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM (ACADEMIC_SOURCE_CODE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM
...
prompt ============================================
prompt
create table SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM
(
...
comment on table SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM
  is 'Describes why the assigned action length varies from the actual days served.';
comment on column SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason_sid
  is 'Uniquely identifies the Action Length Diff Reason Dim';
comment on column SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason
  is 'Description of why the assigned days varies from the actual days.
Example: Term Modified by District';
comment on column SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM.action_length_diff_reason_key
  is 'Business key for the Action Length Diff Reason Dim.
Example: TX*849395*Other';
alter table SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM
...
prompt ==========================
prompt
create table SOMEWHEREISDDATA.APPLICATION
(
...
comment on column SOMEWHEREISDDATA.APPLICATION.application_id
  is 'The APEX application number';
comment on column SOMEWHEREISDDATA.APPLICATION.active_flag
  is 'Indicates if the application is currently active and available.
Values: Y, N';
comment on column SOMEWHEREISDDATA.APPLICATION.description
  is 'Describes the Application';
comment on column SOMEWHEREISDDATA.APPLICATION.application_alias
...
Example: DWS,
               REVIDMGR';
alter table SOMEWHEREISDDATA.APPLICATION
...
prompt =====================================
prompt
create table SOMEWHEREISDDATA.APPLICATION_EVENT_TYPE
(
...
alter table SOMEWHEREISDDATA.APPLICATION_EVENT_TYPE
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.APPLICATION_EVENT_LOG
(
...
alter table SOMEWHEREISDDATA.APPLICATION_EVENT_LOG
...
alter table SOMEWHEREISDDATA.APPLICATION_EVENT_LOG
  ...
  references SOMEWHEREISDDATA.APPLICATION_EVENT_TYPE (EVENT_TYPE_SID);

prompt
prompt Creating table ROLE_MASTER
prompt ==========================
prompt
create table SOMEWHEREISDDATA.ROLE_MASTER
(
...
comment on column SOMEWHEREISDDATA.ROLE_MASTER.role_sid
  is 'Surrogate Key for the User role';
comment on column SOMEWHEREISDDATA.ROLE_MASTER.role
  is 'Defines a role that can be applied to an application and a user.
Example: District,
              Campus';
alter table SOMEWHEREISDDATA.ROLE_MASTER
...
prompt ===============================
prompt
create table SOMEWHEREISDDATA.APPLICATION_ROLE
(
...
comment on column SOMEWHEREISDDATA.APPLICATION_ROLE.application_role_sid
  is 'Surrogate Key for the Application Role';
comment on column SOMEWHEREISDDATA.APPLICATION_ROLE.role_sid
  is 'Surrogate Key for the User role';
alter table SOMEWHEREISDDATA.APPLICATION_ROLE
...
alter table SOMEWHEREISDDATA.APPLICATION_ROLE
  ...
  references SOMEWHEREISDDATA.ROLE_MASTER (ROLE_SID);
alter table SOMEWHEREISDDATA.APPLICATION_ROLE
  add constraint FK_APPL_REF_APP_ROLE foreign key (APPLICATION_ID)
  references SOMEWHEREISDDATA.APPLICATION (APPLICATION_ID);

prompt
prompt Creating table CAMPUS_DIM
prompt =========================
prompt
create table SOMEWHEREISDDATA.CAMPUS_DIM
(
...
comment on table SOMEWHEREISDDATA.CAMPUS_DIM
...
alter table SOMEWHEREISDDATA.CAMPUS_DIM
...
prompt =======================
prompt
create table SOMEWHEREISDDATA.DATE_DIM
(
...
comment on table SOMEWHEREISDDATA.DATE_DIM
  is 'Identifies the common and districts specific calendars.';
comment on column SOMEWHEREISDDATA.DATE_DIM.date_sid
...
comment on column SOMEWHEREISDDATA.DATE_DIM.district_sid
  is 'Surrogate key';
comment on column SOMEWHEREISDDATA.DATE_DIM.date_id
  is 'A specific day of the year';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_year
  is 'Example: 2009';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_year_quarter
  is 'Example: 2009 Q1';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_quarter
  is 'Example: 1';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_year_month
  is 'Example: 200912';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_month
  is 'Example: 12';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_month_name
  is 'Example: December';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_month_short_name
  is 'Example: Dec';
comment on column SOMEWHEREISDDATA.DATE_DIM.calendar_week
  is 'Example: 50';
comment on column SOMEWHEREISDDATA.DATE_DIM.day_of_week
...
7 (Saturday)
';
comment on column SOMEWHEREISDDATA.DATE_DIM.day_of_week_name
  is 'Example: Thursday';
comment on column SOMEWHEREISDDATA.DATE_DIM.day_of_week_short_name
  is 'Example: Thu';
comment on column SOMEWHEREISDDATA.DATE_DIM.school_year
  is 'Begins Aug 1 of the calendar year and ends July 31 of the next calendar year.
Example: 2009';
comment on column SOMEWHEREISDDATA.DATE_DIM.school_year_description
  is 'Example: 2009/2010';
comment on column SOMEWHEREISDDATA.DATE_DIM.school_week
  is 'Example: 24';
comment on column SOMEWHEREISDDATA.DATE_DIM.year_month_day
  is 'Example: 20091215';
comment on column SOMEWHEREISDDATA.DATE_DIM.short_date
  is 'Example: 12/15/2009';
comment on column SOMEWHEREISDDATA.DATE_DIM.long_date
  is 'Example: December 15, 2009';
comment on column SOMEWHEREISDDATA.DATE_DIM.school_day_indicator
  is 'Denotes what type of school day this particular day represents.
Values:
Instructional
Professional
Non-Academic';
comment on column SOMEWHEREISDDATA.DATE_DIM.academic_6_weeks
...
comment on column SOMEWHEREISDDATA.DATE_DIM.academic_9_weeks
...
9
0 - non-instructional days';
comment on column SOMEWHEREISDDATA.DATE_DIM.semester
  is 'Example: 1';
comment on column SOMEWHEREISDDATA.DATE_DIM.first_day_academic_6_weeks
  is 'Values: Yes/No';
comment on column SOMEWHEREISDDATA.DATE_DIM.last_day_academic_6_weeks
  is 'Values: Yes/No';
comment on column SOMEWHEREISDDATA.DATE_DIM.first_day_academic_9_weeks
  is 'Values: Yes/No';
comment on column SOMEWHEREISDDATA.DATE_DIM.last_day_academic_9_weeks
  is 'Values: Yes/No';
comment on column SOMEWHEREISDDATA.DATE_DIM.first_day_semester
  is 'Values: Yes/No';
comment on column SOMEWHEREISDDATA.DATE_DIM.last_day_semester
  is 'Values: Yes/No';
comment on column SOMEWHEREISDDATA.DATE_DIM.date_key
...
alter table SOMEWHEREISDDATA.DATE_DIM
...
prompt ===========================
prompt
create table SOMEWHEREISDDATA.USER_ACCOUNT
(
  ...
  peims_at_risk            VARCHAR2(1) default 'N',
...
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.user_id
  is 'A unique name or email address that identifies a user of one or more applications.
example: jane.doe@anywhereISD.org';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.password
  is 'Users encrypted password';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.password_expiration_date
  is 'The date on which the users password will expire and need to be changed.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.password_update_date
  is 'The date on which the user last changed their password.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.user_first_name
  is 'First name of the user.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.user_last_name
  is 'Surname of the user.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.email_address
  is 'The email address of the user.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.created_by
  is 'The SID of the user that created this user account.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.create_date
  is 'The timestamp when the account was created.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.updated_by
  is 'The SID of the user that updated this user account.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.update_date
  is 'The timestamp when the account was updated.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.account_locked
  is 'Indicates that the account is locked or not allowing or restricting access.
Values: Y, N';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.employee_id
  is 'The Employee identifier of number.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.active_account_flag
  is 'Indicates that the account is currently active for use or has been deactivated.
Values: Y, N';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.last_login_date
  is 'The date and time that the user last successfully logged into a reveal application.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.first_login_flag
  is 'A flag to indicate that the user has not logged in before and needs to complete additional

security setup.
Values: Y/N';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.attempt_ctr
  is 'Identifies the number failed attempts to log on by this user';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.user_source
...
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.super_user
  is 'Indicates that the user is authorized to access functions reserved for the highest level users. Values Y/N';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.reveal_control_panel
  is 'Indicates that the user is authorized to access the control panel page of the Reveal Reporter Application.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.peims_at_risk
  is 'Indicates that the user is authorized to access the functionality related to the capture of PEIMS at risk information.';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.student_ssn_auth
  is 'Indicates if this user is allowed to view Student SSNs. Values are Y or N';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.staff_ssn_auth
  is 'Indicates if this user is allowed to view Staff SSNs. Values are Y or N';
comment on column SOMEWHEREISDDATA.USER_ACCOUNT.econ_disadv_auth
  is 'Indicates if this user is allowed to view the Economically Disadvantage information for a student. Values are Y or N';
alter table SOMEWHEREISDDATA.USER_ACCOUNT
...
prompt ==========================
prompt
create table SOMEWHEREISDDATA.STUDENT_DIM
(
...
comment on table SOMEWHEREISDDATA.STUDENT_DIM
  is 'Identifies a person who receives instruction from a district/campus.';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.postal_code
  is 'Students zip code. may include plus 4. Example: 75444-3333';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.phone_number
  is 'Students Primary contact phone number digits only.  Example: 5558884444';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.gender
  is 'Students Gender Values: Male/Female';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.ethnicity
  is 'Hispanic or Not. Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.american_indian_alaska_native
  is 'Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.asian
  is 'Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.black_or_african_american
  is 'Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.native_hawaiian_pacific_island
  is 'Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.white
  is 'Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.two_or_more_races
  is 'Values Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.race_ethnicity_short_desc
  is 'Concatenation of Student ethnicity and races.
Example: Hispanic, Amer. Indian/Alaskan. , Asian, Black';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.primary_language
  is 'Students primary spoken language.  Example: Spanish';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.ninth_grade_cohort
  is 'The calculated year of graduation based on the year the student entered the ninth grade.';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.limited_english_proficiency
...
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.lep_first_year_monitoring
  is 'Students who are in first year monitoring for limited english proficiency.
values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.lep_second_year_monitoring
  is 'Students who are in second year monitoring for limited english proficiency.
values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.immigrant
  is 'Students who are not naturalized citizens of the United States.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.migrant
  is 'Student whose family frequently moves to follow seasonal work patterns.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.economically_disadvantaged
...
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.special_education
  is 'Indicates that a student is participating a special education program.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.meal_eligibility
...
examples:  Free
              ...
              , Unknown
';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.primary_disability
...
';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.secondary_disability
...
Examples: Emotional Disturbance,
  ...
  Learning Disability,
';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.tertiary_disability
...
Examples: Emotional Disturbance,
  ...
  Learning Disability,
';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.date_entered_ninth_grade
  is 'The date the student start the ninth grade.
Example: 8/24/2008';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.student_photo
  is 'A picture of the student.';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.race_ethnicity_key
...
------   =   Unknown
';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.campus_security_key
...
comment on column SOMEWHEREISDDATA.STUDENT_DIM.district_security_key
  is 'The Current district of the student used to restrict data for security.
A concatenation of state code and district id.
Example: OK*8394839';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.student_key
  is 'The business key for student.  A concatenation of State code, District id, and Student Id.';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.campus_sid
  is 'Identifies the SID of the students currently enrolled campus.';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.campus_id
  is 'Identifies the Campus Id of the students currently enrolled campus.';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.STUDENT_DIM.unique_state_id
  is 'Unique student id assigned by the state.';
create bitmap index SOMEWHEREISDDATA.BMI_STU_DIM_DISTRICT_SID_FK on SOMEWHEREISDDATA.STUDENT_DIM (DISTRICT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.STUDENT_DIM
...
alter table SOMEWHEREISDDATA.STUDENT_DIM
  ...
  references SOMEWHEREISDDATA.USER_ACCOUNT (USER_SID);

prompt
prompt Creating table ATTENDANCE_RISK_FACTOR_FACT
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT
(
  campus_sid               NUMBER not null,
  student_sid              NUMBER not null,
  date_sid                 NUMBER not null,
...
comment on table SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  is 'Captures the results of the Risk Factor Calculation Engine for the attendance risk factor.';
comment on column SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT.period_absence_count
  is 'The number periods the student was absent on this day.
Example: 7';
comment on column SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT.ytd_period_absence_count
  is 'The total number of periods absent from the start of the school year unitl this date.
Example: 54';
comment on column SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT.ytd_days_enrolled
  is 'The total number days the student has been enrolled since the start of the school year unitl this date.
Example: 132';
comment on column SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT.period_absence_percent
  is 'The percent of instructional periods that the student has missed.
Example: .1323 (13.22%)';
comment on column SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT.last_update
  is 'The datetime that the row was insert/updated';
alter table SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_CAMPUS_D foreign key (CAMPUS_SID)
  references SOMEWHEREISDDATA.CAMPUS_DIM (CAMPUS_SID);
alter table SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_DATE_DIM foreign key (DATE_SID)
  references SOMEWHEREISDDATA.DATE_DIM (DATE_SID);
alter table SOMEWHEREISDDATA.ATTENDANCE_RISK_FACTOR_FACT
  add constraint FK_ATTENDAN_REFERENCE_STUDENT_ foreign key (STUDENT_SID)
  references SOMEWHEREISDDATA.STUDENT_DIM (STUDENT_SID);

prompt
prompt Creating table RISK_FACTOR
prompt ==========================
prompt
create table SOMEWHEREISDDATA.RISK_FACTOR
(
...
comment on column SOMEWHEREISDDATA.RISK_FACTOR.risk_factor_type
  is 'Indicates that the Factor is either a primary or secondary.
Values: Primary,
Secondary';
comment on column SOMEWHEREISDDATA.RISK_FACTOR.mandatory_flag
  is 'Indicates if the campus is required to select this risk factor or if it is optional.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.RISK_FACTOR.risk_factor_order
  is 'Defines the sort order for the presentation of the risk factors.';
alter table SOMEWHEREISDDATA.RISK_FACTOR
...
prompt ======================================
prompt
create table SOMEWHEREISDDATA.CAMPUS_FACTOR_SELECTION
(
  campus_sid      NUMBER not null,
  risk_factor_sid NUMBER not null,
  last_update     TIMESTAMP(6)
...
create bitmap index SOMEWHEREISDDATA.BMI_CAMPUS_FACT_SEL_RISK_SIDFK on SOMEWHEREISDDATA.CAMPUS_FACTOR_SELECTION (RISK_FACTOR_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.CAMPUS_FACTOR_SELECTION
...
alter table SOMEWHEREISDDATA.CAMPUS_FACTOR_SELECTION
  ...
  references SOMEWHEREISDDATA.RISK_FACTOR (RISK_FACTOR_SID);

prompt
prompt Creating table CAMPUS_MASTER
prompt ============================
prompt
create table SOMEWHEREISDDATA.CAMPUS_MASTER
(
...
nologging;
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_master_sid
  is 'Surrogate Key for the Campus Master';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.school_id
  is 'The three digit identifier for the school.
Example: 102';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_id
  is 'The nine digit identifier for the campus consisting of the district id and school id.
Example: 057901102';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_name
  is 'The full name of the campus.
Example: SCHOOL FOR THE TALENTED AND GIFTED';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_status
  is 'Identifies the current status of the school.
Example: ACTIVE,
              UNDER CONSTRUCTION,
              ';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.region_name
  is 'The name of the regional service service center for this campus.
Example: Region 10,
                10';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_state_code
  is 'The state abbreviation for the state that is campus resides in.';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_grade_range
  is 'Defines the grade levels taught at this campus.
Example:  06-08,
                EE-05
';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.periods_per_day
  is 'The number of scheduled periods per day at this campus.
Example: 7
8
4 (for A/B block schedule)';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.attendance_threshold
  is 'The percentage threshold by which students will be flagged for the attendance risk factor.
Example: .10 - 10%
               .08 - 8%';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.passing_grade_threshold
  is 'Defines the lowest pasing number grade at this campus.
Example: 70 (default),
                60,
                80';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.default_grading_cycle
  is 'Defines the grading cycle to be used by the core/non-core risk factor for this campus.
Values: 6-Weeks,
             9-Weeks';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.campus_key
  is 'Uniquely identifies a campus. A concatenation of the state code, district id, and campus id.
Example: TX*043901*043901001';
comment on column SOMEWHEREISDDATA.CAMPUS_MASTER.last_update
  is 'Date the row was created or last updated.';
alter table SOMEWHEREISDDATA.CAMPUS_MASTER
...
alter index SOMEWHEREISDDATA.PK_CAMPUS_MASTER nologging;
alter table SOMEWHEREISDDATA.CAMPUS_MASTER
...
alter index SOMEWHEREISDDATA.AK_CAMPUS_MASTER_AK_CAMPUS_M nologging;
alter table SOMEWHEREISDDATA.CAMPUS_MASTER
...
prompt =====================================
prompt
create table SOMEWHEREISDDATA.CAMPUS_RISK_FACTOR_DIM
(
...
alter table SOMEWHEREISDDATA.CAMPUS_RISK_FACTOR_DIM
...
prompt ===============================
prompt
create table SOMEWHEREISDDATA.CLASS_PERIOD_DIM
(
...
comment on table SOMEWHEREISDDATA.CLASS_PERIOD_DIM
  is 'Identifies the division of the day assigned the a particular class of instruction.';
comment on column SOMEWHEREISDDATA.CLASS_PERIOD_DIM.class_period_sid
  is 'Surrogate Key for Class Period Dim.';
comment on column SOMEWHEREISDDATA.CLASS_PERIOD_DIM.campus_sid
  is 'The Campus Sid of the campus that owns the class periods.';
comment on column SOMEWHEREISDDATA.CLASS_PERIOD_DIM.class_period
...
Example: 01,
                ...
                KG,
                PK';
comment on column SOMEWHEREISDDATA.CLASS_PERIOD_DIM.class_period_key
  is 'The business key for the district class periods.
Example: TX*057904*057905001*001
                TX*043901*043901003*M13';
comment on column SOMEWHEREISDDATA.CLASS_PERIOD_DIM.last_update
  is 'Date time that the row was inserted or updated.';
comment on column SOMEWHEREISDDATA.CLASS_PERIOD_DIM.exclude_class_period
  is 'Indicates that the Class Period should be excluded from Risk Calculation Engine processing.
Values: Yes/No';
alter table SOMEWHEREISDDATA.CLASS_PERIOD_DIM
...
prompt =========================
prompt
create table SOMEWHEREISDDATA.COURSE_DIM
(
  course_sid               NUMBER not null,
  district_sid             NUMBER,
  campus_id                VARCHAR2(20),
  course_code              VARCHAR2(31),
...
comment on table SOMEWHEREISDDATA.COURSE_DIM
  is 'A state or locally define curriculum of instruction.';
comment on column SOMEWHEREISDDATA.COURSE_DIM.course_sid
  is 'Surrogate Key for the Course Dim.';
comment on column SOMEWHEREISDDATA.COURSE_DIM.campus_id
  is 'Identifes the campus that owns this particular course.
example: 888888002';
comment on column SOMEWHEREISDDATA.COURSE_DIM.course_code
  is 'The local distrcit/campus identifier for course.';
comment on column SOMEWHEREISDDATA.COURSE_DIM.course_description
  is 'The local name or description of course.';
comment on column SOMEWHEREISDDATA.COURSE_DIM.school_year
  is 'The applicable school year for this course.
Example: 2010';
comment on column SOMEWHEREISDDATA.COURSE_DIM.state_course_code
  is 'The state defined code for the course
Example: 03330100';
comment on column SOMEWHEREISDDATA.COURSE_DIM.state_course_description
  is 'The name/description of the state defined course.
Example: US GOVT';
comment on column SOMEWHEREISDDATA.COURSE_DIM.core_course_flag
  is 'Indicates that this state course is a "core" course for the purposes of the Failed Course flags.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.COURSE_DIM.course_key
...
alter table SOMEWHEREISDDATA.COURSE_DIM
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.COURSE_SECTION_DIM
(
  course_section_sid       NUMBER not null,
  campus_id                VARCHAR2(20),
  course_code              VARCHAR2(25),
  course_description       VARCHAR2(150),
  course_section_number    VARCHAR2(25),
  school_year              VARCHAR2(4),
  term                     VARCHAR2(1),
  state_course_code        VARCHAR2(15),
  state_course_description VARCHAR2(150),
  core_course_flag         VARCHAR2(3),
  course_section_key       VARCHAR2(75),
  last_update              TIMESTAMP(6)
)
tablespace DW_DEFAULT01
  pctfree 10
...
comment on table SOMEWHEREISDDATA.COURSE_SECTION_DIM
  is 'Identifies a scheduled course.';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.course_section_sid
  is 'Surrogate key for the Course Section Dim.';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.campus_id
  is 'Identifies the Campus where this section of the course is taught.
Example: 19902002
';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.course_code
  is 'Identifies the Course being taught.
Example: 1001';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.course_description
  is 'Describes the Course being taught.
Example: ENGLISH 1  ';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.course_section_number
  is 'Identifies the Course Section being taught.
Example: 001';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.school_year
  is 'Describes the school year for the Course Section being taught.
Example: 2011';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.term
...
Example: 1 (Semester or trimester)
                ...
                3 (trimester),
                 Y (Full Year)';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.state_course_code
  is 'Identifies the associated State course for the Course Section being taught.
Example: 03220100';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.state_course_description
  is 'Describes the associated State course for the Course Section being taught.
Example: English I (1 Unit) (ENG 1)';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.core_course_flag
  is 'Identifies if the Course Section being taught is a Core Course.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.course_section_key
...
comment on column SOMEWHEREISDDATA.COURSE_SECTION_DIM.last_update
  is 'The Date/Time the row as last inserted or updated.';
alter table SOMEWHEREISDDATA.COURSE_SECTION_DIM
...
prompt =============================
prompt
create table SOMEWHEREISDDATA.DISCIPLINE_DIM
(
...
comment on table SOMEWHEREISDDATA.DISCIPLINE_DIM
  is 'Describes the various types of descipline that may be applied to a student.';
comment on column SOMEWHEREISDDATA.DISCIPLINE_DIM.discipline_sid
  is 'Uniquely identifies the Discipline DIM';
comment on column SOMEWHEREISDDATA.DISCIPLINE_DIM.campus_id
  is 'Copied formthe campus_dim';
comment on column SOMEWHEREISDDATA.DISCIPLINE_DIM.discipline_code
  is 'The local code that identifies a type of discipline.
Example: WL
               VW';
comment on column SOMEWHEREISDDATA.DISCIPLINE_DIM.discipline_description
  is 'Description of the discipline.
Example: Place In Daep By Court,
                Cont. of District''s Expul. Order from Prior Yr';
comment on column SOMEWHEREISDDATA.DISCIPLINE_DIM.discipline_key
  is 'Business key for the Discipline Dim. By Campus.
Example TX*894758001*11';
comment on column SOMEWHEREISDDATA.DISCIPLINE_DIM.exclude_discipline_flag
  is 'Indicates if the discipline should be exclude from process by the RCE.
values: YES/NO Defalut=YES';
alter table SOMEWHEREISDDATA.DISCIPLINE_DIM
...
prompt
prompt Creating table DWS_AUDIT_LOG
prompt ============================
prompt
create table SOMEWHEREISDDATA.DWS_AUDIT_LOG
(
  dws_audit_log_sid  NUMBER not null,
  user_sid           NUMBER not null,
  student_sid        NUMBER,
  source_sid         NUMBER not null,
  database_action    VARCHAR2(15) not null,
  table_name         VARCHAR2(30) not null,
  column_name        VARCHAR2(30),
  from_value         VARCHAR2(2000),
  to_value           VARCHAR2(2000),
  change_date        TIMESTAMP(6) not null,
  change_description VARCHAR2(2000) not null
)
tablespace DW_DEFAULT01
  pctfree 10
  initrans 1
...
comment on table SOMEWHEREISDDATA.DWS_AUDIT_LOG
  is 'Tracks chages to the system.';
comment on column SOMEWHEREISDDATA.DWS_AUDIT_LOG.user_sid
  is 'User Surrogate Key';
alter table SOMEWHEREISDDATA.DWS_AUDIT_LOG
  add constraint PK_DWS_AUDIT_LOG primary key (DWS_AUDIT_LOG_SID)
  using index 
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
...
alter table SOMEWHEREISDDATA.DWS_AUDIT_LOG
  add constraint FK_DWS_AUDIT_REF_STUDENT_DIM foreign key (STUDENT_SID)
  references SOMEWHEREISDDATA.STUDENT_DIM (STUDENT_SID);
alter table SOMEWHEREISDDATA.DWS_AUDIT_LOG
  add constraint FK_DWS_AUDIT_REF_USER_ACCT foreign key (USER_SID)
  references SOMEWHEREISDDATA.USER_ACCOUNT (USER_SID);
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.DWS_GLOBAL_DEFAULT
(
...
comment on table SOMEWHEREISDDATA.DWS_GLOBAL_DEFAULT
  is 'Contains default vaules that are applied at various times during system operation.';
comment on column SOMEWHEREISDDATA.DWS_GLOBAL_DEFAULT.campus_periods_per_day
  is 'Defines the default number of periods per day to be applied to new campuses.
Default Value = 7';
comment on column SOMEWHEREISDDATA.DWS_GLOBAL_DEFAULT.campus_attendance_threshold
  is 'Defines the default attendance threshold to be applied to new campuses.
Default Value = .10 (10%)';
comment on column SOMEWHEREISDDATA.DWS_GLOBAL_DEFAULT.campus_passing_grade_threshold
  is 'Defines the default passing grade for students at a campus to be applied to new campuses.
Default Value: 70';
comment on column SOMEWHEREISDDATA.DWS_GLOBAL_DEFAULT.campus_default_grading_cycle
...
prompt ========================================
prompt
create table SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY
(
...
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY.intervention_category_sid
  is 'Surrogate key for the intervention category';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY.intervention_category
  is 'Describes a grouping of interventions.
Examples: Tutoring,
                Mentoring,
               Counseling';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY.intervention_category_desc
  is 'Describes the intervention category.';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY.active_flag
  is 'Indicates if the catefory is actively in use or not.
Values: Y/N';
alter table SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY
...
prompt ===============================
prompt
create table SOMEWHEREISDDATA.DWS_INTERVENTION
(
...
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.intervention_sid
  is 'Surrogate Key for the Intervention';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.create_by_user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.last_update_user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.intervention_name
  is 'The specific name of the intervention.
example : Math Tutoring,
                Parent Conference,
                Attendance Monitoring';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.intervention_description
  is 'Describes the intervention.';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.intervention_comment
  is 'User comments about the intervention';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.active_flag
  is 'Indicates if the Intervention is in use or not.
Values: Y/N';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.create_date
  is 'The date and time the Intervention was created.';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION.last_update
  is 'The date and time the Intervention was last updated.';
alter table SOMEWHEREISDDATA.DWS_INTERVENTION
...
alter table SOMEWHEREISDDATA.DWS_INTERVENTION
  ...
  references SOMEWHEREISDDATA.DWS_INTERVENTION_CATEGORY (INTERVENTION_CATEGORY_SID);
alter table SOMEWHEREISDDATA.DWS_INTERVENTION
...
prompt =========================================
prompt
create table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE_TYPE
(
...
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_sid
  is 'Surrogate key for the intervention note type';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_name
  is 'The name of the type of note.
example: Status/Update
               Parent Conference
               Student Conference
                Other';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE_TYPE.intervention_note_type_desc
  is 'describes the type of note.';
alter table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE_TYPE
...
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.DWS_STU_INTERVENTION_STATUS
(
...
comment on column SOMEWHEREISDDATA.DWS_STU_INTERVENTION_STATUS.intervention_status_sid
  is 'Surrogate Key for the Student Intervention Status';
comment on column SOMEWHEREISDDATA.DWS_STU_INTERVENTION_STATUS.intervention_status
  is 'Indicates the state of the intervention.
Example: Open,
                Hold,
                Closed';
comment on column SOMEWHEREISDDATA.DWS_STU_INTERVENTION_STATUS.intervention_status_desc
  is 'describes the intervention status.
example: The "Hold" status indicates that the student is temporarily not 
participating in the intervention.';
alter table SOMEWHEREISDDATA.DWS_STU_INTERVENTION_STATUS
...
prompt =======================================
prompt
create table SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION
(
  ...
  intervention_goal           VARCHAR2(2000),
...
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.student_intervention_sid
  is 'Surrogate key for the student Intervention';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.created_by_user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.last_update_user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.intervention_begin_date
  is 'The date on which the student begins the intervention';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.intervention_end_date
  is 'The date on which the intervention for the student end or ended.';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.intervention_goal
...
of the semester.';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.intervention_plan
...
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.intervention_result_comment
...
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.intervention_result_rank
  is 'Ranks the result of the intervention on a scale of 1 to 5.
1 being unsuccessful and 5 being completely successful.
Values: 1 - 5';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.create_date
  is 'Date and time the Intervention was created';
comment on column SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION.last_update
  is 'Date and time the Intervention was last updated';
alter table SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION
...
alter table SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION
  ...
  references SOMEWHEREISDDATA.DWS_INTERVENTION (INTERVENTION_SID);
alter table SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION
  add constraint FK_DWS_STU_INV_REF_DWS_INV_STS foreign key (INTERVENTION_STATUS_SID)
  references SOMEWHEREISDDATA.DWS_STU_INTERVENTION_STATUS (INTERVENTION_STATUS_SID);
alter table SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE
(
...
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE.intervention_note_sid
  is 'Surrogate Key for the intervention Note';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE.intervention_note_dt
  is 'The date and time that the note was created';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE.intervention_note_text
  is 'The user enter text describing some event related to the intervention.';
comment on column SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE.last_update
  is 'The date and time the note was last updated.  Will initially be the same as the creation date.';
alter table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE
...
alter table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE
  ...
  references SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE_TYPE (INTERVENTION_NOTE_TYPE_SID);
alter table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE
...
alter table SOMEWHEREISDDATA.DWS_INTERVENTION_NOTE
  ...
  references SOMEWHEREISDDATA.DWS_STUDENT_INTERVENTION (STUDENT_INTERVENTION_SID);

prompt
prompt Creating table DWS_PEIMS_AT_RISK
prompt ================================
prompt
create table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
(
  peims_at_risk_sid             NUMBER not null,
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  school_year                   VARCHAR2(4) not null,
  user_sid                      NUMBER,
  certified_date                TIMESTAMP(6),
  grades_repeated               VARCHAR2(10),
  current_grade_level           VARCHAR2(3),
  prior_year_grade_level        VARCHAR2(3),
  prek_assmt_reading            VARCHAR2(10),
  prek_assmt_math               VARCHAR2(10),
  k_3_assmt_reading             VARCHAR2(10),
  k_3_assmt_math                VARCHAR2(10),
  pre_assmt_at_risk_ind         VARCHAR2(3),
  pr_yr_fail_grade_reading      VARCHAR2(10),
  pr_yr_fail_grade_ela_writing  VARCHAR2(10),
  pr_yr_fail_grade_math         VARCHAR2(10),
  pr_yr_fail_grade_science      VARCHAR2(10),
  pr_yr_fail_grade_soc_studies  VARCHAR2(10),
  grades_at_risk_ind            VARCHAR2(3),
  state_assmt_reading           VARCHAR2(10),
  state_assmt_writing           VARCHAR2(10),
  state_assmt_math              VARCHAR2(10),
  state_assmt_science           VARCHAR2(10),
  state_assmt_social_studies    VARCHAR2(10),
  state_assmt_at_risk_ind       VARCHAR2(3),
  prev_fail_state_assmt_110_pct VARCHAR2(3),
  pregnant_or_parent_ind        VARCHAR2(3),
  daep_ind                      VARCHAR2(3),
  expelled_ind                  VARCHAR2(3),
  parole_probation_ind          VARCHAR2(3),
  dropout_ind                   VARCHAR2(3),
  lep_ind                       VARCHAR2(3),
  protective_services_ind       VARCHAR2(3),
  homeless_ind                  VARCHAR2(3),
  residential_placement_fac_ind VARCHAR2(3),
  at_risk_code                  VARCHAR2(10),
  at_risk_entry_date            DATE,
  at_risk_exit_date             DATE,
  coded_at_risk_on_peims        VARCHAR2(3)
)
tablespace DW_DEFAULT01
  pctfree 10
  initrans 1
...
comment on table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
  is 'Student at-risk information supporting PEIMS submission.';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.pre_assmt_at_risk_ind
  is 'Indicates the student may be at risk on Readiness Assessments (elem.)';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.pr_yr_fail_grade_reading
  is 'Prior Year Failed Grade for Reading grades 7-12';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.pr_yr_fail_grade_ela_writing
  is 'Prior Year Failed Grade for ELA/Writing grades 7-12';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.pr_yr_fail_grade_math
  is 'Prior Year Failed Grade for Math grades 7-12';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.pr_yr_fail_grade_science
  is 'Prior Year Failed Grade for Science grades 7-12';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.pr_yr_fail_grade_soc_studies
  is 'Prior Year Failed Grade for Social Studies grades 7-12';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.grades_at_risk_ind
  is 'Indicates if student is at risk for failed grades in grade levels 7-12';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.prev_fail_state_assmt_110_pct
  is 'The student previously failed a state assessment and has not earned 110%';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.residential_placement_fac_ind
  is 'Indicates if the student is in a residental placement facility.';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.at_risk_code
  is 'At risk code for this Student.';
comment on column SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK.coded_at_risk_on_peims
  is 'Indicates the student was code at risk on PEIMS';
alter table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
  add constraint PK_DWS_PEIMS_AT_RISK primary key (PEIMS_AT_RISK_SID)
  using index 
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
...
alter table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
  add constraint AK_DWS_PIEMS_AT_RISK unique (SCHOOL_YEAR, CAMPUS_SID, STUDENT_SID)
  using index 
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
...
alter table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
  add constraint FK_DWS_PEIM_REFERENCE_CAMPUS_D foreign key (CAMPUS_SID)
  references SOMEWHEREISDDATA.CAMPUS_DIM (CAMPUS_SID);
alter table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
  add constraint FK_DWS_PEIM_REFERENCE_STUDENT_ foreign key (STUDENT_SID)
  references SOMEWHEREISDDATA.STUDENT_DIM (STUDENT_SID);
alter table SOMEWHEREISDDATA.DWS_PEIMS_AT_RISK
  add constraint FK_DWS_PEIM_REF_USER_ACCT foreign key (USER_SID)
  references SOMEWHEREISDDATA.USER_ACCOUNT (USER_SID);
...
prompt ===============================
prompt
create table SOMEWHEREISDDATA.DWS_STUDENT_NOTE
(
...
comment on column SOMEWHEREISDDATA.DWS_STUDENT_NOTE.note_author_sid
  is 'User Surrogate Key';
alter table SOMEWHEREISDDATA.DWS_STUDENT_NOTE
...
prompt =========================
prompt
create table SOMEWHEREISDDATA.EMAIL_TYPE
(
...
comment on column SOMEWHEREISDDATA.EMAIL_TYPE.email_type_sid
  is 'Surrogate Key for the Email Type';
comment on column SOMEWHEREISDDATA.EMAIL_TYPE.email_type
  is 'Indicates the kind of email.
Example: New User,
                Password Reset,
                Welcome to Reveal,
                System Maintenance';
alter table SOMEWHEREISDDATA.EMAIL_TYPE
...
prompt ==================================
prompt
create table SOMEWHEREISDDATA.EMAIL_SPECIFICATION
(
...
comment on column SOMEWHEREISDDATA.EMAIL_SPECIFICATION.email_sid
  is 'Surrogate Key for the Email Specification.';
comment on column SOMEWHEREISDDATA.EMAIL_SPECIFICATION.email_type_sid
  is 'Surrogate Key for the Email Type';
comment on column SOMEWHEREISDDATA.EMAIL_SPECIFICATION.email_subject
  is 'Email Subject Line.
Example: Password Reset Request ';
comment on column SOMEWHEREISDDATA.EMAIL_SPECIFICATION.email_body
...
';
comment on column SOMEWHEREISDDATA.EMAIL_SPECIFICATION.application_link
  is 'The HTML link to the appliction login.';
comment on column SOMEWHEREISDDATA.EMAIL_SPECIFICATION.salutation
  is 'The closing of the email.
Example:
Sincerely,
The SchoolViz Support Team';
alter table SOMEWHEREISDDATA.EMAIL_SPECIFICATION
...
alter table SOMEWHEREISDDATA.EMAIL_SPECIFICATION
  ...
  references SOMEWHEREISDDATA.EMAIL_TYPE (EMAIL_TYPE_SID);

prompt
prompt Creating table ETL_EVENT_LOG
prompt ============================
prompt
create table SOMEWHEREISDDATA.ETL_EVENT_LOG
(
...
nologging;
comment on column SOMEWHEREISDDATA.ETL_EVENT_LOG.event_time
  is 'Defaults to SYSDATE';
comment on column SOMEWHEREISDDATA.ETL_EVENT_LOG.event_type
  is 'Values: Warning, Informational, Error';
comment on column SOMEWHEREISDDATA.ETL_EVENT_LOG.source_name
  is 'Values: Cognos, PL/SQL, Perl, SQL*Loader, Other';
comment on column SOMEWHEREISDDATA.ETL_EVENT_LOG.status
  is 'Values: Started, Running, Failed, Succeeded';
comment on column SOMEWHEREISDDATA.ETL_EVENT_LOG.elapsed_time
  is 'In seconds';
create index SOMEWHEREISDDATA.BMI_EVENT_LOG_EVENT_TYPE on SOMEWHEREISDDATA.ETL_EVENT_LOG (EVENT_TYPE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.BMI_EVENT_LOG_STATUS on SOMEWHEREISDDATA.ETL_EVENT_LOG (STATUS)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.ETL_EVENT_LOG
...
prompt =============================================
prompt
create table SOMEWHEREISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE
(
...
comment on table SOMEWHEREISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE
  is 'Converts CDM grading period to CORE Grade_Type as well as identifing the associated period number.';
comment on column SOMEWHEREISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.cdm_grading_period
  is 'The GradingPeriod from the TSDS CDM model.
Example: First Six Weeks,
                Second Nine Weeks,
                Second Semester';
comment on column SOMEWHEREISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.period_number
  is 'Grading Period for specific Grade Type';
comment on column SOMEWHEREISDDATA.ETL_GRADINGPERIOD_TO_GRADETYPE.cycle_type
...
prompt ============================
prompt
create table SOMEWHEREISDDATA.EXECUTION_LOG
(
...
comment on table SOMEWHEREISDDATA.EXECUTION_LOG
  is 'Tracks information about each run of the risk factor calculation engine or the load process.';
comment on column SOMEWHEREISDDATA.EXECUTION_LOG.execution_start_time
  is 'The datetime that the engine started processing this risk factor';
comment on column SOMEWHEREISDDATA.EXECUTION_LOG.process_name
  is 'Name of the process being run
Example: Attendance
               CoreCourseFailure
               ';
comment on column SOMEWHEREISDDATA.EXECUTION_LOG.process_type
  is 'Type of process being run
Example: RCE
               District Load
               Campus Load';
comment on column SOMEWHEREISDDATA.EXECUTION_LOG.execution_end_time
  is 'The datetime that the engine stopped processing this risk factor';
comment on column SOMEWHEREISDDATA.EXECUTION_LOG.execution_result
  is 'The outcome of the execution.
Values: Successful
             Failed';
alter table SOMEWHEREISDDATA.EXECUTION_LOG
...
prompt ==================================
prompt
create table SOMEWHEREISDDATA.EXECUTION_PARAMETER
(
  execution_start_time TIMESTAMP(6) not null,
  campus_sid           NUMBER not null,
...
comment on table SOMEWHEREISDDATA.EXECUTION_PARAMETER
  is 'Contains the parameters used in the execution of a system process.';
comment on column SOMEWHEREISDDATA.EXECUTION_PARAMETER.execution_start_time
  is 'The datetime that the engine started processing this risk factor';
comment on column SOMEWHEREISDDATA.EXECUTION_PARAMETER.parameter_name
  is 'The name of the parameter used in the risk factor calculation.
Example: Periods Per Day
                Attendance Threshold';
comment on column SOMEWHEREISDDATA.EXECUTION_PARAMETER.parameter_value
  is 'The Value of the first parameter used in the risk factor calculation.
Example: 7';
alter table SOMEWHEREISDDATA.EXECUTION_PARAMETER
...
alter table SOMEWHEREISDDATA.EXECUTION_PARAMETER
  ...
  references SOMEWHEREISDDATA.EXECUTION_LOG (EXECUTION_START_TIME, CAMPUS_SID);

prompt
prompt Creating table GRADE_LEVEL_DIM
prompt ==============================
prompt
create table SOMEWHEREISDDATA.GRADE_LEVEL_DIM
(
...
comment on table SOMEWHEREISDDATA.GRADE_LEVEL_DIM
  is 'Identifies the student grade level.
Example: 01
                PK
                KG
                12';
comment on column SOMEWHEREISDDATA.GRADE_LEVEL_DIM.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column SOMEWHEREISDDATA.GRADE_LEVEL_DIM.grade_level
  is 'Identifies a students assigned grade.
Example: 01
                02
                12';
comment on column SOMEWHEREISDDATA.GRADE_LEVEL_DIM.grade_level_description
  is 'Describes a grade level.
Example: First Grade
               Second Grade
               Twelth Grade';
comment on column SOMEWHEREISDDATA.GRADE_LEVEL_DIM.grade_level_order
  is 'Indicates the order of the grade levels for sorting.
Example: 1
                2
                3
';
alter table SOMEWHEREISDDATA.GRADE_LEVEL_DIM
...
prompt =============================
prompt
create table SOMEWHEREISDDATA.GRADE_TYPE_DIM
(
...
comment on table SOMEWHEREISDDATA.GRADE_TYPE_DIM
...
Example: Progess Report
               ...
               Exam
';
comment on column SOMEWHEREISDDATA.GRADE_TYPE_DIM.grade_type_sid
  is 'Surrogate Key for the Grade Type dim';
comment on column SOMEWHEREISDDATA.GRADE_TYPE_DIM.grade_type
...
Example: Six Weeks,
                ...
                Exam,
                Final';
comment on column SOMEWHEREISDDATA.GRADE_TYPE_DIM.grade_type_description
  is 'The Full Description of the grade type.
Example: The six weeks grade revceived by the student';
comment on column SOMEWHEREISDDATA.GRADE_TYPE_DIM.last_update
  is 'The data time this row was last insert/updated';
alter table SOMEWHEREISDDATA.GRADE_TYPE_DIM
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM
(
...
comment on table SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM
  is 'Identifies the student behaviors associated with a discipline event.';
comment on column SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_sid
  is 'Uniquely identifies an incident behavior.';
comment on column SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM.campus_id
  is 'Campus Id copied from the campus dim.';
comment on column SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_code
  is 'Local code that identifies a student behavior associated with an incident.';
comment on column SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_description
  is 'Describes a students behavior
Example: Permanent Removal By A Teacher From Class,
               Alcoholic Beverage,
               Bullying';
comment on column SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_category
  is 'Grouping of behaviors
Examples: School Code of Conduct,
                  State Offense';
comment on column SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM.incident_behavior_key
  is 'Business key for the incident behavior. Consisting of the state code, campus id
and behavior code.
Example: TX*849304001*37';
alter table SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM
(
...
comment on table SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM
  is 'The location where a discipline incident took place';
comment on column SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM.incident_location_sid
  is 'Uniquely identifies the Incident Location';
comment on column SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM.incident_location
  is 'Identifies the place where an incident took place.
Example: Classroom,
                Cafeteria area,
                Unknown';
comment on column SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM.incident_location_key
  is 'Business key for the incident location.
Example: TX*108909*Classroom';
alter table SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM
...
prompt =========================================
prompt
create table SOMEWHEREISDDATA.MERGED_STUDENT_RISK_FACTOR
(
  student_sid       NUMBER not null,
  risk_factor_sid   NUMBER not null,
...
comment on table SOMEWHEREISDDATA.MERGED_STUDENT_RISK_FACTOR
...
comment on column SOMEWHEREISDDATA.MERGED_STUDENT_RISK_FACTOR.flag_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.MERGED_STUDENT_RISK_FACTOR.end_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.MERGED_STUDENT_RISK_FACTOR.risk_factor_count
  is 'Measure used by report tools to count number of studnets with risk factors.
Value 1';
alter table SOMEWHEREISDDATA.MERGED_STUDENT_RISK_FACTOR
...
prompt ===============================
prompt
create table SOMEWHEREISDDATA.NINTH_GRD_COHORT
(
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.RACE_ETHNICITY_DIM
(
...
comment on table SOMEWHEREISDDATA.RACE_ETHNICITY_DIM
  is 'Idenitfies the ethnicity and race selections of a person.';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_sid
  is 'Surrogate key';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.yes_no_key
...
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.binary_key
...
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_key
  is 'The race ethnicity key is used for look up puposes.  It is a positional map of the selected options.
values:
0 - not selected
HIABPW - selected
...
------   =   Unknown
';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.ethnicity
  is 'Indicates that the individual selected Hispanic/Latino(Yes) or Not Hispanic/Latino(No).
Values:
Yes
No';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.ethnicity_description
  is 'Values:
Hispanic/Latino
Not Hispanic/Latino';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.american_indian_alaska_native
  is 'Indicates that the individual selected American Indian/Alaska Native(Yes) or Not American Indian/Alaska Native(No).
Values:
Yes
No';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.amer_indian_alaskan_desc
  is 'Values:
American Indian or Alaska Native
Not American Indian or Alaska Native';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.asian
  is 'Indicates that the individual selected Asian(Yes) or Not Asian(No).
Values:
Yes
No';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.asian_description
  is 'Values:
Asian
Not Asian';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.black_or_african_american
  is 'Indicates that the individual selected Black or African American(Yes) or Not Black or African American(No).
Values:
Yes
No';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.black_african_amer_desc
  is 'Values:
Black or African American
Not Black or African American';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.native_hawaiian_pacific_island
...
Yes
No';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.hawaiian_pacific_island_desc
  is 'Values:
Native Hawaiian/Other Pacific Islander
Not Native Hawaiian/Other Pacific Islander';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.white
  is 'Indicates that the individual selected White(Yes) or Not White(No).
Values:
Yes
No';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.white_description
  is 'Values:
White
Not White';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.two_or_more_races
  is 'Indicates that two or more races were selected.
Example:
Asian, White';
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_long_desc
...
comment on column SOMEWHEREISDDATA.RACE_ETHNICITY_DIM.race_ethnicity_short_desc
...
Black, White';
alter table SOMEWHEREISDDATA.RACE_ETHNICITY_DIM
...
prompt =====================
prompt
create table SOMEWHEREISDDATA.SOURCE
(
  source_sid         NUMBER not null,
...
comment on table SOMEWHEREISDDATA.SOURCE
  is 'The source of data for the reporting category.';
comment on column SOMEWHEREISDDATA.SOURCE.source_sid
  is 'Uniquely identifies the source.';
comment on column SOMEWHEREISDDATA.SOURCE.source_name
  is 'The name of the source of the data of the reporting category.
Example: TxEIS,
                TexasStudentDataSystem(TSDS),
                 Jira';
comment on column SOMEWHEREISDDATA.SOURCE.source_description
  is 'Description of the Source.';
comment on column SOMEWHEREISDDATA.SOURCE.active_flag
  is 'Indicates if the source is available for use.
Values: Y/N';
comment on column SOMEWHEREISDDATA.SOURCE.current_mode
  is 'Whether the data source is set to REALTIME or DATAMART.';
alter table SOMEWHEREISDDATA.SOURCE
...
prompt ==============================
prompt
create table SOMEWHEREISDDATA.REPORT_CATEGORY
(
...
comment on table SOMEWHEREISDDATA.REPORT_CATEGORY
  is 'Defines the groupings of reports. Such as Student, Registration, Health, etc.';
comment on column SOMEWHEREISDDATA.REPORT_CATEGORY.source_sid
  is 'Uniquely identifies the source.';
comment on column SOMEWHEREISDDATA.REPORT_CATEGORY.report_category
  is 'Used to group reports together.
  Example: Student,
                  Finance';
comment on column SOMEWHEREISDDATA.REPORT_CATEGORY.report_category_description
  is 'Describes the REPORT CATEGORY';
comment on column SOMEWHEREISDDATA.REPORT_CATEGORY.active_flag
  is 'denotes if the category is in use.
Values: Y/N';
alter table SOMEWHEREISDDATA.REPORT_CATEGORY
...
alter table SOMEWHEREISDDATA.REPORT_CATEGORY
  ...
  references SOMEWHEREISDDATA.SOURCE (SOURCE_SID);

prompt
prompt Creating table REPORT_TYPE
prompt ==========================
prompt
create table SOMEWHEREISDDATA.REPORT_TYPE
(
...
comment on table SOMEWHEREISDDATA.REPORT_TYPE
  is 'The kind of report';
alter table SOMEWHEREISDDATA.REPORT_TYPE
...
prompt ==========================
prompt
create table SOMEWHEREISDDATA.REPORT_LIST
(
...
comment on column SOMEWHEREISDDATA.REPORT_LIST.report_name
  is 'The name of the report to be displayed on the main page.';
comment on column SOMEWHEREISDDATA.REPORT_LIST.report_description
  is 'Describes the REPORT';
comment on column SOMEWHEREISDDATA.REPORT_LIST.report_alias
  is 'The APEX page alias for the report, used in the link to the page';
comment on column SOMEWHEREISDDATA.REPORT_LIST.report_category_sid
  is 'Foriegn key to report_category table';
comment on column SOMEWHEREISDDATA.REPORT_LIST.active_flag
  is 'Used to indicate if a flag is active for use or not.
  values: Y,
           N';
alter table SOMEWHEREISDDATA.REPORT_LIST
...
alter table SOMEWHEREISDDATA.REPORT_LIST
  ...
  references SOMEWHEREISDDATA.REPORT_CATEGORY (REPORT_CATEGORY_SID)
  deferrable initially deferred;
alter table SOMEWHEREISDDATA.REPORT_LIST
  add constraint FK_REPORT_L_REFERENCE_REPORT_T foreign key (REPORT_TYPE_SID)
  references SOMEWHEREISDDATA.REPORT_TYPE (REPORT_TYPE_SID);

prompt
prompt Creating table RF_DISPLAY_COLUMNS
prompt =================================
prompt
create table SOMEWHEREISDDATA.RF_DISPLAY_COLUMNS
(
  campus_sid               NUMBER not null,
...
alter table SOMEWHEREISDDATA.RF_DISPLAY_COLUMNS
...
prompt =====================================
prompt
create table SOMEWHEREISDDATA.SECURITY_QUESTION_TYPE
(
...
comment on column SOMEWHEREISDDATA.SECURITY_QUESTION_TYPE.security_question_type_sid
  is 'Surrogate Key for the Security Question Type';
comment on column SOMEWHEREISDDATA.SECURITY_QUESTION_TYPE.security_question_type_name
  is 'Denotes the type of Security Question.
Values: Login,
            External IP Address,
            Password Reset';
comment on column SOMEWHEREISDDATA.SECURITY_QUESTION_TYPE.security_question_type_desc
...
system.';
alter table SOMEWHEREISDDATA.SECURITY_QUESTION_TYPE
...
prompt ================================
prompt
create table SOMEWHEREISDDATA.SECURITY_QUESTION
(
...
comment on column SOMEWHEREISDDATA.SECURITY_QUESTION.security_question_sid
  is 'Surrogate Key for the security Question';
comment on column SOMEWHEREISDDATA.SECURITY_QUESTION.security_question_type_sid
  is 'Surrogate Key for the Security Question Type';
comment on column SOMEWHEREISDDATA.SECURITY_QUESTION.security_question
  is 'A question used to identify a valid user.
Example: What is your birth city?';
alter table SOMEWHEREISDDATA.SECURITY_QUESTION
...
alter table SOMEWHEREISDDATA.SECURITY_QUESTION
  ...
  references SOMEWHEREISDDATA.SECURITY_QUESTION_TYPE (SECURITY_QUESTION_TYPE_SID);

prompt
prompt Creating table SECURITY_TRANSACTION_LOG
prompt =======================================
prompt
create table SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG
(
...
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.security_transaction_sid
  is 'Surrogate key for the logon transaction.';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.user_id
  is 'The User ID of the person attempting to login.';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.transaction_date
  is 'Date and time of the security transaction.';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.log_message
  is 'Indicates the result of the users attempt to login to an application. Values: SUCCESSFUL LOGIN, UNSUCCESSFUL LOGIN, ACCOUNT LOCKED, PASSWORD CHANGED, USER ROLE ADDED, APPLICATION LICENSE DELETED, <ATTENDANCE> RISK FACTOR DELETED FOR CAMPUS <057938001>';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.action_type
  is 'Indicates what type of action was taken by the user. Example: Login Attempt, Password Reset, First Time Login, External Security Question, Login Question, etc..';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.action_result
  is 'Indicates the result of the users action. Example: Successful, Failed';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.attempts
  is 'Indicates the number times the user entered their password or security question before either successfully or unsuccessfully logging in. Example: 2';
comment on column SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG.user_ip_address
  is 'The users ip address that they connected to the application from. Example: 207.235.45.106 (ipv4) 2001:db8:85a3::8a2e:370:7334 (ipv6)';
alter table SOMEWHEREISDDATA.SECURITY_TRANSACTION_LOG
...
prompt ============================
prompt
create table SOMEWHEREISDDATA.SOURCE_CONFIG
(
...
alter table SOMEWHEREISDDATA.SOURCE_CONFIG
...
prompt ===============================
prompt
create table SOMEWHEREISDDATA.STATE_COURSE_DIM
(
...
comment on table SOMEWHEREISDDATA.STATE_COURSE_DIM
  is 'Contains all of the state defined courses.';
comment on column SOMEWHEREISDDATA.STATE_COURSE_DIM.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column SOMEWHEREISDDATA.STATE_COURSE_DIM.state_code
  is 'The upper case two character state code for this course.
Example: TX';
comment on column SOMEWHEREISDDATA.STATE_COURSE_DIM.state_course_code
  is 'The state defined code for the course
Example: 03330100';
comment on column SOMEWHEREISDDATA.STATE_COURSE_DIM.state_course_description
  is 'The name/description of the state defined course.
Example: US GOVT';
comment on column SOMEWHEREISDDATA.STATE_COURSE_DIM.core_course_flag
  is 'Indicates that this state course is a "core" course for the purposes of the Failed Course flags.
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STATE_COURSE_DIM.state_course_key
  is 'The business key used to look state courses. Consisting of the state code * state course code
Example: TX*049304939';
alter table SOMEWHEREISDDATA.STATE_COURSE_DIM
...
prompt ==================================
prompt
create table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
(
...
comment on table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
...
comment on column SOMEWHEREISDDATA.STUDENT_CREDIT_FACT.student_credit_fact_sid
  is 'A surrogate key for the fact.';
comment on column SOMEWHEREISDDATA.STUDENT_CREDIT_FACT.course_sid
  is 'Surrogate Key for the Course Dim.';
comment on column SOMEWHEREISDDATA.STUDENT_CREDIT_FACT.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column SOMEWHEREISDDATA.STUDENT_CREDIT_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_CREDIT_FACT.credits_earned
  is 'The number of credits earned by a student for a particular course.
Example: 1.0,
                0.5,
                0.25
                0.333';
comment on column SOMEWHEREISDDATA.STUDENT_CREDIT_FACT.local_credits_earned
  is 'This is the value for credits earned from the source.
Examples: 10
                  5
                  NC';
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
  ...
  references SOMEWHEREISDDATA.ACADEMIC_RECORD_SOURCE_DIM (ACADEMIC_SOURCE_CODE);
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
  ...
  references SOMEWHEREISDDATA.COURSE_DIM (COURSE_SID);
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
  ...
  references SOMEWHEREISDDATA.STATE_COURSE_DIM (STATE_COURSE_SID);
alter table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT
...
prompt ======================================
prompt
create table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT_ERR
(
...
prompt ======================================
prompt
create table SOMEWHEREISDDATA.STUDENT_CREDIT_FACT_REJ
(
  student_credit_fact_sid NUMBER not null,
  campus_sid              NUMBER not null,
  course_sid              NUMBER not null,
...
prompt =============================================
prompt
create table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
(
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  date_sid                      NUMBER not null,
...
comment on table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
  is 'Actions taken as a result of a student discipline incident.';
comment on column SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.date_sid
...
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_length_diff_reason_sid
  is 'Uniquely identifies the Action Length Diff Reason Dim';
comment on column SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.discipline_sid
  is 'Uniquely identifies the Discipline DIM';
comment on column SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.incident_number
  is 'The discipline incident number associated with this action.';
comment on column SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_assigned_days
  is 'The number of days assigned for the action.';
comment on column SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT.action_actual_days
  is 'The number of days actually served for this action.';
alter table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
  ...
  references SOMEWHEREISDDATA.ACTION_LENGTH_DIFF_REASON_DIM (ACTION_LENGTH_DIFF_REASON_SID);
alter table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
  ...
  references SOMEWHEREISDDATA.DISCIPLINE_DIM (DISCIPLINE_SID);
alter table SOMEWHEREISDDATA.STUDENT_DISCIPLINE_ACTION_FACT
...
prompt ========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_DISC_ACT_FACT_ERR
(
  exception_type                VARCHAR2(75),
  campus_sid                    NUMBER,
  student_sid                   NUMBER,
...
prompt ========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_DISC_ACT_FACT_REJ
(
  campus_sid                    NUMBER not null,
  student_sid                   NUMBER not null,
  date_sid                      NUMBER not null,
...
prompt ======================================
prompt
create table SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT
(
  campus_sid          NUMBER not null,
  student_sid         NUMBER not null,
...
comment on column SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT.entry_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT.withdrawal_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT.last_update
  is 'Date that this records was last updated';
alter table SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT
  ...
  references SOMEWHEREISDDATA.GRADE_LEVEL_DIM (GRADE_LEVEL_SID);
alter table SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT
...
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT_ERR
(
  load_sid            NUMBER,
...
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_ENROLLMENT_FACT_REJ
(
  campus_sid          NUMBER not null,
  student_sid         NUMBER not null,
  entry_date_sid      NUMBER not null,
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.STUDENT_GRADE_FACT
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
comment on table SOMEWHEREISDDATA.STUDENT_GRADE_FACT
  is 'Captures a students grade.
Grain = 1 Row/ student/Course Section/date/Grade Type';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.state_course_sid
  is 'Unique identifier for state couse dim.';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.grade_level_sid
  is 'Surrogate Key for Grade level.';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.academic_source_code
  is 'A code that indicates what kind of Academic Source .
Example: T - transfer
               C - Classroom
               E - Exam
               O - online';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.number_grade
  is 'The numerical grade received by a student.
Example: 100,
                 75.6
                 50.07';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.letter_grade
  is 'The letter grade received by a student.
Example: A,
                B,
                 P,
                 NG';
comment on column SOMEWHEREISDDATA.STUDENT_GRADE_FACT.last_update
  is 'The date/time the row was inserted or updated.';
alter table SOMEWHEREISDDATA.STUDENT_GRADE_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_GRADE_FACT
  ...
  references SOMEWHEREISDDATA.COURSE_SECTION_DIM (COURSE_SECTION_SID);
alter table SOMEWHEREISDDATA.STUDENT_GRADE_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_GRADE_FACT
  ...
  references SOMEWHEREISDDATA.GRADE_TYPE_DIM (GRADE_TYPE_SID);

prompt
prompt Creating table STUDENT_GRADE_FACT_ERR
prompt =====================================
prompt
create table SOMEWHEREISDDATA.STUDENT_GRADE_FACT_ERR
(
  load_sid           NUMBER,
  exception_type     VARCHAR2(200),
...
prompt =====================================
prompt
create table SOMEWHEREISDDATA.STUDENT_GRADE_FACT_REJ
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
comment on table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
  is 'Transactional fact to record when a student is abscent from a class period.';
comment on column SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT.period_absence_count
  is 'A measure for this fact table.  Value: 1';
create index SOMEWHEREISDDATA.NDX_STU_PRD_ABS_DATE_SID_FK on SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT (DATE_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
  ...
  references SOMEWHEREISDDATA.ABSENCE_REASON_DIM (ABSENCE_REASON_SID);
alter table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
  ...
  references SOMEWHEREISDDATA.CLASS_PERIOD_DIM (CLASS_PERIOD_SID);
alter table SOMEWHEREISDDATA.STUDENT_PERIOD_ABSENCE_FACT
...
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_PERIOD_ABS_FACT_ERR
(
  exception_type     VARCHAR2(200),
...
prompt ==========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_PERIOD_ABS_FACT_REJ
(
  campus_sid           NUMBER not null,
  student_sid          NUMBER not null,
  date_sid             NUMBER not null,
...
prompt ======================================
prompt
create table SOMEWHEREISDDATA.STUDENT_PERIOD_OVERRIDE
(
  campus_sid      NUMBER not null,
  student_sid     NUMBER not null,
  periods_per_day NUMBER,
...
comment on table SOMEWHEREISDDATA.STUDENT_PERIOD_OVERRIDE
  is 'Overides the default campus periods per day for a particular student for the current semester.
Example: 5';
alter table SOMEWHEREISDDATA.STUDENT_PERIOD_OVERRIDE
...
prompt =======================================
prompt
create table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT
(
  campus_sid             NUMBER not null,
  student_sid            NUMBER not null,
  flag_date_sid          NUMBER not null,
...
comment on table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT
  is 'Grain = 1 row /student/risk factor/effective date';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT.flag_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT.end_date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT.risk_factor_count
  is 'A measure defined for Cognos reporting; Value 1';
create index SOMEWHEREISDDATA.NDX_STU_RISK_FACTOR_STU_SID_FK on SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT (STUDENT_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT
...
alter table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT
  ...
  references SOMEWHEREISDDATA.CAMPUS_RISK_FACTOR_DIM (CAMPUS_RISK_FACTOR_SID);
alter table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_FACT
...
prompt ============================================
prompt
create table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_PHASE_SUM
(
  campus_sid        NUMBER not null,
  date_sid          NUMBER not null,
  student_sid       NUMBER not null,
...
alter table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_PHASE_SUM
...
prompt ===========================================
prompt
create table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT
(
  campus_sid                     NUMBER not null,
  student_sid                    NUMBER not null,
  date_sid                       NUMBER not null,
...
comment on table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT
...
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian partitioning.
Format will be district sid concatenated to the date in YYYYMMDD format.
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.attendance_flag
  is 'Indicates that the student was flagged for attendance during this snapshot period.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_attendance_flag
  is 'Indicates that the student was flagged for attendance at the end of an academic semester.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.core_course_failure_flag
  is 'Indicates that the student was flagged for failing a core course during a marking period.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.non_core_course_failure_flag
  is 'Indicates that the student was flagged for failing a non-core course during a marking period.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_core_crs_failure_flag
  is 'Indicates that the student was flagged for failing a core course for a semester.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.semester_noncore_crs_fail_flag
  is 'Indicates that the student was flagged for failing a non-core course for a semester.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.gpa_flag
  is 'Indicates that the student was flagged for a GPA below minium established standard.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.deficient_credits_flag
  is 'Indicates that the student was flagged for having to few credits for a semester.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.discipline_flag
  is 'Indicates that the student was flagged for behavorial problems.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.grade_6_thru_8_retention_flag
  is 'Indicates that the student was flagged for having been retained in grades 6 through 8 one or more times.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.cohort_flag
  is 'Indicates that the student was at risk of not graduating with his/her 9th grade class.
Values: Yes, No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.other_flag
...
Values: Yes/No';
comment on column SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT.risk_factor_count
  is 'The total number of risk factors flagged Yes for this student on this date.
Example: 3';
create index SOMEWHEREISDDATA.NDX_STU_RISK_SNAPSHOT_DATE_FK on SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT (DATE_SID)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
alter table SOMEWHEREISDDATA.STUDENT_RISK_FACTOR_SNAPSHOT
...
prompt =============================================
prompt
create table SOMEWHEREISDDATA.STUDENT_RISK_FCT_PHSE_SUM_XREF
(
  date_sid          NUMBER not null,
  risk_factor_phase VARCHAR2(10) not null,
  risk_factor_count NUMBER(2) not null,
...
prompt ===========================================
prompt
create table SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT
(
  campus_sid            NUMBER not null,
  student_sid           NUMBER not null,
  date_sid              NUMBER not null,
...
comment on table SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT
  is 'The occurrence of an incident that may or may not result in a student discipline action.';
comment on column SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT.date_sid
  is 'Surrogate key.  This column must be kept sequential within a district in order to maintian
...
Example:
120100708  for district with sid 1';
comment on column SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT.incident_location_sid
  is 'Uniquely identifies the Incident Location';
comment on column SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT.incident_behavior_sid
  is 'Uniquely identifies an incident behavior.';
alter table SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT
...
alter table SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT
  ...
  references SOMEWHEREISDDATA.INCIDENT_BEHAVIOR_DIM (INCIDENT_BEHAVIOR_SID);
alter table SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT
  add constraint FK_STU_DIS_INC_REF_INC_LOC foreign key (INCIDENT_LOCATION_SID)
  references SOMEWHEREISDDATA.INCIDENT_LOCATION_DIM (INCIDENT_LOCATION_SID);
alter table SOMEWHEREISDDATA.STU_DISCIPLINE_INCIDENT_FACT
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.STU_DISC_INC_FACT_ERR
(
  exception_type        VARCHAR2(75),
  campus_sid            NUMBER,
  student_sid           NUMBER,
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.STU_DISC_INC_FACT_REJ
(
  campus_sid            NUMBER not null,
  student_sid           NUMBER not null,
  date_sid              NUMBER not null,
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.TALEND_ETL_PROCESS
(
...
alter table SOMEWHEREISDDATA.TALEND_ETL_PROCESS
...
prompt ========================================
prompt
create table SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER
(
  moment            TIMESTAMP(6),
  pid               VARCHAR2(20),
...
create index SOMEWHEREISDDATA.IX_ACTION_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (ACTION)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_EXTRACT_DATE_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_JOB_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LABEL_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (LABEL)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LEA_NAME_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LEA_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_MOMENT_TFC on SOMEWHEREISDDATA.TALEND_FLOW_METER_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==================================
prompt
create table SOMEWHEREISDDATA.TALEND_LEA_CONTEXTS
(
  batch_gid     NUMBER,
...
prompt =================================
prompt
create table SOMEWHEREISDDATA.TALEND_LOG_CATCHER
(
  moment       TIMESTAMP(6),
  pid          VARCHAR2(20),
  root_pid     VARCHAR2(20),
...
create index SOMEWHEREISDDATA.IX_EXTRACT_DATE_TLC on SOMEWHEREISDDATA.TALEND_LOG_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_JOB_TLC on SOMEWHEREISDDATA.TALEND_LOG_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LEA_NAME_TLC on SOMEWHEREISDDATA.TALEND_LOG_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LEA_TLC on SOMEWHEREISDDATA.TALEND_LOG_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_MOMENT_TLC on SOMEWHEREISDDATA.TALEND_LOG_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==================================
prompt
create table SOMEWHEREISDDATA.TALEND_STAT_CATCHER
(
  moment            TIMESTAMP(6),
  pid               VARCHAR2(20),
  father_pid        VARCHAR2(20),
...
create index SOMEWHEREISDDATA.IX_EXTRACT_DATE_TSC on SOMEWHEREISDDATA.TALEND_STAT_CATCHER (EXTRACT_DATE)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_JOB_TSC on SOMEWHEREISDDATA.TALEND_STAT_CATCHER (JOB)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LEA_NAME_TSC on SOMEWHEREISDDATA.TALEND_STAT_CATCHER (LEA_NAME)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_LEA_TSC on SOMEWHEREISDDATA.TALEND_STAT_CATCHER (LEA)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
create index SOMEWHEREISDDATA.IX_MOMENT_TSC on SOMEWHEREISDDATA.TALEND_STAT_CATCHER (MOMENT)
  tablespace DW_DEFAULT01
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ==========================
prompt
create table SOMEWHEREISDDATA.USER_CAMPUS
(
...
comment on column SOMEWHEREISDDATA.USER_CAMPUS.user_campus_sid
  is 'Surrogate Key for the User Campus';
comment on column SOMEWHEREISDDATA.USER_CAMPUS.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.USER_CAMPUS.campus_master_sid
  is 'Surrogate Key for the Campus Master';
alter table SOMEWHEREISDDATA.USER_CAMPUS
...
alter table SOMEWHEREISDDATA.USER_CAMPUS
  ...
  references SOMEWHEREISDDATA.CAMPUS_MASTER (CAMPUS_MASTER_SID);
alter table SOMEWHEREISDDATA.USER_CAMPUS
...
prompt ==========================
prompt
create table SOMEWHEREISDDATA.USER_REPORT
(
...
comment on table SOMEWHEREISDDATA.USER_REPORT
  is 'A specific report assigned to a user.';
comment on column SOMEWHEREISDDATA.USER_REPORT.user_sid
  is 'User Surrogate Key';
alter table SOMEWHEREISDDATA.USER_REPORT
...
alter table SOMEWHEREISDDATA.USER_REPORT
  ...
  references SOMEWHEREISDDATA.REPORT_LIST (REPORT_LIST_SID);
alter table SOMEWHEREISDDATA.USER_REPORT
...
prompt ===================================
prompt
create table SOMEWHEREISDDATA.USER_REPORT_CATEGORY
(
...
comment on table SOMEWHEREISDDATA.USER_REPORT_CATEGORY
  is 'Defines which report categorys a user is allowed acces.';
comment on column SOMEWHEREISDDATA.USER_REPORT_CATEGORY.user_sid
  is 'User Surrogate Key';
alter table SOMEWHEREISDDATA.USER_REPORT_CATEGORY
...
prompt ========================
prompt
create table SOMEWHEREISDDATA.USER_ROLE
(
...
comment on column SOMEWHEREISDDATA.USER_ROLE.user_role_sid
  is 'User Role Surrogate Key';
comment on column SOMEWHEREISDDATA.USER_ROLE.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.USER_ROLE.application_role_sid
  is 'Surrogate Key for the Application Role';
comment on column SOMEWHEREISDDATA.USER_ROLE.default_application_flag
  is 'Denotes which application the user will be connected to after successful login(authorization).
Values: Y/N';
alter table SOMEWHEREISDDATA.USER_ROLE
...
alter table SOMEWHEREISDDATA.USER_ROLE
  ...
  references SOMEWHEREISDDATA.APPLICATION_ROLE (APPLICATION_ROLE_SID);
alter table SOMEWHEREISDDATA.USER_ROLE
...
prompt =====================================
prompt
create table SOMEWHEREISDDATA.USER_SECURITY_QUESTION
(
...
comment on column SOMEWHEREISDDATA.USER_SECURITY_QUESTION.user_security_question_sid
  is 'Surrogate Key for the User Security Question';
comment on column SOMEWHEREISDDATA.USER_SECURITY_QUESTION.security_question_sid
  is 'Surrogate Key for the security Question';
comment on column SOMEWHEREISDDATA.USER_SECURITY_QUESTION.user_sid
  is 'User Surrogate Key';
comment on column SOMEWHEREISDDATA.USER_SECURITY_QUESTION.user_response
  is 'The users answer to the security question.';
alter table SOMEWHEREISDDATA.USER_SECURITY_QUESTION
...
alter table SOMEWHEREISDDATA.USER_SECURITY_QUESTION
  ...
  references SOMEWHEREISDDATA.SECURITY_QUESTION (SECURITY_QUESTION_SID);
alter table SOMEWHEREISDDATA.USER_SECURITY_QUESTION
...
prompt ====================================
prompt
create table SOMEWHEREISDDATA.USER_STUDENT_SECURITY
(
  user_id      VARCHAR2(75) not null,
  district_sid NUMBER not null,
  student_sid  NUMBER not null
...
alter table SOMEWHEREISDDATA.USER_STUDENT_SECURITY
...
prompt ==============================
prompt
create sequence SOMEWHEREISDDATA.SID_SEQUENCE
minvalue 1
...
prompt ====================================
prompt
create or replace synonym SOMEWHEREISDDATA.PKG_REVEAL_SECURITY
...
prompt ===========================
prompt
create or replace force view somewhereisddata.application_v as
select
--ROWID as "ROW_ID",
APPLICATION_ID,
ACTIVE_FLAG,
...
prompt ======================================
prompt
create or replace force view somewhereisddata.execution_load_campus_vw as
...
prompt =================================
prompt
create or replace force view somewhereisddata.reveal_lea_contexts as
...
prompt ================================
prompt
create or replace force view somewhereisddata.reveal_log_catcher as
...
prompt ======================================
prompt
create or replace force view somewhereisddata.security_question_user_v as
select
...
prompt
prompt Creating package CC_CONTROL
prompt ===========================
prompt
create or replace package somewhereisddata.CC_Control is
 TxEIS_Install constant boolean := FALSE;
end CC_Control;
/
...
prompt =======================================
prompt
create or replace package somewhereisddata.PKG_IDMGR_USER_ACCOUNT is
...
--------------------------------------------------------------
   procedure PROC_INS_USER_ACCOUNT (
      ...
      P_PEIMS_AT_RISK            in varchar2  default 'N');
--------------------------------------------------------------
...
$IF CC_Control.TxEIS_Install $THEN -- Conditionally include the following code if a TxEIS Installation
--------------------------------------------------------------
...
$END -- End of Conditional Complilation
--------------------------------------------------------------
...
prompt ============================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.USER_ACCOUNT_V AS
SELECT
   ...
   PKG_IDMGR_USER_ACCOUNT.FN_BUILD_USER_ACCOUNT_MD5(
          ...
          P_PEIMS_AT_RISK            => USER_ACCOUNT.PEIMS_AT_RISK,
          P_COL_SEP                  => '|') as MD5
FROM
   USER_ACCOUNT
...
prompt ===============================
prompt
create or replace force view somewhereisddata.user_apps_roles_v as
select
    A.APPLICATION_ID
  , A.ACTIVE_FLAG
  , A.DESCRIPTION
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_STUDENT_MASTER AS
...
prompt ====================================
prompt
create or replace force view somewhereisddata.v_dws_all_risk_factors as
select
        STUDENT_DIM.STUDENT_SID,
...
prompt ==============================
prompt
create or replace force view somewhereisddata.v_dws_as_of_date as
...
prompt
prompt Creating view V_DWS_CAMPUS_LIST
prompt ===============================
prompt
create or replace force view somewhereisddata.v_dws_campus_list as
select CAMPUS_SID
      ,DISTRICT_SID
      ,DISTRICT_ID
      ,CAMPUS_ID
...
prompt ==========================================
prompt
create or replace force view somewhereisddata.v_dws_campus_risk_factor_sum as
select
       a.campus_id,
       a.campus_name,
...
prompt ==================================
prompt
create or replace force view somewhereisddata.v_dws_champions_list as
select
...
prompt
prompt Creating view V_DWS_CHANGE_LOG
prompt ==============================
prompt
create or replace force view somewhereisddata.v_dws_change_log as
select distinct
 dws_audit_log.source_sid
,dws_audit_log.student_sid
,dws_audit_log.table_name
,dws_audit_log.change_description
,initcap(student_dim.full_name) as full_name
,dws_audit_log.change_date
,'On '||to_char(dws_audit_log.change_date,'mm/dd/yyyy')||' '||initcap(user_account_v.USER_FIRST_NAME)||' '||initcap(user_account_v.USER_LAST_NAME)||'('||user_account_v.USER_ID||')'||' '||initcap(dws_audit_log.change_description) as change_log
,'On '||to_char(dws_audit_log.change_date,'mm/dd/yyyy')||' '||initcap(user_account_v.USER_FIRST_NAME)||' '||initcap(user_account_v.USER_LAST_NAME)||'('||user_account_v.USER_ID||')'||' '||initcap(dws_audit_log.change_description)||
' For Student ' ||initcap(student_dim.full_name)||'('||student_dim.student_id||')' as change_log_student
from dws_audit_log
left join user_account_v on user_account_v.USER_SID = dws_audit_log.user_sid
left join student_dim on student_dim.student_sid = dws_audit_log.student_sid
order by dws_audit_log.change_date desc;

prompt
prompt Creating view V_DWS_CREDITS_DETAIL
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_CREDITS_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_CREDITS_SUMMARY AS
SELECT
...
prompt =====================================
prompt
create or replace force view somewhereisddata.v_dws_curr_risk_factors as
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_DISC_ACT_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_DISC_INC_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt =======================================
prompt
create or replace force view somewhereisddata.v_dws_disc_inc_act_detail as
select
...
prompt ======================================
prompt
create or replace force view somewhereisddata.v_dws_enrollment_history as
...
prompt =================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_GRADES_DETAIL AS
SELECT STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.GENDER,
...
prompt
prompt Creating view V_DWS_GRADE_LEVEL
prompt ===============================
prompt
create or replace force view somewhereisddata.v_dws_grade_level as
select GRADE_LEVEL_SID
,GRADE_LEVEL
,GRADE_LEVEL_DESCRIPTION
,GRADE_LEVEL_ORDER
from GRADE_LEVEL_DIM
ORDER BY GRADE_LEVEL_ORDER;

prompt
prompt Creating package PKG_DWS_INTERVENTION
prompt =====================================
prompt
create or replace package somewhereisddata."PKG_DWS_INTERVENTION" is
/* *******************************************
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_INTERVENTION AS
SELECT
INTERVENTION_SID
...
prompt ========================================
prompt
create or replace package somewhereisddata.PKG_DWS_INTERV_CATEGORY is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_INTERVENTION_CATEGORY AS
SELECT
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_INTERVENTION_NOTES AS
...
prompt ==========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_INTERVENTION_NOTE_TYPE AS
SELECT
INTERVENTION_NOTE_TYPE_NAME
...
prompt
prompt Creating view V_DWS_PEIMS_AT_RISK_DTL
prompt =====================================
prompt
create or replace force view somewhereisddata.v_dws_peims_at_risk_dtl as
select
       V_DWS_STUDENT_MASTER.STUDENT_SID,
       Initcap(V_DWS_STUDENT_MASTER.FULL_NAME) as FULL_NAME,
       V_DWS_STUDENT_MASTER.STUDENT_ID,
       V_DWS_STUDENT_MASTER.UNIQUE_STATE_ID,
       ...
       DATE_DIM.SCHOOL_YEAR AS CURRENT_SCHOOL_YEAR,
       DWS_PEIMS_AT_RISK.PEIMS_AT_RISK_SID,
       DWS_PEIMS_AT_RISK.CAMPUS_SID as AT_RISK_CAMPUS_SID,
       CAMPUS_DIM.CAMPUS_ID as AT_RISK_CAMPUS_ID,
       CAMPUS_DIM.CAMPUS_NAME AS AT_RISK_CAMPUS_NAME,
       DWS_PEIMS_AT_RISK.SCHOOL_YEAR,
       DWS_PEIMS_AT_RISK.GRADES_REPEATED,
       DWS_PEIMS_AT_RISK.CURRENT_GRADE_LEVEL,
       DWS_PEIMS_AT_RISK.PRIOR_YEAR_GRADE_LEVEL,
       DWS_PEIMS_AT_RISK.PREK_ASSMT_READING,
       DWS_PEIMS_AT_RISK.PREK_ASSMT_MATH,
       DWS_PEIMS_AT_RISK.K_3_ASSMT_READING,
       DWS_PEIMS_AT_RISK.K_3_ASSMT_MATH,
       DWS_PEIMS_AT_RISK.PRE_ASSMT_AT_RISK_IND,
       DWS_PEIMS_AT_RISK.PR_YR_FAIL_GRADE_READING,
       DWS_PEIMS_AT_RISK.PR_YR_FAIL_GRADE_ELA_WRITING,
       DWS_PEIMS_AT_RISK.PR_YR_FAIL_GRADE_MATH,
       DWS_PEIMS_AT_RISK.PR_YR_FAIL_GRADE_SCIENCE,
       DWS_PEIMS_AT_RISK.PR_YR_FAIL_GRADE_SOC_STUDIES,
       DWS_PEIMS_AT_RISK.GRADES_AT_RISK_IND,
       DWS_PEIMS_AT_RISK.STATE_ASSMT_READING,
       DWS_PEIMS_AT_RISK.STATE_ASSMT_WRITING,
       DWS_PEIMS_AT_RISK.STATE_ASSMT_MATH,
       DWS_PEIMS_AT_RISK.STATE_ASSMT_SCIENCE,
       DWS_PEIMS_AT_RISK.STATE_ASSMT_SOCIAL_STUDIES,
       DWS_PEIMS_AT_RISK.STATE_ASSMT_AT_RISK_IND,
       DWS_PEIMS_AT_RISK.PREV_FAIL_STATE_ASSMT_110_PCT,
       DWS_PEIMS_AT_RISK.PREGNANT_OR_PARENT_IND,
       DWS_PEIMS_AT_RISK.DAEP_IND,
       DWS_PEIMS_AT_RISK.EXPELLED_IND,
       DWS_PEIMS_AT_RISK.PAROLE_PROBATION_IND,
       DWS_PEIMS_AT_RISK.DROPOUT_IND,
       DWS_PEIMS_AT_RISK.LEP_IND,
       DWS_PEIMS_AT_RISK.PROTECTIVE_SERVICES_IND,
       DWS_PEIMS_AT_RISK.HOMELESS_IND,
       DWS_PEIMS_AT_RISK.RESIDENTIAL_PLACEMENT_FAC_IND,
       DWS_PEIMS_AT_RISK.AT_RISK_CODE,
       DWS_PEIMS_AT_RISK.AT_RISK_ENTRY_DATE,
       DWS_PEIMS_AT_RISK.AT_RISK_EXIT_DATE,
       DWS_PEIMS_AT_RISK.CODED_AT_RISK_ON_PEIMS,
       USER_ACCOUNT.USER_ID,
       DWS_PEIMS_AT_RISK.CERTIFIED_DATE,
       (select nvl(count(*),0)
          ...
          where DWS_STUDENT_INTERVENTION.STUDENT_SID = V_DWS_STUDENT_MASTER.STUDENT_SID
            and trunc(sysdate) between DWS_STUDENT_INTERVENTION.INTERVENTION_BEGIN_DATE and DWS_STUDENT_INTERVENTION.INTERVENTION_END_DATE
            and DWS_STU_INTERVENTION_STATUS.INTERVENTION_STATUS = 'Open') AS NBR_ACTIVE_INTERVENTIONS
  from V_DWS_STUDENT_MASTER
  left join DWS_PEIMS_AT_RISK on V_DWS_STUDENT_MASTER.STUDENT_SID = DWS_PEIMS_AT_RISK.STUDENT_SID
  left join CAMPUS_DIM  on CAMPUS_DIM.CAMPUS_SID = DWS_PEIMS_AT_RISK.CAMPUS_SID
  left join USER_ACCOUNT on USER_ACCOUNT.USER_SID = DWS_PEIMS_AT_RISK.USER_SID
  join (select distinct DATE_DIM.SCHOOL_YEAR
       from DATE_DIM
      where DATE_DIM.DATE_ID <= TRUNC(SYSDATE)
        and DATE_DIM.DATE_ID != to_date('29991231','YYYYMMDD')
        and DATE_DIM.SCHOOL_YEAR = ( select max(DATE_DIM.SCHOOL_YEAR)
                                       from DATE_DIM
                                      where DATE_DIM.DATE_ID != to_date('29991231','YYYYMMDD'))) DATE_DIM
      on 1=1;

prompt
prompt Creating view V_DWS_PEIMS_AT_RISK_LIST
prompt ======================================
prompt
create or replace force view somewhereisddata.v_dws_peims_at_risk_list as
select PEIMS_AT_RISK_SID
      ,CAMPUS_NAME
      ,STUDENT_SID
      ,SCHOOL_YEAR
      ,CURRENT_GRADE_LEVEL
      ,PRE_ASSMT_AT_RISK_IND
      ,GRADES_AT_RISK_IND
      ,STATE_ASSMT_AT_RISK_IND
      ,AT_RISK_CODE
      ,AT_RISK_ENTRY_DATE
      ,AT_RISK_EXIT_DATE
      ,CODED_AT_RISK_ON_PEIMS
      ,USER_ACCOUNT.USER_ID AS CERTIFIED_BY
      ,CERTIFIED_DATE
  from DWS_PEIMS_AT_RISK
  join CAMPUS_DIM  ON CAMPUS_DIM.CAMPUS_SID = DWS_PEIMS_AT_RISK.CAMPUS_SID
  left join USER_ACCOUNT ON USER_ACCOUNT.USER_SID = DWS_PEIMS_AT_RISK.USER_SID;
...
prompt =====================================
prompt
create or replace force view somewhereisddata.v_dws_period_abs_detail as
select STUDENT_DIM.STUDENT_SID,
       STUDENT_DIM.FULL_NAME,
       STUDENT_DIM.STUDENT_ID,
       STUDENT_DIM.CURRENTLY_ENROLLED_CAMPUS_ID,
...
prompt ==================================
prompt
create or replace force view somewhereisddata.v_dws_period_abs_sum as
...
prompt ======================================
prompt
create or replace force view somewhereisddata.v_dws_period_abs_sum_rpt as
with pivot_data AS (
select
    "STUDENT_DIM".STUDENT_SID,
    "STUDENT_DIM".STUDENT_ID,
    ...
    CASE WHEN(DATE_DIM.ACADEMIC_9_WEEKS IS NULL) THEN NULL ELSE ('Marking Period: '||DATE_DIM.ACADEMIC_9_WEEKS) END ACADEMIC_9_WEEKS,
    DATE_DIM.SHORT_DATE,
...
group by "STUDENT_DIM".STUDENT_SID,
          ...
          CASE WHEN(DATE_DIM.ACADEMIC_9_WEEKS IS NULL) THEN NULL
            ELSE ('Marking Period: '||DATE_DIM.ACADEMIC_9_WEEKS) END,
          "DATE_DIM"."SHORT_DATE",
          CASE WHEN("CLASS_PERIOD_DIM"."CLASS_PERIOD" IS NULL) THEN NULL
               ELSE ('Period '||"CLASS_PERIOD_DIM"."CLASS_PERIOD") END
order by "SCHOOL_YEAR_DESCRIPTION" desc nulls last
      ,  "ACADEMIC_6_WEEKS" asc nulls last
      ,  "SHORT_DATE" desc nulls last
)
select "STUDENT_SID"
       ,"STUDENT_ID"
       ,"FULL_NAME"
       ,"CURRENTLY_ENROLLED_CAMPUS_ID"
       ,"CURRENTLY_ENROLLED_CAMPUS_NAME"
       ,"STUDENT_CHAMPION"
       ...
       ,"'Period 08'_PERIOD"
       ,"'Period 09'_PERIOD"
  from PIVOT_DATA PIVOT(count(PERIOD_ABSENCE_COUNT) as PERIOD for(CLASS_PERIOD) in('Period 01'
                                                                                  ,'Period 02'
                                                                                  ,'Period 03'
                                                                                  ,'Period 04'
                                                                                  ,'Period 05'
...
prompt ===========================================
prompt
create or replace force view somewhereisddata.v_dws_recently_added_students as
select
"STUDENT_DIM"."STUDENT_SID",
"CAMPUS_DIM"."CAMPUS_NAME",
...
prompt ====================================
prompt
create or replace force view somewhereisddata.v_dws_risk_factor_flow as
select
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_RISK_FACTOR_HISTORY AS
WITH RUN_LOG AS (
...
prompt
prompt Creating view V_DWS_SCHOOL_YEAR
prompt ===============================
prompt
create or replace force view somewhereisddata.v_dws_school_year as
...
prompt ========================================
prompt
create or replace force view somewhereisddata.v_dws_student_intervention as
select
...
prompt ===========================================
prompt
create or replace force view somewhereisddata.v_dws_student_intervention_ir as
select
  DWS_STUDENT_INTERVENTION.STUDENT_SID,
  DWS_STUDENT_INTERVENTION.STUDENT_INTERVENTION_SID,
  DWS_INTERVENTION_CATEGORY.INTERVENTION_CATEGORY,
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_STUDENT_NOTE AS
...
prompt ============================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_STUDENT_RISK_FACTOR_LIST AS
SELECT DISTINCT
       DISTRICT_SECURITY_KEY,
       CAMPUS_SECURITY_KEY,
       CAMPUS_DIM.CAMPUS_ID,
     ...
     DECODE(STUDENT_RISK_FACTOR_SNAPSHOT.SEMESTER_CORE_CRS_FAILURE_FLAG,
       ...
       DECODE(DWS_PEIMS_AT_RISK.AT_RISK_CODE,
              'Y',
              'YES',
              'no') AS PEIMS_AT_RISK,
       (select nvl(count(*),0)
           from DWS_STUDENT_INTERVENTION
           join DWS_STU_INTERVENTION_STATUS on DWS_STU_INTERVENTION_STATUS.INTERVENTION_STATUS_SID = DWS_STUDENT_INTERVENTION.INTERVENTION_STATUS_SID
          where DWS_STUDENT_INTERVENTION.STUDENT_SID = STUDENT_RISK_FACTOR_SNAPSHOT.STUDENT_SID
            and trunc(sysdate) between DWS_STUDENT_INTERVENTION.INTERVENTION_BEGIN_DATE and DWS_STUDENT_INTERVENTION.INTERVENTION_END_DATE
            and DWS_STU_INTERVENTION_STATUS.INTERVENTION_STATUS = 'Open') AS NBR_ACTIVE_INTERVENTIONS
  FROM STUDENT_RISK_FACTOR_SNAPSHOT
  join DATE_DIM on DATE_DIM.DATE_SID = STUDENT_RISK_FACTOR_SNAPSHOT.DATE_SID
  join CAMPUS_DIM on CAMPUS_DIM.CAMPUS_SID = STUDENT_RISK_FACTOR_SNAPSHOT.CAMPUS_SID
  ...
  join V_DWS_STUDENT_MASTER on V_DWS_STUDENT_MASTER.STUDENT_SID = STUDENT_RISK_FACTOR_SNAPSHOT.STUDENT_SID
  join EXECUTION_LOAD_CAMPUS_VW on STUDENT_RISK_FACTOR_SNAPSHOT.CAMPUS_SID = EXECUTION_LOAD_CAMPUS_VW.CAMPUS_SID
  left join DWS_PEIMS_AT_RISK on DWS_PEIMS_AT_RISK.STUDENT_SID = STUDENT_RISK_FACTOR_SNAPSHOT.STUDENT_SID
                             and DWS_PEIMS_AT_RISK.CAMPUS_SID = STUDENT_RISK_FACTOR_SNAPSHOT.CAMPUS_SID
                             and DWS_PEIMS_AT_RISK.SCHOOL_YEAR = DATE_DIM.SCHOOL_YEAR;

prompt
prompt Creating view V_DWS_STU_INTERVENTION_STATUS
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_DWS_STU_INTERVENTION_STATUS AS
SELECT
INTERVENTION_STATUS
...
prompt ======================================
prompt
create or replace force view somewhereisddata.v_dws_stu_risk_histogram as
select
 STUDENT_RISK_FACTOR_SNAPSHOT.RISK_FACTOR_COUNT,
...
prompt ==========================================
prompt
create or replace force view somewhereisddata.v_dws_wkly_attendance_rf_cnt as
select
...
prompt ======================================
prompt
create or replace force view somewhereisddata.v_enrollment_by_campus_d as
select NULL AS LINK
...
prompt ====================================
prompt
create or replace force view somewhereisddata.v_enrollment_by_campus as
select link
       ,sch_yr
       ,campus
       ,STUDENT_ID
...
prompt ========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_ENROLLMENT_BY_DISTRICT_D AS
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_ENROLLMENT_BY_DISTRICT AS
...
prompt =========================================
prompt
create or replace force view somewhereisddata.v_enrollment_by_ethnicity_d as
select NULL AS LINK
       ,SR_STU_ENROLL.SCH_YR
       ,case ethn_agg_cd
       when 'A' then 'Asian'
...
prompt =======================================
prompt
create or replace force view somewhereisddata.v_enrollment_by_ethnicity as
...
prompt ======================================
prompt
create or replace force view somewhereisddata.v_enrollment_by_gender_d as
select NULL AS LINK
       ,sr_stu_enroll.sch_yr
...
prompt ====================================
prompt
create or replace force view somewhereisddata.v_enrollment_by_gender as
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_ENROLLMENT_BY_GRADE_LVL_D AS
SELECT NULL AS LINK
       ,SR_STU_ENROLL.SCH_YR
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_ENROLLMENT_BY_GRADE_LVL AS
SELECT LINK
...
prompt ==============================
prompt
create or replace force view somewhereisddata.v_idmgr_app_role as
...
prompt ===================================
prompt
create or replace force view somewhereisddata.v_idmgr_campus_master as
select
...
prompt ===================================
prompt
create or replace force view somewhereisddata.v_idmgr_login_message as
...
prompt =====================================
prompt
create or replace force view somewhereisddata.v_idmgr_report_catg_all as
...
prompt =================================
prompt
create or replace force view somewhereisddata.v_idmgr_report_list as
select
...
prompt =======================================
prompt
create or replace force view somewhereisddata.v_idmgr_security_question as
...
prompt ========================================
prompt
create or replace force view somewhereisddata.v_idmgr_security_trans_log as
select
...
prompt ===========================================
prompt
create or replace force view somewhereisddata.v_idmgr_txeis_report_catg_all as
...
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_IDMGR_USER_ACCT_COLUMN_AUTH AS
SELECT
USER_ACCOUNT.STUDENT_SSN_AUTH
,USER_ACCOUNT.STAFF_SSN_AUTH
,USER_ACCOUNT.ECON_DISADV_AUTH
...
prompt =================================
prompt
create or replace force view somewhereisddata.v_idmgr_user_campus as
select
 USER_SID
,CAMPUS_MASTER_SID
from USER_CAMPUS;
...
prompt =================================
prompt
create or replace force view somewhereisddata.v_idmgr_user_report as
...
prompt ==========================================
prompt
create or replace force view somewhereisddata.v_idmgr_user_report_category as
...
prompt ===============================
prompt
create or replace force view somewhereisddata.v_idmgr_user_role as
select
...
prompt ============================================
prompt
create or replace force view somewhereisddata.v_idmgr_user_txeis_bus_act_prm as
...
prompt =============================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_SCHOOL_YEAR_D AS
...
prompt ===========================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_SCHOOL_YEAR AS
SELECT DISTINCT sch_yr school_year
,sch_yr
FROM V_SCHOOL_YEAR_D;

prompt
prompt Creating view V_TXBUS_ACCT_SECURITY
prompt ===================================
prompt
create or replace force view somewhereisddata.v_txbus_acct_security as
select MV_TXSTU_BUS_ACCT_SEC_D.USER_ID
      ,USER_ACCOUNT_V.USER_SID
      ,MV_TXSTU_BUS_ACCT_SEC_D.APP_ID
      ,BFN_GL.FUND
      ,BFN_GL.FUNC
      ,BFN_GL.OBJ
      ,BFN_GL.SOBJ
      ...
      ,BFN_GL.ED_SPAN
      ,BFN_GL.PROJ_DTL
      ,BFN_GL.FUND || '-' || BFN_GL.FUNC || '-' || BFN_GL.OBJ || '-' || BFN_GL.SOBJ || '.' || BFN_GL.ORG || '-' || BFN_GL.FSCL_YR ||
       '-' || BFN_GL.PGM || '-' || BFN_GL.ED_SPAN  || '-' || BFN_GL.PROJ_DTL  as Account_Code
  from MV_TXSTU_BUS_ACCT_SEC_D
  join USER_ACCOUNT_V on USER_ACCOUNT_V.USER_ID = MV_TXSTU_BUS_ACCT_SEC_D.USER_ID
  join BFN_GL on BFN_GL.FUND like replace(MV_TXSTU_BUS_ACCT_SEC_D.FUND, 'X', '%')
             and BFN_GL.FUNC like replace(MV_TXSTU_BUS_ACCT_SEC_D.FUNC, 'X', '%')
             and BFN_GL.OBJ like replace(MV_TXSTU_BUS_ACCT_SEC_D.OBJ, 'X', '%')
             and BFN_GL.SOBJ like replace(MV_TXSTU_BUS_ACCT_SEC_D.SOBJ, 'X', '%')
             and BFN_GL.ORG like replace(MV_TXSTU_BUS_ACCT_SEC_D.ORG, 'X', '%')
             and BFN_GL.FSCL_YR like replace(MV_TXSTU_BUS_ACCT_SEC_D.FSCL_YR, 'X', '%')
             and BFN_GL.PGM like replace(MV_TXSTU_BUS_ACCT_SEC_D.PGM, 'X', '%')
             and BFN_GL.ED_SPAN like
                 case MV_TXSTU_BUS_ACCT_SEC_D.ED_SPAN
                   when 'X' then
                    replace(MV_TXSTU_BUS_ACCT_SEC_D.ED_SPAN, 'X', '%')
                   else
                    MV_TXSTU_BUS_ACCT_SEC_D.ED_SPAN
                 end
             and BFN_GL.PROJ_DTL like
                 case
                   when INSTR(MV_TXSTU_BUS_ACCT_SEC_D.PROJ_DTL, 'X', 1, 1) > 0 then
                    replace(MV_TXSTU_BUS_ACCT_SEC_D.PROJ_DTL, 'X', '%')
                   else
                    MV_TXSTU_BUS_ACCT_SEC_D.PROJ_DTL
                 end
             and BFN_GL.ACTIVE_ID = 'A';

prompt
prompt Creating view V_TXBUS_ACCT_SECURITY_IMPORT
prompt ==========================================
prompt
create or replace force view somewhereisddata.v_txbus_acct_security_import as
select MV_TXSTU_BUS_ACCT_SEC_D.USER_ID
      ,user_account_v.USER_SID
      ,APP_ID
      ,FUND
...
prompt
prompt Creating view V_TXSEC_SEC_USERS_LIST_FILTER
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSEC_SEC_USERS_LIST_FILTER AS
SELECT
SEC_USERS.USR_ID
, SEC_USERS.USR_LOG_NAME
, SEC_USERS.USR_NAME_F
, SEC_USERS.USR_NAME_L
FROM SEC_USERS
WHERE SEC_USERS.USR_DELETED != 1
  AND SEC_USERS.USR_LOG_NAME != 'ADMIN'
  AND SEC_USERS.USR_LOG_NAME NOT IN (SELECT USER_ACCOUNT.USER_ID
                                           FROM USER_ACCOUNT);

prompt
prompt Creating view V_TXSEC_SEC_USER_CAMPUS_LIST
prompt ==========================================
prompt
create or replace force view somewhereisddata.v_txsec_sec_user_campus_list as
select distinct SEC_USERS.USR_ID
               ,ROLE_NAME
               ,USR_LOG_NAME
               ,CAMPUS_ID
  from SEC_USERS
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_ATT_DETAIL_D AS
SELECT
 SR_ATT_POST.SCH_YR
...
prompt =========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_STU_CAMPUS_MASTER_D AS
SELECT
...
prompt =======================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_STU_CAMPUS_MASTER AS
SELECT SCH_YR,
       GRD,
       GRDSORT,
       ENTRY_DT,
...
prompt ===========================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_ATT_STU_ENROLL_DETAIL AS
SELECT
...
prompt ======================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_CONTACT_PARENT_D AS
SELECT
...
prompt ====================================
prompt
create or replace force view somewhereisddata.v_txstu_contact_parent as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt =====================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_GRADEBK_LOGIN_D AS
...
prompt ===================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_GRADEBK_LOGIN AS
SELECT USER_ID,
       ACTIVE_CD,
...
prompt ==============================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_GRADES_D AS
SELECT
  SR_CRS_GRD.SCH_YR
...
prompt ============================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_GRADES AS
SELECT
  STUDENT.SCH_YR
  ,STUDENT.CAMPUS_ID
  ,STUDENT.CAMPUS_NAME
...
prompt ===============================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_IMMUNIZ_D AS
SELECT
STU_ID STUDENT_ID,
...
prompt =============================
prompt
create or replace force view somewhereisddata.v_txstu_immuniz as
select distinct
V_TXSTU_STU_CAMPUS_MASTER.sch_yr,
V_TXSTU_STU_CAMPUS_MASTER.grd,
V_TXSTU_STU_CAMPUS_MASTER.grdsort,
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_INSTRUCTOR_D AS
SELECT
...
prompt ================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_INSTRUCTOR AS
SELECT
...
prompt ====================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_REGISTRATION_D AS
SELECT
       	SR_STU_ENROLL.SCH_YR
...
prompt ==================================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_TXSTU_REGISTRATION AS
SELECT
...
prompt =============================
prompt
CREATE OR REPLACE FORCE VIEW SOMEWHEREISDDATA.V_USER_APP_LIST AS
...
prompt ====================================================
prompt
create materialized view SOMEWHEREISDDATA.STUDENT_CREDIT_SUMMARY_MV
...
prompt =========================================
prompt
create or replace package somewhereisddata.pkg_core_load_processing is
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE SOMEWHEREISDDATA."PKG_CORE_UTILITIES" is
...
prompt
prompt Creating package PKG_DWS_AUDIT_LOG
prompt ==================================
prompt
create or replace package somewhereisddata.PKG_DWS_AUDIT_LOG is

  -- Author  : BULLC
  -- Created : 5/29/2014 2:55:11 PM
  -- Purpose : TRACK USER CHANGES

  procedure INS_DWS_AUDIT_LOG (
      P_USER_SID              IN NUMBER,
      P_STUDENT_SID           IN NUMBER,
      P_SOURCE_SID            IN NUMBER,
      P_DATABASE_ACTION       IN VARCHAR2,
      P_TABLE_NAME            IN VARCHAR2,
      P_COLUMN_NAME           IN VARCHAR2 DEFAULT NULL,
      P_FROM_VALUE            IN VARCHAR2 DEFAULT NULL,
      P_TO_VALUE              IN VARCHAR2 DEFAULT NULL,
      P_CHANGE_DATE           IN TIMESTAMP DEFAULT SYSTIMESTAMP,
      P_CHANGE_DESCRIPTION    IN VARCHAR2
    );

end PKG_DWS_AUDIT_LOG;
/
...
prompt ==========================================
prompt
create or replace package somewhereisddata."PKG_DWS_INTERVENTION_NOTE" is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt
prompt Creating package PKG_DWS_PEIMS_AT_RISK
prompt ======================================
prompt
create or replace package somewhereisddata."PKG_DWS_PEIMS_AT_RISK" is
/* *******************************************
Description: This package contains the methods for maintaining the
             DWS_PEIMS_AT_RISK table.
Change History
05/27/2014 CB  Initial version
********************************************** */
--------------------------------------------------------------
-- create procedure for table DWS_PEIMS_AT_RISK
--------------------------------------------------------------
   procedure INS_DWS_PEIMS_AT_RISK (
         P_CAMPUS_SID                     in number
        ,P_STUDENT_SID                    in number
        ,P_SCHOOL_YEAR                    in varchar2
        ,P_USER_SID                       in number   default null
        ,P_CERTIFIED_DATE                 in timestamp default null
        ,P_GRADES_REPEATED                in varchar2 default null
        ,P_CURRENT_GRADE_LEVEL            in varchar2 default null
        ,P_PRIOR_YEAR_GRADE_LEVEL         in varchar2 default null
        ,P_PREK_ASSMT_READING             in varchar2 default null
        ,P_PREK_ASSMT_MATH                in varchar2 default null
        ,P_K_3_ASSMT_READING              in varchar2 default null
        ,P_K_3_ASSMT_MATH                 in varchar2 default null
        ,P_PRE_ASSMT_AT_RISK_IND          in varchar2 default null
        ,P_PR_YR_FAIL_GRADE_READING       in varchar2 default null
        ,P_PR_YR_FAIL_GRADE_ELA_WRITING   in varchar2 default null
        ,P_PR_YR_FAIL_GRADE_MATH          in varchar2 default null
        ,P_PR_YR_FAIL_GRADE_SCIENCE       in varchar2 default null
        ,P_PR_YR_FAIL_GRADE_SOC_STUDIES   in varchar2 default null
        ,P_GRADES_AT_RISK_IND             in varchar2 default null
        ,P_STATE_ASSMT_READING            in varchar2 default null
        ,P_STATE_ASSMT_WRITING            in varchar2 default null
        ,P_STATE_ASSMT_MATH               in varchar2 default null
        ,P_STATE_ASSMT_SCIENCE            in varchar2 default null
        ,P_STATE_ASSMT_SOCIAL_STUDIES     in varchar2 default null
        ,P_STATE_ASSMT_AT_RISK_IND        in varchar2 default null
        ,P_PREV_FAIL_STATE_ASMT_110_PCT   in varchar2 default null
        ,P_PREGNANT_OR_PARENT_IND         in varchar2 default null
        ,P_DAEP_IND                       in varchar2 default null
        ,P_EXPELLED_IND                   in varchar2 default null
        ,P_PAROLE_PROBATION_IND           in varchar2 default null
        ,P_DROPOUT_IND                    in varchar2 default null
        ,P_LEP_IND                        in varchar2 default null
        ,P_PROTECTIVE_SERVICES_IND        in varchar2 default null
        ,P_HOMELESS_IND                   in varchar2 default null
        ,P_RES_PLACEMENT_FAC_IND          in varchar2 default null
        ,P_AT_RISK_CODE                   in varchar2 default null
        ,P_AT_RISK_ENTRY_DATE             in date     default null
        ,P_AT_RISK_EXIT_DATE              in date     default null
        ,P_CODED_AT_RISK_ON_PEIMS         in varchar2 default null
   );
--------------------------------------------------------------
-- update procedure for table "DWS_INTERVENTION"
   procedure UPD_DWS_PEIMS_AT_RISK (
         P_PEIMS_AT_RISK_SID              in number
        ,P_CAMPUS_SID                     in number
        ,P_SCHOOL_YEAR                    in varchar2
        ,P_GRADES_REPEATED                in varchar2 default null
        ,P_CURRENT_GRADE_LEVEL            in varchar2 default null
        ...
        ,P_RES_PLACEMENT_FAC_IND          in varchar2 default null
        ,P_AT_RISK_CODE                   in varchar2 default null
        ,P_AT_RISK_CODE_OLD               in varchar2 default null
        ,P_AT_RISK_ENTRY_DATE             in date     default null
        ,P_AT_RISK_EXIT_DATE              in date     default null
        ,P_CODED_AT_RISK_ON_PEIMS         in varchar2 default null
        ,P_MD5                            in varchar2  default null
...
--------------------------------------------------------------
-- update procedure for table CERTIFY_DWS_PEIMS_AT_RISK
-- PURPOSE: TO UPDATE THE CERTIFIED_DATE AND THE USER_SID
--          OF THE USER THAT CERTIFIED THE DATA.
--------------------------------------------------------------
   procedure CERTIFY_DWS_PEIMS_AT_RISK (
         P_PEIMS_AT_RISK_SID              in number
        ,P_STUDENT_SID                    in number
        ,P_MD5                            in varchar2  default null
   );
--------------------------------------------------------------
-- update procedure for table DECERTIFY_DWS_PEIMS_AT_RISK
-- PURPOSE: TO SET THE CERTIFIED_DATE AND THE USER_SID
--          TO NULL TO DE-CERTIFIED THE DATA.
--------------------------------------------------------------
   procedure DECERTIFY_DWS_PEIMS_AT_RISK (
         P_PEIMS_AT_RISK_SID              in number
        ,P_STUDENT_SID                    in number
   );
--------------------------------------------------------------
-- delete procedure for table "DWS_PEIMS_AT_RISK"
--------------------------------------------------------------
   procedure DEL_DWS_PEIMS_AT_RISK (
      P_PEIMS_AT_RISK_SID                 in number
   );
--------------------------------------------------------------
--  procedure GET_DWS_PEIMS_AT_RISK_DEFAULT
--  Purpose: retrieves some default data for the the PEIMS at-risk
--           ADD.
--------------------------------------------------------------
   procedure GET_DWS_PEIMS_AT_RISK_DEFAULT (
         P_CAMPUS_SID                      out  number
        ,P_STUDENT_SID                     in  number
        ,P_SCHOOL_YEAR                     out  varchar2
        ,P_CURRENT_GRADE_LEVEL             out  varchar2
        ,P_DAEP_IND                        out  varchar2
        ,P_EXPELLED_IND                    out  varchar2
        ,P_LEP_IND                         out  varchar2
   );
--------------------------------------------------------------
-- get procedure for table "DWS_PEIMS_AT_RISK" without MD5
--------------------------------------------------------------
   procedure GET_DWS_PEIMS_AT_RISK (
         P_PEIMS_AT_RISK_SID               in   number
        ,P_CAMPUS_SID                      out  number
        ,P_STUDENT_SID                     out  number
        ,P_SCHOOL_YEAR                     out  varchar2
        ,P_USER_SID                        out  number
        ,P_CERTIFIED_DATE                  out  timestamp
        ,P_GRADES_REPEATED                 out  varchar2
        ,P_CURRENT_GRADE_LEVEL             out  varchar2
        ,P_PRIOR_YEAR_GRADE_LEVEL          out  varchar2
        ,P_PREK_ASSMT_READING              out  varchar2
        ,P_PREK_ASSMT_MATH                 out  varchar2
        ,P_K_3_ASSMT_READING               out  varchar2
        ,P_K_3_ASSMT_MATH                  out  varchar2
        ,P_PRE_ASSMT_AT_RISK_IND           out  varchar2
        ,P_PR_YR_FAIL_GRADE_READING        out  varchar2
        ,P_PR_YR_FAIL_GRADE_ELA_WRITING    out  varchar2
        ,P_PR_YR_FAIL_GRADE_MATH           out  varchar2
        ,P_PR_YR_FAIL_GRADE_SCIENCE        out  varchar2
        ,P_PR_YR_FAIL_GRADE_SOC_STUDIES    out  varchar2
        ,P_GRADES_AT_RISK_IND              out  varchar2
        ,P_STATE_ASSMT_READING             out  varchar2
        ,P_STATE_ASSMT_WRITING             out  varchar2
        ,P_STATE_ASSMT_MATH                out  varchar2
        ,P_STATE_ASSMT_SCIENCE             out  varchar2
        ,P_STATE_ASSMT_SOCIAL_STUDIES      out  varchar2
        ,P_STATE_ASSMT_AT_RISK_IND         out  varchar2
        ,P_PREV_FAIL_STATE_ASMT_110_PCT    out  varchar2
        ,P_PREGNANT_OR_PARENT_IND          out  varchar2
        ,P_DAEP_IND                        out  varchar2
        ,P_EXPELLED_IND                    out  varchar2
        ,P_PAROLE_PROBATION_IND            out  varchar2
        ,P_DROPOUT_IND                     out  varchar2
        ,P_LEP_IND                         out  varchar2
        ,P_PROTECTIVE_SERVICES_IND         out  varchar2
        ,P_HOMELESS_IND                    out  varchar2
        ,P_RES_PLACEMENT_FAC_IND           out  varchar2
        ,P_AT_RISK_CODE                    out  varchar2
        ,P_AT_RISK_ENTRY_DATE              out  date
        ,P_AT_RISK_EXIT_DATE               out  date
        ,P_CODED_AT_RISK_ON_PEIMS          out  varchar2
   );
--------------------------------------------------------------
-- get procedure for table "DWS_PEIMS_AT_RISK"
--------------------------------------------------------------
   procedure GET_DWS_PEIMS_AT_RISK (
         P_PEIMS_AT_RISK_SID               in   number
        ,P_CAMPUS_SID                      out  number
...
--------------------------------------------------------------
-- build MD5 function for table "DWS_INTERVENTION"
   function BUILD_DWS_PEIMS_AT_RISK_MD5 (
       P_PEIMS_AT_RISK_SID               in  number
      ,P_CAMPUS_SID                      in  number
      ,P_STUDENT_SID                     in  number
      ,P_SCHOOL_YEAR                     in  varchar2
...
prompt =================================
prompt
create or replace package somewhereisddata.PKG_DWS_SECURITY is
...
prompt =============================================
prompt
create or replace package somewhereisddata.PKG_DWS_STUDENT_INTERVENTION is
/* *******************************************
Description: This package contains the methods for maintaining the
...
prompt =====================================
prompt
create or replace package somewhereisddata.PKG_DWS_STUDENT_NOTE is
--------------------------------------------------------------
...
prompt ==========================
prompt
create or replace package somewhereisddata.PKG_EMAIL is
...
prompt ===============================================
prompt
create or replace package somewhereisddata.pkg_enrollment_post_processing is
...
prompt ===================================
prompt
create or replace package somewhereisddata.PKG_IDMGR_DISTRICT is
--------------------------------------------------------------
-- update procedure for table "DISTRICT_DIM
   procedure PROC_UPD_DISTRICT_DIM (
      ...
      P_PASSWORD_MINIMUM_LENGTH    in number    default 8,
      P_MD5                        in varchar2  default null
   );
--------------------------------------------------------------
-- get procedure for table "DISTRICT_DIM
   procedure PROC_GET_DISTRICT_DIM (
      ...
      P_PASSWORD_MINIMUM_LENGTH    out number
   );
--------------------------------------------------------------
-- get procedure for table "DISTRICT_DIM
   procedure PROC_GET_DISTRICT_DIM (
...
-- build MD5 function for table "DISTRICT_DIM
   function FN_BUILD_DISTRICT_DIM_MD5 (
      ...
      P_PASSWORD_MINIMUM_LENGTH    in number    default null,
      P_COL_SEP                    in varchar2  default '|'
   ) return varchar2;
--------------------------------------------------------------
...
--------------------------------------------------------------
-- Retrieves the District's minimum password length.
--------------------------------------------------------------
   procedure PROC_MIN_LENGTH (
     P_PASSWORD_MINIMUM_LENGTH    out number
     );
...
prompt ============================================
prompt
create or replace package somewhereisddata.pkg_Risk_Calculation_Engine is
  ...
  -- 20140520 CBull Fixed end date processing for 9-weeks districts
  -- Version Information ---
  --  $Revision$
...
prompt =======================================
prompt
create or replace package somewhereisddata.PKG_RISK_FACTOR_CONFIG is
...
prompt ====================================
prompt
create or replace package somewhereisddata.PKG_RPT_DATA_SOURCE is
...
prompt =================================
prompt
CREATE OR REPLACE PACKAGE SOMEWHEREISDDATA.pkg_sv_acct_mgmt
AS
...
prompt ================================
prompt
CREATE OR REPLACE PACKAGE SOMEWHEREISDDATA."PKG_SV_SECURITY"
AS
...
prompt ==============================
prompt
CREATE OR REPLACE PACKAGE SOMEWHEREISDDATA."PKG_UTILITIES"
...
prompt ==============================================
prompt
create or replace package body somewhereisddata.pkg_core_load_processing is
...
prompt ========================================
prompt
CREATE OR REPLACE PACKAGE BODY SOMEWHEREISDDATA."PKG_CORE_UTILITIES" is
...
prompt
prompt Creating package body PKG_DWS_AUDIT_LOG
prompt =======================================
prompt
create or replace package body somewhereisddata.PKG_DWS_AUDIT_LOG is
...
prompt ==========================================
prompt
create or replace package body somewhereisddata.PKG_DWS_INTERVENTION is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION
   procedure INS_DWS_INTERVENTION (
      P_INTERVENTION_CATEGORY_SID in number,
...
prompt ===============================================
prompt
create or replace package body somewhereisddata.PKG_DWS_INTERVENTION_NOTE is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION_NOTE
   procedure INS_DWS_INTERVENTION_NOTE (
      P_STUDENT_INTERVENTION_SID   in number,
...
prompt =============================================
prompt
create or replace package body somewhereisddata.PKG_DWS_INTERV_CATEGORY is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION_CATEGORY
   procedure INS_DWS_INTERVENTION_CATEGORY (
      P_INTERVENTION_CATEGORY      in varchar2,
...
prompt
prompt Creating package body PKG_DWS_PEIMS_AT_RISK
prompt ===========================================
prompt
create or replace package body somewhereisddata.PKG_DWS_PEIMS_AT_RISK is
--------------------------------------------------------------
-- create procedure for table "DWS_INTERVENTION
   procedure INS_DWS_PEIMS_AT_RISK (
         P_CAMPUS_SID                     in number
   ...
   v_user_sid                             number;
   v_peims_at_risk_sid                    number;
   v_create_date                          timestamp := systimestamp;
   ...
   begin
     ...
     v_peims_at_risk_sid := SID_SEQUENCE.NEXTVAL;
     -- Insert the DWS_PEIMS_AT_RISK row --
      insert into DWS_PEIMS_AT_RISK
        (PEIMS_AT_RISK_SID
        ,CAMPUS_SID
        ,STUDENT_SID
        ,SCHOOL_YEAR
        ...
        ,GRADES_REPEATED
        ,CURRENT_GRADE_LEVEL
        ,PRIOR_YEAR_GRADE_LEVEL
        ,PREK_ASSMT_READING
        ,PREK_ASSMT_MATH
        ,K_3_ASSMT_READING
        ,K_3_ASSMT_MATH
        ,PRE_ASSMT_AT_RISK_IND
        ,PR_YR_FAIL_GRADE_READING
        ,PR_YR_FAIL_GRADE_ELA_WRITING
        ,PR_YR_FAIL_GRADE_MATH
        ,PR_YR_FAIL_GRADE_SCIENCE
        ,PR_YR_FAIL_GRADE_SOC_STUDIES
        ,GRADES_AT_RISK_IND
        ,STATE_ASSMT_READING
        ,STATE_ASSMT_WRITING
        ,STATE_ASSMT_MATH
        ,STATE_ASSMT_SCIENCE
        ,STATE_ASSMT_SOCIAL_STUDIES
        ,STATE_ASSMT_AT_RISK_IND
        ,PREV_FAIL_STATE_ASSMT_110_PCT
        ,PREGNANT_OR_PARENT_IND
        ,DAEP_IND
        ,EXPELLED_IND
        ,PAROLE_PROBATION_IND
        ,DROPOUT_IND
        ,LEP_IND
        ,PROTECTIVE_SERVICES_IND
        ,HOMELESS_IND
        ,RESIDENTIAL_PLACEMENT_FAC_IND
        ,AT_RISK_CODE
        ,AT_RISK_ENTRY_DATE
        ,AT_RISK_EXIT_DATE
        ,CODED_AT_RISK_ON_PEIMS)
      values
        ...
        ,P_CERTIFIED_DATE
        ,P_GRADES_REPEATED
        ,P_CURRENT_GRADE_LEVEL
        ,P_PRIOR_YEAR_GRADE_LEVEL
        ,P_PREK_ASSMT_READING
        ,P_PREK_ASSMT_MATH
        ,P_K_3_ASSMT_READING
        ,P_K_3_ASSMT_MATH
        ,P_PRE_ASSMT_AT_RISK_IND
        ,P_PR_YR_FAIL_GRADE_READING
        ,P_PR_YR_FAIL_GRADE_ELA_WRITING
        ,P_PR_YR_FAIL_GRADE_MATH
        ,P_PR_YR_FAIL_GRADE_SCIENCE
        ,P_PR_YR_FAIL_GRADE_SOC_STUDIES
        ,P_GRADES_AT_RISK_IND
        ,P_STATE_ASSMT_READING
        ,P_STATE_ASSMT_WRITING
        ,P_STATE_ASSMT_MATH
        ,P_STATE_ASSMT_SCIENCE
        ,P_STATE_ASSMT_SOCIAL_STUDIES
        ,P_STATE_ASSMT_AT_RISK_IND
        ,P_PREV_FAIL_STATE_ASMT_110_PCT
        ,P_PREGNANT_OR_PARENT_IND
        ,P_DAEP_IND
        ,P_EXPELLED_IND
        ,P_PAROLE_PROBATION_IND
        ,P_DROPOUT_IND
        ,P_LEP_IND
        ,P_PROTECTIVE_SERVICES_IND
        ,P_HOMELESS_IND
        ,P_RES_PLACEMENT_FAC_IND
        ,P_AT_RISK_CODE
        ,P_AT_RISK_ENTRY_DATE
        ,P_AT_RISK_EXIT_DATE
        ,P_CODED_AT_RISK_ON_PEIMS);

      -- this section logs the non-null columns to the the audit log --
      -- it uses a common description for aggregation to an activity log --
      -- that is presented to the users --
      if P_CAMPUS_SID is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'CAMPUS_SID',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_CAMPUS_SID,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STUDENT_SID is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STUDENT_SID',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STUDENT_SID,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_SCHOOL_YEAR is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'SCHOOL_YEAR',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_SCHOOL_YEAR,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_GRADES_REPEATED is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'GRADES_REPEATED',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_GRADES_REPEATED,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_CURRENT_GRADE_LEVEL is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'CURRENT_GRADE_LEVEL',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_CURRENT_GRADE_LEVEL,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PRIOR_YEAR_GRADE_LEVEL is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PRIOR_YEAR_GRADE_LEVEL',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PRIOR_YEAR_GRADE_LEVEL,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PREK_ASSMT_READING is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PREK_ASSMT_READING',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PREK_ASSMT_READING,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PREK_ASSMT_MATH is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PREK_ASSMT_MATH',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PREK_ASSMT_MATH,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_K_3_ASSMT_READING is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'K_3_ASSMT_READING',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_K_3_ASSMT_READING,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_K_3_ASSMT_MATH is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'K_3_ASSMT_MATH',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_K_3_ASSMT_MATH,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PRE_ASSMT_AT_RISK_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PRE_ASSMT_AT_RISK_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PRE_ASSMT_AT_RISK_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PR_YR_FAIL_GRADE_READING is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_READING',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PR_YR_FAIL_GRADE_READING,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PR_YR_FAIL_GRADE_ELA_WRITING is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_ELA_WRITING',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PR_YR_FAIL_GRADE_ELA_WRITING,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PR_YR_FAIL_GRADE_MATH is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_MATH',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PR_YR_FAIL_GRADE_MATH,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PR_YR_FAIL_GRADE_SCIENCE is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_SCIENCE',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PR_YR_FAIL_GRADE_SCIENCE,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PR_YR_FAIL_GRADE_SOC_STUDIES is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_SOC_STUDIES',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PR_YR_FAIL_GRADE_SOC_STUDIES,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_GRADES_AT_RISK_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'GRADES_AT_RISK_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_GRADES_AT_RISK_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STATE_ASSMT_READING is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STATE_ASSMT_READING',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STATE_ASSMT_READING,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STATE_ASSMT_WRITING is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STATE_ASSMT_WRITING',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STATE_ASSMT_WRITING,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STATE_ASSMT_MATH is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STATE_ASSMT_MATH',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STATE_ASSMT_MATH,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STATE_ASSMT_SCIENCE is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STATE_ASSMT_SCIENCE',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STATE_ASSMT_SCIENCE,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STATE_ASSMT_SOCIAL_STUDIES is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STATE_ASSMT_SOCIAL_STUDIES',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STATE_ASSMT_SOCIAL_STUDIES,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_STATE_ASSMT_AT_RISK_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'STATE_ASSMT_AT_RISK_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_STATE_ASSMT_AT_RISK_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PREV_FAIL_STATE_ASMT_110_PCT is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PREV_FAIL_STATE_ASMT_110_PCT',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PREV_FAIL_STATE_ASMT_110_PCT,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PREGNANT_OR_PARENT_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PREGNANT_OR_PARENT_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PREGNANT_OR_PARENT_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_DAEP_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'DAEP_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_DAEP_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_EXPELLED_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'EXPELLED_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_EXPELLED_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PAROLE_PROBATION_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PAROLE_PROBATION_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PAROLE_PROBATION_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_DROPOUT_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'DROPOUT_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_DROPOUT_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_LEP_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'LEP_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_LEP_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_PROTECTIVE_SERVICES_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'PROTECTIVE_SERVICES_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_PROTECTIVE_SERVICES_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_HOMELESS_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'HOMELESS_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_HOMELESS_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_RES_PLACEMENT_FAC_IND is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'RES_PLACEMENT_FAC_IND',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_RES_PLACEMENT_FAC_IND,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_AT_RISK_CODE is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'AT_RISK_CODE',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_AT_RISK_CODE,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_AT_RISK_ENTRY_DATE is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'AT_RISK_ENTRY_DATE',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_AT_RISK_ENTRY_DATE,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_AT_RISK_EXIT_DATE is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'AT_RISK_EXIT_DATE',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_AT_RISK_EXIT_DATE,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;
      if P_CODED_AT_RISK_ON_PEIMS is not null then
        PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => v_peims_at_risk_sid,
                                      P_DATABASE_ACTION => 'INSERT',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'CODED_AT_RISK_ON_PEIMS',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => P_CODED_AT_RISK_ON_PEIMS,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'CREATED A NEW STUDENT PEIMS AT-RISK RECORD');
      end if;

   end INS_DWS_PEIMS_AT_RISK;
--------------------------------------------------------------
-- update procedure for table "DWS_INTERVENTION
--------------------------------------------------------------
   procedure UPD_DWS_PEIMS_AT_RISK (
      ...
      L_MD5                           varchar2(32767) := null;
      v_student_sid                   number;
      v_user_sid                      number;
      v_update_date                   timestamp := systimestamp;
      v_DWS_PIEMS_AT_RISK_OLD         DWS_PEIMS_AT_RISK%ROWTYPE;
   ...
   begin
        ...
        select user_account.user_sid
         ...
         for c1 in (
            select * from  DWS_PEIMS_AT_RISK
            where PEIMS_AT_RISK_SID = P_PEIMS_AT_RISK_SID FOR UPDATE
         ) loop

            if P_MD5 is not null then
               L_MD5 := BUILD_DWS_PEIMS_AT_RISK_MD5(
                 c1.PEIMS_AT_RISK_SID,
                 c1.CAMPUS_SID,
                 c1.STUDENT_SID,
                 c1.SCHOOL_YEAR,
                 c1.USER_SID,
                 c1.CERTIFIED_DATE,
                 c1.GRADES_REPEATED,
                 c1.CURRENT_GRADE_LEVEL,
                 c1.PRIOR_YEAR_GRADE_LEVEL,
                 c1.PREK_ASSMT_READING,
                 c1.PREK_ASSMT_MATH,
                 c1.K_3_ASSMT_READING,
                 c1.K_3_ASSMT_MATH,
                 c1.PRE_ASSMT_AT_RISK_IND,
                 c1.PR_YR_FAIL_GRADE_READING,
                 c1.PR_YR_FAIL_GRADE_ELA_WRITING,
                 c1.PR_YR_FAIL_GRADE_MATH,
                 c1.PR_YR_FAIL_GRADE_SCIENCE,
                 c1.PR_YR_FAIL_GRADE_SOC_STUDIES,
                 c1.GRADES_AT_RISK_IND,
                 c1.STATE_ASSMT_READING,
                 c1.STATE_ASSMT_WRITING,
                 c1.STATE_ASSMT_MATH,
                 c1.STATE_ASSMT_SCIENCE,
                 c1.STATE_ASSMT_SOCIAL_STUDIES,
                 c1.STATE_ASSMT_AT_RISK_IND,
                 c1.PREV_FAIL_STATE_ASSMT_110_PCT,
                 c1.PREGNANT_OR_PARENT_IND,
                 c1.DAEP_IND,
                 c1.EXPELLED_IND,
                 c1.PAROLE_PROBATION_IND,
                 c1.DROPOUT_IND,
                 c1.LEP_IND,
                 c1.PROTECTIVE_SERVICES_IND,
                 c1.HOMELESS_IND,
                 c1.RESIDENTIAL_PLACEMENT_FAC_IND,
                 c1.AT_RISK_CODE,
                 c1.AT_RISK_ENTRY_DATE,
                 c1.AT_RISK_EXIT_DATE,
                 c1.CODED_AT_RISK_ON_PEIMS
               );
            end if;
            v_student_sid := c1.student_sid;
            v_DWS_PIEMS_AT_RISK_OLD := c1;
         end loop;
      ...
      if (P_MD5 is null) or (L_MD5 = P_MD5) then
         ...
         update DWS_PEIMS_AT_RISK
            set CAMPUS_SID                    = P_CAMPUS_SID
               ,SCHOOL_YEAR                   = P_SCHOOL_YEAR
               ,GRADES_REPEATED               = P_GRADES_REPEATED
               ,CURRENT_GRADE_LEVEL           = P_CURRENT_GRADE_LEVEL
               ,PRIOR_YEAR_GRADE_LEVEL        = P_PRIOR_YEAR_GRADE_LEVEL
               ,PREK_ASSMT_READING            = P_PREK_ASSMT_READING
               ,PREK_ASSMT_MATH               = P_PREK_ASSMT_MATH
               ,K_3_ASSMT_READING             = P_K_3_ASSMT_READING
               ,K_3_ASSMT_MATH                = P_K_3_ASSMT_MATH
               ,PRE_ASSMT_AT_RISK_IND         = P_PRE_ASSMT_AT_RISK_IND
               ,PR_YR_FAIL_GRADE_READING      = P_PR_YR_FAIL_GRADE_READING
               ,PR_YR_FAIL_GRADE_ELA_WRITING  = P_PR_YR_FAIL_GRADE_ELA_WRITING
               ,PR_YR_FAIL_GRADE_MATH         = P_PR_YR_FAIL_GRADE_MATH
               ,PR_YR_FAIL_GRADE_SCIENCE      = P_PR_YR_FAIL_GRADE_SCIENCE
               ,PR_YR_FAIL_GRADE_SOC_STUDIES  = P_PR_YR_FAIL_GRADE_SOC_STUDIES
               ,GRADES_AT_RISK_IND            = P_GRADES_AT_RISK_IND
               ,STATE_ASSMT_READING           = P_STATE_ASSMT_READING
               ,STATE_ASSMT_WRITING           = P_STATE_ASSMT_WRITING
               ,STATE_ASSMT_MATH              = P_STATE_ASSMT_MATH
               ,STATE_ASSMT_SCIENCE           = P_STATE_ASSMT_SCIENCE
               ,STATE_ASSMT_SOCIAL_STUDIES    = P_STATE_ASSMT_SOCIAL_STUDIES
               ,STATE_ASSMT_AT_RISK_IND       = P_STATE_ASSMT_AT_RISK_IND
               ,PREV_FAIL_STATE_ASSMT_110_PCT = P_PREV_FAIL_STATE_ASMT_110_PCT
               ,PREGNANT_OR_PARENT_IND        = P_PREGNANT_OR_PARENT_IND
               ,DAEP_IND                      = P_DAEP_IND
               ,EXPELLED_IND                  = P_EXPELLED_IND
               ,PAROLE_PROBATION_IND          = P_PAROLE_PROBATION_IND
               ,DROPOUT_IND                   = P_DROPOUT_IND
               ,LEP_IND                       = P_LEP_IND
               ,PROTECTIVE_SERVICES_IND       = P_PROTECTIVE_SERVICES_IND
               ,HOMELESS_IND                  = P_HOMELESS_IND
               ,RESIDENTIAL_PLACEMENT_FAC_IND = P_RES_PLACEMENT_FAC_IND
               ,AT_RISK_CODE                  = P_AT_RISK_CODE
               ,AT_RISK_ENTRY_DATE            = P_AT_RISK_ENTRY_DATE
               ,AT_RISK_EXIT_DATE             = P_AT_RISK_EXIT_DATE
               ,CODED_AT_RISK_ON_PEIMS        = P_CODED_AT_RISK_ON_PEIMS
          where PEIMS_AT_RISK_SID = P_PEIMS_AT_RISK_SID;

        if P_AT_RISK_CODE != P_AT_RISK_CODE_OLD then
          PKG_DWS_PEIMS_AT_RISK.DECERTIFY_DWS_PEIMS_AT_RISK(P_PEIMS_AT_RISK_SID => P_PEIMS_AT_RISK_SID,
                                                     P_STUDENT_SID => v_student_sid);
        end if;

        -- this section logs the changed columns to the the audit log --
        -- assuming we made it this far the update must have worked --
        -- Compare the old value to the new value. --

          if nvl(P_CAMPUS_SID,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.CAMPUS_SID,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'CAMPUS_SID',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.CAMPUS_SID,
                                          P_TO_VALUE => P_CAMPUS_SID,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_SCHOOL_YEAR,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.SCHOOL_YEAR,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'SCHOOL_YEAR',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.SCHOOL_YEAR,
                                          P_TO_VALUE => P_SCHOOL_YEAR,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_GRADES_REPEATED,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.GRADES_REPEATED,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'GRADES_REPEATED',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.GRADES_REPEATED,
                                          P_TO_VALUE => P_GRADES_REPEATED,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_CURRENT_GRADE_LEVEL,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.CURRENT_GRADE_LEVEL,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'CURRENT_GRADE_LEVEL',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.CURRENT_GRADE_LEVEL,
                                          P_TO_VALUE => P_CURRENT_GRADE_LEVEL,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PRIOR_YEAR_GRADE_LEVEL,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PRIOR_YEAR_GRADE_LEVEL,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PRIOR_YEAR_GRADE_LEVEL',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PRIOR_YEAR_GRADE_LEVEL,
                                          P_TO_VALUE => P_PRIOR_YEAR_GRADE_LEVEL,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PREK_ASSMT_READING,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PREK_ASSMT_READING,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PREK_ASSMT_READING',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PREK_ASSMT_READING,
                                          P_TO_VALUE => P_PREK_ASSMT_READING,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PREK_ASSMT_MATH,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PREK_ASSMT_MATH,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PREK_ASSMT_MATH',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PREK_ASSMT_MATH,
                                          P_TO_VALUE => P_PREK_ASSMT_MATH,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_K_3_ASSMT_READING,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.K_3_ASSMT_READING,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'K_3_ASSMT_READING',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.K_3_ASSMT_READING,
                                          P_TO_VALUE => P_K_3_ASSMT_READING,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_K_3_ASSMT_MATH,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.K_3_ASSMT_MATH,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'K_3_ASSMT_MATH',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.K_3_ASSMT_MATH,
                                          P_TO_VALUE => P_K_3_ASSMT_MATH,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PRE_ASSMT_AT_RISK_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PRE_ASSMT_AT_RISK_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PRE_ASSMT_AT_RISK_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PRE_ASSMT_AT_RISK_IND,
                                          P_TO_VALUE => P_PRE_ASSMT_AT_RISK_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PR_YR_FAIL_GRADE_READING,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_READING,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_READING',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_READING,
                                          P_TO_VALUE => P_PR_YR_FAIL_GRADE_READING,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PR_YR_FAIL_GRADE_ELA_WRITING,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_ELA_WRITING,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_ELA_WRITING',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_ELA_WRITING,
                                          P_TO_VALUE => P_PR_YR_FAIL_GRADE_ELA_WRITING,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PR_YR_FAIL_GRADE_MATH,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_MATH,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_MATH',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_MATH,
                                          P_TO_VALUE => P_PR_YR_FAIL_GRADE_MATH,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PR_YR_FAIL_GRADE_SCIENCE,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_SCIENCE,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_SCIENCE',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_SCIENCE,
                                          P_TO_VALUE => P_PR_YR_FAIL_GRADE_SCIENCE,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PR_YR_FAIL_GRADE_SOC_STUDIES,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_SOC_STUDIES,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PR_YR_FAIL_GRADE_SOC_STUDIES',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PR_YR_FAIL_GRADE_SOC_STUDIES,
                                          P_TO_VALUE => P_PR_YR_FAIL_GRADE_SOC_STUDIES,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_GRADES_AT_RISK_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.GRADES_AT_RISK_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'GRADES_AT_RISK_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.GRADES_AT_RISK_IND,
                                          P_TO_VALUE => P_GRADES_AT_RISK_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_STATE_ASSMT_READING,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_READING,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'STATE_ASSMT_READING',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_READING,
                                          P_TO_VALUE => P_STATE_ASSMT_READING,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_STATE_ASSMT_WRITING,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_WRITING,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'STATE_ASSMT_WRITING',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_WRITING,
                                          P_TO_VALUE => P_STATE_ASSMT_WRITING,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_STATE_ASSMT_MATH,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_MATH,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'STATE_ASSMT_MATH',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_MATH,
                                          P_TO_VALUE => P_STATE_ASSMT_MATH,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_STATE_ASSMT_SCIENCE,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_SCIENCE,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'STATE_ASSMT_SCIENCE',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_SCIENCE,
                                          P_TO_VALUE => P_STATE_ASSMT_SCIENCE,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_STATE_ASSMT_SOCIAL_STUDIES,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_SOCIAL_STUDIES,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'STATE_ASSMT_SOCIAL_STUDIES',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_SOCIAL_STUDIES,
                                          P_TO_VALUE => P_STATE_ASSMT_SOCIAL_STUDIES,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_STATE_ASSMT_AT_RISK_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_AT_RISK_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'STATE_ASSMT_AT_RISK_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.STATE_ASSMT_AT_RISK_IND,
                                          P_TO_VALUE => P_STATE_ASSMT_AT_RISK_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PREV_FAIL_STATE_ASMT_110_PCT,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PREV_FAIL_STATE_ASSMT_110_PCT,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PREV_FAIL_STATE_ASMT_110_PCT',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PREV_FAIL_STATE_ASSMT_110_PCT,
                                          P_TO_VALUE => P_PREV_FAIL_STATE_ASMT_110_PCT,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PREGNANT_OR_PARENT_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PREGNANT_OR_PARENT_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PREGNANT_OR_PARENT_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PREGNANT_OR_PARENT_IND,
                                          P_TO_VALUE => P_PREGNANT_OR_PARENT_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_DAEP_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.DAEP_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'DAEP_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.DAEP_IND,
                                          P_TO_VALUE => P_DAEP_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_EXPELLED_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.EXPELLED_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'EXPELLED_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.EXPELLED_IND,
                                          P_TO_VALUE => P_EXPELLED_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PAROLE_PROBATION_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PAROLE_PROBATION_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PAROLE_PROBATION_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PAROLE_PROBATION_IND,
                                          P_TO_VALUE => P_PAROLE_PROBATION_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_DROPOUT_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.DROPOUT_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'DROPOUT_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.DROPOUT_IND,
                                          P_TO_VALUE => P_DROPOUT_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_LEP_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.LEP_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'LEP_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.LEP_IND,
                                          P_TO_VALUE => P_LEP_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_PROTECTIVE_SERVICES_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.PROTECTIVE_SERVICES_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'PROTECTIVE_SERVICES_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.PROTECTIVE_SERVICES_IND,
                                          P_TO_VALUE => P_PROTECTIVE_SERVICES_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_HOMELESS_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.HOMELESS_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'HOMELESS_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.HOMELESS_IND,
                                          P_TO_VALUE => P_HOMELESS_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_RES_PLACEMENT_FAC_IND,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.RESIDENTIAL_PLACEMENT_FAC_IND,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'RES_PLACEMENT_FAC_IND',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.RESIDENTIAL_PLACEMENT_FAC_IND,
                                          P_TO_VALUE => P_RES_PLACEMENT_FAC_IND,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_AT_RISK_CODE,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.AT_RISK_CODE,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'AT_RISK_CODE',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.AT_RISK_CODE,
                                          P_TO_VALUE => P_AT_RISK_CODE,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_AT_RISK_ENTRY_DATE,to_date('29991231','YYYYMMDD')) != nvl(v_DWS_PIEMS_AT_RISK_OLD.AT_RISK_ENTRY_DATE,to_date('29991231','YYYYMMDD')) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'AT_RISK_ENTRY_DATE',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.AT_RISK_ENTRY_DATE,
                                          P_TO_VALUE => P_AT_RISK_ENTRY_DATE,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_AT_RISK_EXIT_DATE,to_date('29991231','YYYYMMDD')) != nvl(v_DWS_PIEMS_AT_RISK_OLD.AT_RISK_EXIT_DATE,to_date('29991231','YYYYMMDD')) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'AT_RISK_EXIT_DATE',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.AT_RISK_EXIT_DATE,
                                          P_TO_VALUE => P_AT_RISK_EXIT_DATE,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
          if nvl(P_CODED_AT_RISK_ON_PEIMS,-99) != nvl(v_DWS_PIEMS_AT_RISK_OLD.CODED_AT_RISK_ON_PEIMS,-99) then
            PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                          P_STUDENT_SID => v_student_sid,
                                          P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                          P_DATABASE_ACTION => 'UPDATE',
                                          P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                          P_COLUMN_NAME => 'CODED_AT_RISK_ON_PEIMS',
                                          P_FROM_VALUE => v_DWS_PIEMS_AT_RISK_OLD.CODED_AT_RISK_ON_PEIMS,
                                          P_TO_VALUE => P_CODED_AT_RISK_ON_PEIMS,
                                          P_CHANGE_DATE => v_update_date,
                                          P_CHANGE_DESCRIPTION => 'UPDATED A STUDENT PEIMS AT-RISK RECORD');
          end if;
...
--------------------------------------------------------------
   procedure CERTIFY_DWS_PEIMS_AT_RISK (
      ...
      L_MD5                           varchar2(32767) := null;
      v_user_sid                      number;
      v_certified_date                timestamp;
      v_create_date                   timestamp := systimestamp;

   begin
      -- set the certified date --
      v_certified_date := systimestamp;
      ...
      -- get the current MD5 for the row --
      if P_MD5 is not null then
         for c1 in (
            select * from  DWS_PEIMS_AT_RISK
            where PEIMS_AT_RISK_SID = P_PEIMS_AT_RISK_SID FOR UPDATE
      ...
      if (P_MD5 is null) or (L_MD5 = P_MD5) then
         ...
         update DWS_PEIMS_AT_RISK
            set USER_SID                    = v_user_sid
               ,CERTIFIED_DATE              = SYSTIMESTAMP
          where PEIMS_AT_RISK_SID = P_PEIMS_AT_RISK_SID;

          PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      P_STUDENT_SID => P_STUDENT_SID,
                                      P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                      P_DATABASE_ACTION => 'CERTIFY',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'CERTIFIED_DATE',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => v_certified_date,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'PEIMS AT-RISK DATA CERTIFIED');
          ...
          PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                      ...
                                      P_DATABASE_ACTION => 'CERTIFY',
                                      P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                      P_COLUMN_NAME => 'USER_SID',
                                      P_FROM_VALUE => NULL,
                                      P_TO_VALUE => v_user_sid,
                                      P_CHANGE_DATE => v_create_date,
                                      P_CHANGE_DESCRIPTION => 'PEIMS AT-RISK DATA CERTIFIED');
      else
         raise_application_error (-20001,'Current version of data in database has changed since user initiated update process. current checksum = '||L_MD5||', item checksum = '||P_MD5||'.');
...
--------------------------------------------------------------
   ...
   begin
      ...
      -- get the current CERTIFIED_DATE for the row --
      ...
      for c1 in (
         ...
         v_certified_date := C1.CERTIFIED_DATE;
      end loop;
     ...
     update DWS_PEIMS_AT_RISK
      ...
      PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                  P_STUDENT_SID => P_STUDENT_SID,
                                  P_SOURCE_SID => P_PEIMS_AT_RISK_SID,
                                  P_DATABASE_ACTION => 'DE-CERTIFY',
                                  P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                  P_COLUMN_NAME => 'CERTIFIED_DATE',
                                  P_FROM_VALUE => v_certified_date,
                                  P_TO_VALUE => NULL,
                                  P_CHANGE_DATE => v_create_date,
                                  P_CHANGE_DESCRIPTION => 'PEIMS AT-RISK DATA DE-CERTIFIED');
      ...
      PKG_DWS_AUDIT_LOG.INS_DWS_AUDIT_LOG(P_USER_SID => v_user_sid,
                                  ...
                                  P_TABLE_NAME => 'DWS_PEIMS_AT_RISK',
                                  P_COLUMN_NAME => 'USER_SID',
                                  P_FROM_VALUE => v_user_sid,
                                  P_TO_VALUE => NULL,
                                  P_CHANGE_DATE => v_create_date,
                                  P_CHANGE_DESCRIPTION => 'PEIMS AT-RISK DATA DE-CERTIFIED');


   end DECERTIFY_DWS_PEIMS_AT_RISK;
--------------------------------------------------------------
-- delete procedure for table "DWS_INTERVENTION
--------------------------------------------------------------
   procedure DEL_DWS_PEIMS_AT_RISK (
   ...
   begin
      ...
      delete DWS_PEIMS_AT_RISK
       where PEIMS_AT_RISK_SID = P_PEIMS_AT_RISK_SID;

   end DEL_DWS_PEIMS_AT_RISK;
--------------------------------------------------------------
--  procedure GET_DWS_PEIMS_AT_RISK_DEFAULT
--  Purpose: retrieves some default data for the the PEIMS at-risk
--           ADD.
--------------------------------------------------------------
   ...
   v_lep_1st_yr_monitoring  char(1);
   v_lep_2nd_yr_monitoring  char(1);

   begin

     -- get the max school-year that is less than the current year and excluding the
     -- max date row. this is to handle an out of date date_dim.
     select distinct DATE_DIM.SCHOOL_YEAR
       into P_SCHOOL_YEAR
       from DATE_DIM
      where DATE_DIM.DATE_ID <= TRUNC(SYSDATE)
        and DATE_DIM.DATE_ID != to_date('29991231','YYYYMMDD')
        and DATE_DIM.SCHOOL_YEAR = ( select max(DATE_DIM.SCHOOL_YEAR)
                                       from DATE_DIM
                                      where DATE_DIM.DATE_ID != to_date('29991231','YYYYMMDD'));
     -- get the students LEP status, current grade level, and current campus from stu_dim --
     select CURRENT_GRADE_LEVEL
           ,case SUBSTR(LIMITED_ENGLISH_PROFICIENCY,1,1)
             when 'Y' then '1'
             else '0'
             end as LIMITED_ENGLISH_PROFICIENCY
           ,case SUBSTR(LEP_FIRST_YEAR_MONITORING,1,1)
             when 'Y' then 'F'
             else 'N'
             end as LEP_FIRST_YEAR_MONITORING
           ,case SUBSTR(LEP_SECOND_YEAR_MONITORING,1,1)
             when 'Y' then 'S'
             else 'N'
             end as LEP_SECOND_YEAR_MONITORING
           ,CAMPUS_SID
       into P_CURRENT_GRADE_LEVEL
           ,P_LEP_IND
           ,v_lep_1st_yr_monitoring
           ,v_lep_2nd_yr_monitoring
           ,P_CAMPUS_SID
      from STUDENT_DIM
     where STUDENT_DIM.STUDENT_SID = P_STUDENT_SID;

     -- set the Parm P_LEP_IND to the value of 2nd yr monitoring, or
     -- 1st yr monitoring and lastly LEP.
     if v_lep_2nd_yr_monitoring = 'S' then
        P_LEP_IND := 'S';
     else if  v_lep_1st_yr_monitoring = 'F' then
              P_LEP_IND := 'F';
          end if;
     end if;

     -- get the students current grade level from last enrollment--
     select GRADE_LEVEL_DIM.GRADE_LEVEL
       into P_CURRENT_GRADE_LEVEL
       from STUDENT_ENROLLMENT_FACT
       join GRADE_LEVEL_DIM on STUDENT_ENROLLMENT_FACT.GRADE_LEVEL_SID = GRADE_LEVEL_DIM.GRADE_LEVEL_SID
      where STUDENT_ENROLLMENT_FACT.STUDENT_SID = P_STUDENT_SID
        and  STUDENT_ENROLLMENT_FACT.ENTRY_DATE_SID = (select max(STUDENT_ENROLLMENT_FACT_MAX.ENTRY_DATE_SID)
                                                        from STUDENT_ENROLLMENT_FACT STUDENT_ENROLLMENT_FACT_MAX
                                                        where STUDENT_ENROLLMENT_FACT_MAX.STUDENT_SID = P_STUDENT_SID);
     ...
     select EXPULSION
      ...
      FROM (
            select distinct
                case
                when discipline_dim.discipline_code = '01' then 'Y'
                when discipline_dim.discipline_code = '02' then 'Y'
                when discipline_dim.discipline_code = '03' then 'Y'
                when discipline_dim.discipline_code = '04' then 'Y'
                when discipline_dim.discipline_code = '09' then 'Y'
                when discipline_dim.discipline_code = '11' then 'Y'
                when discipline_dim.discipline_code = '12' then 'Y'
                when discipline_dim.discipline_code = '15' then 'Y'
                when discipline_dim.discipline_code = '50' then 'Y'
                when discipline_dim.discipline_code = '56' then 'Y'
                when discipline_dim.discipline_code = '58' then 'Y'
                when discipline_dim.discipline_code = '61' then 'Y'
                else 'N'
                end as EXPULSION
            from STUDENT_DISCIPLINE_ACTION_FACT
            ...
            where STUDENT_DISCIPLINE_ACTION_FACT.Student_Sid = P_STUDENT_SID
            order by 1 desc
            ) DISC_EXPULSION
      WHERE ROWNUM = 1;
      ...
      FROM (
            select distinct
                case
                when discipline_dim.discipline_code = '07' then 'Y'
                when discipline_dim.discipline_code = '08' then 'Y'
                when discipline_dim.discipline_code = '10' then 'Y'
                when discipline_dim.discipline_code = '14' then 'Y'
                when discipline_dim.discipline_code = '55' then 'Y'
                when discipline_dim.discipline_code = '57' then 'Y'
                else 'N'
                end as DAEP
            from STUDENT_DISCIPLINE_ACTION_FACT
            join discipline_dim  on discipline_dim.discipline_sid = STUDENT_DISCIPLINE_ACTION_FACT.discipline_sid
      ...
      EXCEPTION
        WHEN no_data_found THEN
          NULL;  -- IT'S OK, DO NOTHING.
      END;

   end GET_DWS_PEIMS_AT_RISK_DEFAULT;
--------------------------------------------------------------
-- get procedure for table "DWS_INTERVENTION
--------------------------------------------------------------
   procedure GET_DWS_PEIMS_AT_RISK (
   ...
   begin
      ...
      for c1 in (
         ...
         where PEIMS_AT_RISK_SID = P_PEIMS_AT_RISK_SID
          ...
          P_CAMPUS_SID                      := c1.campus_sid;
          P_STUDENT_SID                     := c1.student_sid;
          P_SCHOOL_YEAR                     := c1.school_year;
          P_USER_SID                        := c1.user_sid;
          P_CERTIFIED_DATE                  := c1.certified_date;
          P_GRADES_REPEATED                 := c1.grades_repeated;
          P_CURRENT_GRADE_LEVEL             := c1.current_grade_level;
          P_PRIOR_YEAR_GRADE_LEVEL          := c1.prior_year_grade_level;
          P_PREK_ASSMT_READING              := c1.prek_assmt_reading;
          P_PREK_ASSMT_MATH                 := c1.prek_assmt_math;
          P_K_3_ASSMT_READING               := c1.k_3_assmt_reading;
          P_K_3_ASSMT_MATH                  := c1.k_3_assmt_math;
          P_PRE_ASSMT_AT_RISK_IND           := c1.pre_assmt_at_risk_ind;
          P_PR_YR_FAIL_GRADE_READING        := c1.pr_yr_fail_grade_reading;
          P_PR_YR_FAIL_GRADE_ELA_WRITING    := c1.pr_yr_fail_grade_ela_writing;
          P_PR_YR_FAIL_GRADE_MATH           := c1.pr_yr_fail_grade_math;
          P_PR_YR_FAIL_GRADE_SCIENCE        := c1.pr_yr_fail_grade_science;
          P_PR_YR_FAIL_GRADE_SOC_STUDIES    := c1.pr_yr_fail_grade_soc_studies;
          P_GRADES_AT_RISK_IND              := c1.grades_at_risk_ind;
          P_STATE_ASSMT_READING             := c1.state_assmt_reading;
          P_STATE_ASSMT_WRITING             := c1.state_assmt_writing;
          P_STATE_ASSMT_MATH                := c1.state_assmt_math;
          P_STATE_ASSMT_SCIENCE             := c1.state_assmt_science;
          P_STATE_ASSMT_SOCIAL_STUDIES      := c1.state_assmt_social_studies;
          P_STATE_ASSMT_AT_RISK_IND         := c1.state_assmt_at_risk_ind;
          P_PREV_FAIL_STATE_ASMT_110_PCT   := c1.prev_fail_state_assmt_110_pct;
          P_PREGNANT_OR_PARENT_IND          := c1.pregnant_or_parent_ind;
          P_DAEP_IND                        := c1.daep_ind;
          P_EXPELLED_IND                    := c1.expelled_ind;
          P_PAROLE_PROBATION_IND            := c1.parole_probation_ind;
          P_DROPOUT_IND                     := c1.dropout_ind;
          P_LEP_IND                         := c1.lep_ind;
          P_PROTECTIVE_SERVICES_IND         := c1.protective_services_ind;
          P_HOMELESS_IND                    := c1.homeless_ind;
          P_RES_PLACEMENT_FAC_IND   := c1.residential_placement_fac_ind;
          P_AT_RISK_CODE                    := c1.at_risk_code;
          P_AT_RISK_ENTRY_DATE              := c1.at_risk_entry_date;
          P_AT_RISK_EXIT_DATE               := c1.at_risk_exit_date;
          P_CODED_AT_RISK_ON_PEIMS          := c1.coded_at_risk_on_PEIMS;

          P_MD5 := BUILD_DWS_PEIMS_AT_RISK_MD5(
              c1.PEIMS_at_risk_sid,
              c1.campus_sid,
              c1.student_sid,
              c1.school_year,
...
--------------------------------------------------------------
-- build MD5 function for table DWS_PEIMS_AT_RISK
-- this function builds a hash key of the table data to be used to
-- determine that the table data has not changed since it was read.
   function BUILD_DWS_PEIMS_AT_RISK_MD5 (
       P_PEIMS_AT_RISK_SID               in  number
   ...
   begin
      ...
      return utl_raw.cast_to_raw(dbms_obfuscation_toolkit.md5(input_string=>
          P_PEIMS_AT_RISK_SID               ||P_COL_SEP||
          P_CAMPUS_SID                      ||P_COL_SEP||
          P_STUDENT_SID                     ||P_COL_SEP||
          P_SCHOOL_YEAR                     ||P_COL_SEP||
          P_USER_SID                        ||P_COL_SEP||
          P_CERTIFIED_DATE                  ||P_COL_SEP||
          P_GRADES_REPEATED                 ||P_COL_SEP||
          P_CURRENT_GRADE_LEVEL             ||P_COL_SEP||
          P_PRIOR_YEAR_GRADE_LEVEL          ||P_COL_SEP||
          P_PREK_ASSMT_READING              ||P_COL_SEP||
          P_PREK_ASSMT_MATH                 ||P_COL_SEP||
          P_K_3_ASSMT_READING               ||P_COL_SEP||
          P_K_3_ASSMT_MATH                  ||P_COL_SEP||
          P_PRE_ASSMT_AT_RISK_IND           ||P_COL_SEP||
          P_PR_YR_FAIL_GRADE_READING        ||P_COL_SEP||
          P_PR_YR_FAIL_GRADE_ELA_WRITING    ||P_COL_SEP||
          P_PR_YR_FAIL_GRADE_MATH           ||P_COL_SEP||
          P_PR_YR_FAIL_GRADE_SCIENCE        ||P_COL_SEP||
          P_PR_YR_FAIL_GRADE_SOC_STUDIES    ||P_COL_SEP||
          P_GRADES_AT_RISK_IND              ||P_COL_SEP||
          P_STATE_ASSMT_READING             ||P_COL_SEP||
          P_STATE_ASSMT_WRITING             ||P_COL_SEP||
          P_STATE_ASSMT_MATH                ||P_COL_SEP||
          P_STATE_ASSMT_SCIENCE             ||P_COL_SEP||
          P_STATE_ASSMT_SOCIAL_STUDIES      ||P_COL_SEP||
          P_STATE_ASSMT_AT_RISK_IND         ||P_COL_SEP||
          P_PREV_FAIL_STATE_ASMT_110_PCT    ||P_COL_SEP||
          P_PREGNANT_OR_PARENT_IND          ||P_COL_SEP||
          P_DAEP_IND                        ||P_COL_SEP||
          P_EXPELLED_IND                    ||P_COL_SEP||
          P_PAROLE_PROBATION_IND            ||P_COL_SEP||
          P_DROPOUT_IND                     ||P_COL_SEP||
          P_LEP_IND                         ||P_COL_SEP||
          P_PROTECTIVE_SERVICES_IND         ||P_COL_SEP||
          P_HOMELESS_IND                    ||P_COL_SEP||
          P_RES_PLACEMENT_FAC_IND           ||P_COL_SEP||
          P_AT_RISK_CODE                    ||P_COL_SEP||
          P_AT_RISK_ENTRY_DATE              ||P_COL_SEP||
          P_AT_RISK_EXIT_DATE               ||P_COL_SEP||
          P_CODED_AT_RISK_ON_PEIMS          ||P_COL_SEP||
          ''
      ));

   end BUILD_DWS_PEIMS_AT_RISK_MD5;
...
prompt ======================================
prompt
create or replace package body somewhereisddata.PKG_DWS_SECURITY is
...
prompt ==================================================
prompt
create or replace package body somewhereisddata.PKG_DWS_STUDENT_INTERVENTION is
...
prompt ==========================================
prompt
create or replace package body somewhereisddata.PKG_DWS_STUDENT_NOTE is
--------------------------------------------------------------
-- create procedure for table DWS_STUDENT_NOTE
   procedure INS_DWS_STUDENT_NOTE (
      P_STUDENT_SID     in number,
...
prompt ===============================
prompt
create or replace package body somewhereisddata.PKG_EMAIL is
...
prompt ====================================================
prompt
create or replace package body somewhereisddata.pkg_enrollment_post_processing is
  ...
  * Asap...Handle case where student enrolled concurrently in multiple campuses
  ...
  would see her as not enrolled and also assign incorrect campus sec key  level.
...
prompt ========================================
prompt
create or replace package body somewhereisddata.PKG_IDMGR_DISTRICT is
--------------------------------------------------------------
-- update procedure for table "DISTRICT_DIM
   procedure PROC_UPD_DISTRICT_DIM (
      P_DISTRICT_SID in number,
   ...
   begin
      ...
      if (P_MD5 is null) or (L_MD5 = P_MD5) then 
         update DISTRICT_DIM set
            ...
            PASSWORD_MINIMUM_LENGTH       = P_PASSWORD_MINIMUM_LENGTH
...
-- get procedure for table "DISTRICT_DIM
   ...
   begin
      ...
      for c1 in (
         ...
         P_PASSWORD_MINIMUM_LENGTH    := c1.PASSWORD_MINIMUM_LENGTH;
...
-- build MD5 function for table "DISTRICT_DIM
   ...
   begin
      ...
      return sys.utl_raw.cast_to_raw(sys.dbms_obfuscation_toolkit.md5(input_string=> 
         ...
         P_PASSWORD_MINIMUM_LENGTH    ||P_COL_SEP||
         ''
      ));
...
--------------------------------------------------------------
   ...
   begin
     select DISTRICT_DIM.PASSWORD_MINIMUM_LENGTH
       into P_PASSWORD_MINIMUM_LENGTH
       from DISTRICT_DIM
      where DISTRICT_SID = (select min(DISTRICT_SID) from DISTRICT_DIM  
                                where DISTRICT_SID != -1)
        and ROWNUM = 1
      order by DISTRICT_SID;
...
prompt ============================================
prompt
create or replace package body somewhereisddata.PKG_IDMGR_USER_ACCOUNT is
--------------------------------------------------------------
-- build MD5 function for table "USER_ACCOUNT
--------------------------------------------------------------
   function FN_BUILD_USER_ACCOUNT_MD5 (
...
--------------------------------------------------------------
   ...
   begin
     -- RETRIEVE THE CONTEXT USER FOR LOGGING --
      ...
      delete from dws_audit_log
      where dws_audit_log.user_sid = P_USER_SID;
      
      $IF CC_Control.TxEIS_Install $THEN -- Conditionally include the following code if a TxEIS Installation
        delete from user_txeis_bus_acct_permiss
        where user_txeis_bus_acct_permiss.user_sid = P_USER_SID;
      $END -- End of Conditional Complilation
...
--------------------------------------------------------------
   ...
   begin
      ...
      PROC_GET_USER_ACCOUNT (
         ...
         P_PEIMS_AT_RISK              => P_PEIMS_AT_RISK,
         P_MD5                        => ignore
      );
...
--------------------------------------------------------------
   ...
   begin
      ...
      for c1 in (
         ...
         P_PEIMS_AT_RISK            := c1.PEIMS_AT_RISK;
...
--------------------------------------------------------------
   procedure PROC_USER_RPT_CATEG_SHUTTLE(
    ...
    $IF CC_Control.TxEIS_Install $THEN -- Conditionally include the following code if a TxEIS Installation
        V_TXEIS_RPT_CATEGORIES      PKG_TXEIS_SECURITY.t_list_array2;/*t_list_array := t_list_array();*/
    $END
   ...
   $IF CC_Control.TxEIS_Install $THEN -- Conditionally include the following code if a TxEIS Installation
     ...
     V_TXEIS_RPT_CATEGORIES := pkg_txeis_security.func_get_txeis_rpt_categs;
...
prompt =================================================
prompt
create or replace package body somewhereisddata.pkg_risk_calculation_engine is
...
20140520  C.Bull       Fixed end date processing for 9-weeks districts
--------------------------------------------------------------------------------*/
...
BEGIN
   ...
   for i in v_date_collection.first..v_date_collection.last
     loop
       ...
       if v_date_collection(i).EndNineWeeksFlag = 'Yes' then
         if not v_first_time_9wks then
           ...
           if v_date_collection(i).EndSemesterFlag = 'Yes' then
             v_9weeks_end_date  := v_date_collection(i).dateSid;
             v_9wks_end_date_array(v_9weeks_end_date) := v_date_collection(i).dateSid;
             v_first_time_9wks := True;
           end if;
         else
           v_9weeks_end_date  := v_date_collection(i).dateSid;
...
prompt ============================================
prompt
create or replace package body somewhereisddata.PKG_RISK_FACTOR_CONFIG is
...
prompt =========================================
prompt
create or replace package body somewhereisddata.PKG_RPT_DATA_SOURCE is
...
prompt ======================================
prompt
CREATE OR REPLACE PACKAGE BODY SOMEWHEREISDDATA.pkg_sv_acct_mgmt
AS
PROCEDURE proc_reset_email
          (  p_user_sid IN number
            ,p_workspace_id IN number default null)
...
IS
  ...
  /* NOTE:  set p_user_ip_address => NULL and p_browser => NULL on
            pkg_sv_acct_mgmt.proc_log_trans() call in this procedure
            due to errors that occurred when calling this procedure
            from SQL*Plus and Oracle SQL Developer.  Works 'ok'
            with PL/SQL Developer.  T. Esposito 20131202
  */
...
prompt =====================================
prompt
CREATE OR REPLACE PACKAGE BODY SOMEWHEREISDDATA.pkg_sv_security
AS
PROCEDURE proc_login
          (
           p_uname IN VARCHAR2
...
prompt ===================================
prompt
CREATE OR REPLACE PACKAGE BODY SOMEWHEREISDDATA."PKG_UTILITIES"
AS
...
prompt ===========================================
prompt
CREATE OR REPLACE TRIGGER SOMEWHEREISDDATA.maintain_campus_selections
...
prompt ============================================
prompt
create or replace trigger somewhereisddata."TRG_ABS_RSN_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
create or replace trigger somewhereisddata."TRG_CAMPUS_DIM_LAST_UPDATE"
...
prompt ==============================================
prompt
create or replace trigger somewhereisddata."TRG_CLASS_PRD_DIM_LAST_UPDATE"
...
prompt ===========================================
prompt
create or replace trigger somewhereisddata."TRG_COURSE_DIM_LAST_UPDATE"
...
prompt =============================================
prompt
create or replace trigger somewhereisddata."TRG_CRS_SECT_DIM_LAST_UPDATE"
...
prompt =========================================
prompt
CREATE OR REPLACE TRIGGER SOMEWHEREISDDATA.TRG_DIST_DIM_LAST_UPDATE
...
prompt ========================================
prompt
create or replace trigger somewhereisddata."TRG_STU_DIM_LAST_UPDATE"
